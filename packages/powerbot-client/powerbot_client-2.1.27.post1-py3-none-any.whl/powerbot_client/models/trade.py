...
class Trade(object):
    ...
    def buy_aggressor_indicator(self, buy_aggressor_indicator):
        ...
        :type buy_aggressor_indicator: str
        """
        allowed_values = ["Y", "N", "U"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and buy_aggressor_indicator not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def sell_aggressor_indicator(self, sell_aggressor_indicator):
        ...
        :type sell_aggressor_indicator: str
        """
        allowed_values = ["Y", "N", "U"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and sell_aggressor_indicator not in allowed_values:  # noqa: E501
            raise ValueError(
