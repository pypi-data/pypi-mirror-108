...
class ContractChangedEvent(object):
    ...
    def __init__(self, message_class=None, emitted_at=None, contract_id=None, contract_name=None, contract_type=None, delivery_area=None, trading_enabled=None, local_vars_configuration=None):  # noqa: E501
