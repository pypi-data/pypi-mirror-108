...
class ContractApi(object):
    ...
    def get_contract_history(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        :type as_of: datetime
        :param with_owntrades: If set to true, the own trades which happend on that revision are returned.
    ...
    def get_limits(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        :param portfolio_id:
        :type portfolio_id: list[str]
        :param include_standing_orders: Include standing (active) orders in the risk calculation
        :type include_standing_orders: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def get_limits_with_http_info(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        if 'portfolio_id' in local_var_params and local_var_params['portfolio_id'] is not None:  # noqa: E501
            query_params.append(('portfolio_id', local_var_params['portfolio_id']))  # noqa: E501
            collection_formats['portfolio_id'] = 'csv'  # noqa: E501
        if 'include_standing_orders' in local_var_params and local_var_params['include_standing_orders'] is not None:  # noqa: E501
            query_params.append(('include_standing_orders', local_var_params['include_standing_orders']))  # noqa: E501
    ...
    def get_order_books(self, **kwargs):  # noqa: E501
        ...
        :param with_portfolio_information: If set to true, the portfolio_informations are included in the response. Set to false to optimize caching.
