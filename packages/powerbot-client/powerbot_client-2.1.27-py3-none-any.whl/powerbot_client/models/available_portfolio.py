...
class AvailablePortfolio(object):
    ...
    def __init__(self, id=None, name=None, tenant_id=None, tenant_name=None, risk_management=None):  # noqa: E501
        """AvailablePortfolio - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AvailablePortfolio, dict):
