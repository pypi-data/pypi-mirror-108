...
class AlgoSetup(object):
    ...
    def __init__(self, id=None, name=None, description=None, require_heartbeat_every_seconds=None, on_missing_heartbeat=None, image=None):  # noqa: E501
        """AlgoSetup - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    def require_heartbeat_every_seconds(self, require_heartbeat_every_seconds):
        ...
        :type: int
        """
        if require_heartbeat_every_seconds is None:
    ...
    def on_missing_heartbeat(self):
        ...
        Specifies how the algorithm will handle orders if a heartbeat is missed. Must be > 0  # noqa: E501
    ...
    def on_missing_heartbeat(self, on_missing_heartbeat):
        ...
        :type: str
        """
        if on_missing_heartbeat is None:
