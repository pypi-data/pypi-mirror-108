...
class AtcStatus(object):
    ...
    def __init__(self, status=None, status_text=None, heartbeat_as_of=None):  # noqa: E501
        """AtcStatus - a model defined in Swagger"""  # noqa: E501
        self._status = None
