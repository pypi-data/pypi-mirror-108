...
class MarketOptions(object):
    ...
    def __init__(self, internal_trading=None, default_delivery_area_id=None, restrict_safe_mode=False):  # noqa: E501
    ...
    def internal_trading(self, internal_trading):
        ...
        if internal_trading not in allowed_values:
            raise ValueError(
    ...
    def restrict_safe_mode(self):
        ...
        restict switching market mode to the master API key  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketOptions, dict):
