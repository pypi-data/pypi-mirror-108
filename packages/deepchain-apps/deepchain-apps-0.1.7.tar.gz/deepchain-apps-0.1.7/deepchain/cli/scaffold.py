...
from .apps_utils import check_app_exist, get_last_release, save_app, save_release_tag
...
class CreateCommand(BaseCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        scaffold_parser = parser.add_parser(name="create", help="create template for new app")
