...
class Levenberg_Marquart():
    ...
    def __init__(self, initial_prediction, compute_hessian, compute_gradient,  forward_model, d_param=1e-50,lower_constraint = -np.inf, upper_constraint = np.inf, num_iterations=5):
        ...
        self.verbose = True
        self.f0 = self.forward_model(self.initial_prediction)
