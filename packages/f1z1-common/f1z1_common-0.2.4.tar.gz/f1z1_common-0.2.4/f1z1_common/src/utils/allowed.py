...
# from common.f1z1_common.src.validator.is_validators import is_dict, is_enum


AllowedOptionsTypes = Union[Dict, Enum]


class IStaticOptions(object):
    """
    allowed static options descriptors interface
    """
