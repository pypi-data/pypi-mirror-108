...
from sym.flow.cli.commands.connectors import connectors_commands
from sym.flow.cli.commands.debug import debug_commands
from sym.flow.cli.commands.integrations import integrations_commands
...
symflow.add_command(connectors_commands)
symflow.add_command(integrations_commands)
