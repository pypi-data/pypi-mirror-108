...
from libs.stomaExcel import Ui_Dialog1
...
from predict.generateExcelStoma import generaExcelStoma
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        excel = action('Generate Excel', self.generarExcelStoma,
        ...
        addActions(self.menus.stoma, (create, createRegion, detect, createScale, excel,close))#, trainModel
        ...
        self.actions.beginner = (
            open, opendir, openNextImg, openPrevImg,None, save,  detect,excel,None,create, createRegion, createScale, delete)#,trainModel
    ...
    def generarExcelStoma(self):
        self.saveFile()
        DialogStoma = QtWidgets.QDialog()
        ui1 = Ui_Dialog1()
        ui1.setupUi1(DialogStoma)
        x = DialogStoma.exec_()
        if ui1.genera:
            try:
                generaExcelStoma(os.path.dirname(ustr(self.filePath)), ui1.escaStoma, self.shapeSize, ui1.uni, ui1.che2, ui1.che3, ui1.che4, ui1.che5, ui1.che6, ui1.che7, ui1.che8, ui1.che9, ui1.che10)
                ...
                QMessageBox.about(self, "Information", "Introduce the value of the scale")
                self.generarExcelStoma()
        # QMessageBox msgBox
    ...
    def handleNewWindow(self):
        self.childWindow = Ui_Dialog1(self)
