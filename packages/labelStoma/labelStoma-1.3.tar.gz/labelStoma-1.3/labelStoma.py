...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def generarExcel(self):
        ...
        if ui.genera:
            try:
                generaExcel(os.path.dirname(ustr(self.filePath)), ui.escaStoma, self.shapeSize, ui.uni, ui.che2, ui.che3, ui.che4, ui.che5, ui.che6, ui.che7, ui.che8, ui.che9, ui.che10)
