...
class DataClient:
    ...
    def __init__(self, token="", debug=False, use_cache=False):
        ...
        self.get_bars = partial(self.history, data_type="bar", freq="QS", use_cache=use_cache)
        self.get_ticks = partial(self.history, data_type="tick", freq="12BH", use_cache=use_cache)
        self.get_dailys = partial(self.history, data_type="daily", freq="YS", use_cache=use_cache)
