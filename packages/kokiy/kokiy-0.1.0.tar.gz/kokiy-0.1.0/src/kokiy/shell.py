    ...
    *Parent class for computationnal shells*
    ...
    def __init__(self, n_axe_1, n_axe_2):
        ...
        *Initialize a Shell object*
        ...
        # TODO: do we really need to access things via properties?

        # TODO: shape can be a property, no? and store also n_trans, n_long
        self.shape = (n_axe_1, n_axe_2)
        self.axis_names = AXIS_NAMES

        # TODO: need to empty initializations?
        ...
        # TODO: u and v instead of u_adim and v_adim? adim by default
    ...
    def dwu(self):
        ...
        *Getter method for weighted u-direction spacing matrix of shape (self.shape,)*
        """
        # TODO: name is clearly not helpful
        return self._dwu
    ...
    def dump_shell(self, name='shell'):
        ...
        *Dump shell geometrical properties into hdf file*
        ...
        field_names = ['theta', 'n_x', 'n_y', 'n_z', 'n_r', 'du', 'dv',
                       'u_adim', 'v_adim', 'dwu', 'dwv', 'surf']
        for field_name in field_names:
            # TODO: why use private if public?
            xmdf.add_field(getattr(self, f'_{field_name}'), field_name)
    ...
    def average_on_shell_over_dirs(self, variable, directions, scale=True):
        ...
        *Performs an integration (average) over one or multiple directions*
        ...
        :param scale: bool
            use False to keep nominal averaging
            use True (defaut) to take into acount the surface element
    ...
    def plot(self, savefile=None):
        ...
        *Plot 2D curve of the Shell*
        ...
        """
        # TODO: why plot xy instead of any other two variables?
    ...
    def _compute_shell_crest(self, ctrl_pts_1, ctrl_pts_2):
        ...
        *Build the shell crest of shape (2, self.shape[1]) and respecting controle points*
        """
        # TODO: move to axishell

        # TODO: spline smoothness properties controlled by defaults in shell?
    ...
    def _compute_shellcrest_nml(self, shell_crest):
        ...
        *Private methold returning shell crest normals*
        ...
        # TODO: rename to _compute_shell_crest_normals?
    ...
    def rad_theta_components(self, vect_y, vect_z):
        """
        returns the radial and azimuthal components of a vect y,z

        """

        y_coor = np.take(self._xyz, 1, -1)
        z_coor = np.take(self._xyz, 2, -1)

        unit_rad_y = y_coor / self.rad
        unit_rad_z = z_coor / self.rad

        unit_azi_y = unit_rad_z
        unit_azi_z = - unit_rad_y

        vect_r = vect_y * unit_rad_y + vect_z * unit_rad_z
        vect_theta = vect_y * unit_azi_y + vect_z * unit_azi_z

        return vect_r, vect_theta
