...
def dict_2_jsonable(dic: typing.Dict) -> typing.Dict:
    """将字典对象中的各项转换为可Json的对象"""
    return json.loads(simplejson.dumps(dic, cls=SimpleJsonEncoder, ignore_nan=True))


def obj_2_json(dic: typing.Union[typing.Dict, typing.List]) -> str:
    """将字典/列表对象转换为Json字符串"""
    return simplejson.dumps(dic, cls=SimpleJsonEncoder, ignore_nan=True)
