...
def CreateComponent(json):
    ...
    # Image.WithText
    elif t == components.ImageWithText.COMPONENT_ID:
        ret = Image.WithText.__new__(Image.WithText)
        ret.component = components.ImageWithText.__new__(components.ImageWithText)
    # Image.View
    ...
    # Document.WithText
    elif t == components.DocumentWithText.COMPONENT_ID:
        ret = Document.WithText.__new__(Document.WithText)
        ret.component = components.DocumentWithText.__new__(components.DocumentWithText)
    else:
