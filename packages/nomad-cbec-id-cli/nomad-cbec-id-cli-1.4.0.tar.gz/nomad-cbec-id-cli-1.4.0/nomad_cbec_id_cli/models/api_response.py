...
class ApiResponse(object):
    ...
    def __init__(self, code=None, message=None, data=None, error=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this ApiResponse.  # noqa: E501

        error message.  # noqa: E501

        :return: The error of this ApiResponse.  # noqa: E501
        :rtype: str
        """
        return self._error
