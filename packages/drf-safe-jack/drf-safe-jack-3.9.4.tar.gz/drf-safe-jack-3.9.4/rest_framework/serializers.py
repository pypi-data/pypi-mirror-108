    ...
    * Default `.create()` and `.update()` implementations are provided.
    ...
    def create(self, validated_data):
        ...
        try:
            ...
            api_created.send(sender=self.ModelClass)
        except TypeError:
    ...
    def update(self, instance, validated_data):
        ...
        # old_data = ser.data
        #
        # old_data = json.loads(json.dumps(old_data))

        # print("class________________",self.__class__)
        # print("instance________________",instance)
        # print("old_data--------------------",old_data)
        #
        # print("validata_data--------------------", validated_data)
        ...
        # (data=result, many=many, partial=True)
        ...
        #
        # api_updated.send(sender=self.Meta.model, old_data=old_data, new_data=new_data,
        #                  instance=instance)
