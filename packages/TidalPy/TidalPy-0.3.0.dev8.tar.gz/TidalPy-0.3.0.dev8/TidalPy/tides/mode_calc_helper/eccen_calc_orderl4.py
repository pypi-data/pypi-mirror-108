...
from ..eccentricity_funcs import orderl2, orderl3, orderl4, EccenOutput
...
@njit(cacheable=True)
def eccentricity_truncation_2_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
...
@njit(cacheable=True)
def eccentricity_truncation_4_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_6_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_8_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_10_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_12_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_14_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_16_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_18_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
...
@njit(cacheable=True)
def eccentricity_truncation_20_maxl_4(eccentricity: FloatArray) -> Dict[int, EccenOutput]:
    """ Calculates eccentricity functions (squared) for a given maximum tidal order (going through each l)
