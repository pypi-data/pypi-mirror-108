...
def calculate_sls(radius: np.ndarray, shear_modulus: np.ndarray, bulk_modulus: np.ndarray,
    ...
    if layer_1_static:
        radial_derivative_layer_1 = static_liquid_ode
        derivative_inputs_layer_1 = (radius[layer_1_indx],
                                     density[layer_1_indx], gravity[layer_1_indx],
                                     order_l, G_to_use)
    else:
        radial_derivative_layer_1 = dynamic_liquid_ode
        derivative_inputs_layer_1 = (radius[layer_1_indx], bulk_modulus[layer_1_indx],
                                     density[layer_1_indx], gravity[layer_1_indx], frequency,
                                     order_l, G_to_use)
    if layer_2_static:
        radial_derivative_layer_2 = static_solid_ode
        derivative_inputs_layer_2 = (radius[layer_2_indx], shear_modulus[layer_2_indx], bulk_modulus[layer_2_indx],
                                     density[layer_2_indx], gravity[layer_2_indx],
                                     order_l, G_to_use)
    else:
        radial_derivative_layer_2 = dynamic_solid_ode
        derivative_inputs_layer_2 = (radius[layer_2_indx], shear_modulus[layer_2_indx], bulk_modulus[layer_2_indx],
    ...
    tidal_y_derivative[:, layer_2_indx] = np.stack(
            radial_derivative_layer_2(radius[layer_2_indx], tidal_y[:, layer_2_indx], *derivative_inputs_layer_2)
    )
    ...
    if layer_1_static:
        ...
        tidal_y_liq = np.zeros((4, len(radius[layer_1_indx])), dtype=np.complex128)
        tidal_y_liq[0, :] = tidal_y[0, layer_1_indx]
        tidal_y_liq[1, :] = tidal_y[1, layer_1_indx]
        tidal_y_liq[2, :] = tidal_y[4, layer_1_indx]
        tidal_y_liq[3, :] = tidal_y[5, layer_1_indx]
        liq_derivatives = np.stack(
                radial_derivative_layer_1(radius[layer_1_indx], tidal_y_liq, *derivative_inputs_layer_1)
        )
        tidal_y_derivative[0, layer_1_indx] = liq_derivatives[0, :]
        tidal_y_derivative[1, layer_1_indx] = liq_derivatives[1, :]
        tidal_y_derivative[4, layer_1_indx] = liq_derivatives[2, :]
        tidal_y_derivative[5, layer_1_indx] = liq_derivatives[3, :]
