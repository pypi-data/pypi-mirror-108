...
from ..inclination_funcs import orderl2, orderl3, orderl4, orderl5, orderl6, InclinOutput
from ...utilities.performance.numba import njit
from ...utilities.types import FloatArray


@njit(cacheable=True)
def inclination_off_maxl_6(obliquity: FloatArray) -> Dict[int, InclinOutput]:
...
@njit(cacheable=True)
def inclination_on_maxl_6(obliquity: FloatArray) -> Dict[int, InclinOutput]:
