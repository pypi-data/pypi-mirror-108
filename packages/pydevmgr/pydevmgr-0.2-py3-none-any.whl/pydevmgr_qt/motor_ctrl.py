...
from .device_ctrl import DeviceCtrl, BaseUi
...
class MotorCtrlStatData(DeviceCtrl.Data.StatData):
...
class MotorCtrlData(DeviceCtrl.Data):
...
class MotorCtrlUi(QFrame, BaseUi):
    def init_ui(self):        
        uic.loadUi(find_ui('motor_ctrl_frame.ui'), self)
    
class MotorCtrl(DeviceCtrl):
    ...
    def connect_device(self,motor, data):
