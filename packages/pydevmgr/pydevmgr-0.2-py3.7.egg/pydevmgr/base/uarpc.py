...
class UaRpc(BaseRpc):
    ...
    Args:
        ...
        atypes (None, iterable, optional): a list of callable parser for the method arguments. 
                If given the number of `atypes` shall match the number of arguments in the server 
    ...
    ::
        ...
        move_abs = UaRpcNode('mot1.move_abs', client.get_node('ns=4;s=MAIN.Motor1'), '4:RPC_MoveAbs', atypes=(float, float))         
    ...
    def __init__(self, 
          ...
          ua_method_id: str, 
          atypes: Optional[Tuple[Callable]] = None, 
    ...
    def new(cls, 
        ...
        And optionaly 
            - _get_atypes method if atypes if None
        ...
        Args:
            ...
            atypes (iterable, optional): A list of parsers for the method arguments. 
                 If None, ``atypes = parent._get_atypes(name)``  if _get_atypes method exists in parent 
        ...
        if atypes is None and hasattr(parent, "_get_atypes"):
            atypes = parent._get_atypes(name)
        ...
        return cls( kjoin(parent.key, name), uacom_node, ua_method_id, atypes=atypes, RPC_ERROR=RPC_ERROR)
    ...
    def fcall(self, *args) -> int:
        """ call method on serser, parse args first according to .atypes attribute """
        return self._uacom_node.call_method(self._ua_method_id, *self._parse_args(args))
