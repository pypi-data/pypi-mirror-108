...
class LampCtrlConfig(CtrlConfig):
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    # Data Structure 
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class LampConfig(DeviceConfig):
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    # Data Structure 
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ctrl_config : LampCtrlConfig = LampCtrlConfig() 
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class LampStatInterface(StatInterface):
    ERROR = ERROR
    SUBSTATE = SUBSTATE
...
class LampCfgInterface(CfgInterface):
...
class LampRpcInterface(RpcInterface):    
    RPC_ERROR = RPC_ERROR
    ##
...
class Lamp(UaDevice):    
    ...
    stat = LampStatInterface.prop('stat')    
    cfg  = LampCfgInterface.prop('cfg')
    rpc  = LampRpcInterface.prop('rpc')
...
Recorder.new_device_type('Lamp', Lamp)
...
class LampStatModel(BaseStatModel):
...
class LampModel(BaseModel):
    StatModel = LampStatModel
    CfgModel = LampCfgModel
        
    cfg: LampCfgModel = LampCfgModel()
    stat: LampStatModel = LampStatModel()
