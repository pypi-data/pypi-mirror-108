# mypy-boto3-networkmanager<a id="mypy-boto3-networkmanager"></a>
...
[boto3.NetworkManager 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/networkmanager.html#NetworkManager)
