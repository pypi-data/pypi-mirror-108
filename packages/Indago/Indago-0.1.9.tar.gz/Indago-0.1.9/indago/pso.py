    ...
    def _run(self):
        ...
        for self.it in range(1, self.iterations + 1):
            ...
            if self.params['inertia'] == 'LDIW':
                w = 1.0 - (1.0 - 0.4) * self.it / self.iterations

            """ TVAC """
            if self.method == 'TVAC':
                c1 = 2.5 - (2.5 - 0.5) * self.it / self.iterations
                c2 = 0.5 + (2.5 - 0.5) * self.it / self.iterations
            ...
            if self.params['inertia'] == 'anakatabatic':
                ...
                #print(w_start)
                w = w_start * (1 - self.it / self.iterations) \
                    + w_stop * (self.it / self.iterations)
