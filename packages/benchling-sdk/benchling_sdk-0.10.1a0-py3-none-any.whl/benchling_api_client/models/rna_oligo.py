...
class RnaOligo:
    ...
    fields: Fields
    id: str
    registration_origin: Optional[RegistrationOrigin]
    api_url: Union[Unset, None] = UNSET
    bases: Union[Unset, None] = UNSET
    nucleotide_type: Union[Unset, None] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        id = self.id
        registration_origin = self.registration_origin.to_dict() if self.registration_origin else None
