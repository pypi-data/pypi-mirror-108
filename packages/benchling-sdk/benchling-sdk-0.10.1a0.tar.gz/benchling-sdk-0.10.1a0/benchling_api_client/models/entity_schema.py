...
class EntitySchema:
    ...
    containable_type: Union[Unset, EntitySchemaContainableType] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.containable_type, Unset):
            containable_type = self.containable_type.value
