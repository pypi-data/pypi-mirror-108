...
class LocalExperimentDriver(BaseExperimentDriver):
    ...
    def prepare_raw_experiment_data(self,
        ...
        # todo gaurav: consider not splitting into X/y/weights at this point, just keep using training_data ?
        Contract.assert_type(raw_experiment_data.X, "raw_experiment_data.X", expected_types=pd.DataFrame)
        Contract.assert_type(raw_experiment_data.y, "raw_experiment_data.y", expected_types=np.ndarray)
