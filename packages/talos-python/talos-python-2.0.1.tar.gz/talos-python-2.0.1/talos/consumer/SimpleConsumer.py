...
class SimpleConsumer:
    ...
    def fetch_message(self, startOffset=None, maxFetchedNumber=None):
        ...
        try:
            ...
            if not self.scheduleInfoCache and self.scheduleInfoCache.get_is_auto_location():
                self.logger.warn(
                    ...
                    + "The exception message is :" + tTransportException.message +
        ...
        if getMessageResponse.isTransfer is not None and getMessageResponse.isTransfer and self.scheduleInfoCache is not None \
