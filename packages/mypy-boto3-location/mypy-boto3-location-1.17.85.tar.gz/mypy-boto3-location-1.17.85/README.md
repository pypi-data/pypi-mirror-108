# mypy-boto3-location<a id="mypy-boto3-location"></a>
...
[boto3.LocationService 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/location.html#LocationService)
