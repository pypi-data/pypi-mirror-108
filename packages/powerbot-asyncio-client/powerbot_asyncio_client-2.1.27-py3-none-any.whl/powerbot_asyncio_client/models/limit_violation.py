...
class LimitViolation(object):
    ...
    def __init__(self, message=None, contract_id=None, delivery_area=None, violation_type=None):  # noqa: E501
        """LimitViolation - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    def violation_type(self, violation_type):
        ...
        if violation_type not in allowed_values:
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LimitViolation, dict):
