...
class OrderBookEntry(object):
    ...
    def __init__(self, order_id=None, delivery_area=None, contract_id=None, order_entry_time=None, price=None, quantity=None, exe_restriction=None, type=None, local_vars_configuration=None):  # noqa: E501
