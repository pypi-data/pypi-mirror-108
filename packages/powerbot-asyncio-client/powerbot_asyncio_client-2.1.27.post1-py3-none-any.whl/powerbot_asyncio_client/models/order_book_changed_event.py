...
class OrderBookChangedEvent(object):
    ...
    def __init__(self, message_class=None, portfolio_id=None, emitted_at=None, contract_id=None, contract_type=None, delivery_area=None, delivery_start=None, delivery_end=None, active_since=None, revision=None, sequence_number=None, local_vars_configuration=None):  # noqa: E501
