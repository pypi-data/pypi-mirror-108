...
<xsl:template match="note[starts-with(@class, 'amc_question') and not(.//note[@class='amc_numeric_choices'])]"> <!-- FIXME seconde condition useless-->
...
<!-- \AMCnumericChoices 
FIXME Need to support tolerance
-->
<xsl:template match="note[@class='amc_questionmult' and .//note[@class='amc_numeric_choices']]"> <!-- FIXME seconde condition useless-->
