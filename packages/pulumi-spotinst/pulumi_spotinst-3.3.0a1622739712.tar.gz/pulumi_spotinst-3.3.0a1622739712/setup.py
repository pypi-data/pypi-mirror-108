...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.3.0-alpha.1622739712+f637a6fe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.3.0-alpha.1622739712+f637a6fe`
                """)
            else:
                raise
