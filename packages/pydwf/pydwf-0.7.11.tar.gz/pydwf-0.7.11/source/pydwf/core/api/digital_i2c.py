...
class DigitalI2c(DwfDeviceSubApi):
    ...
    def sclSet(self, channel_index: int) -> None:
        """Set the channel where the clock (SCL) signal is transmitted.
    ...
    def sdaSet(self, channel_index: int) -> None:
        """Set the channel where the data (SDA) signal is transmitted/received.
    ...
    def writeRead(self, address: int, tx: List[int], number_of_rx_bytes: int) -> Tuple[int, List[int]]:
        ...
        Parameters:
            address (int): Address of the target device.
            tx (List[int]): Words to send.
            number_of_rx_bytes (int): Number of octets to receive.

        Returns:
            Tuple[int, List[int]:
                The first element is the NAK indication; the second element is a list of values received.
    ...
    def read(self, address: int, number_of_words: int) -> Tuple[int, List[int]]:
        ...
        Parameters:
            address (int): Address of the target device.
            number_of_words (int): Number of octets to receive.
