...
from pydwf.core.auxiliary.enum_types import (
    ...
    DwfAcquisitionMode, DwfAnalogInFilter, DwfTriggerType, DwfTriggerSlope, DwfTriggerLengthCondition,
    DwfErrorCode, DwfAnalogOutFunction, DwfAnalogIO, DwfAnalogOutNode, DwfAnalogOutMode,
