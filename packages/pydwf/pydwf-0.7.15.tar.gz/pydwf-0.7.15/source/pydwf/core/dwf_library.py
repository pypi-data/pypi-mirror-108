...
class DwfLibrary:
    ...
    def paramSet(self, parameter: DwfDeviceParameter, value: int) -> None:
        ...
        Parameters are settings of a specific |DwfDevice|. Different |DwfDevice| instances can
        have different values for each of the possible |DwfDeviceParameter:link| parameters.
