...
class AnalogOut(AbstractDwfDeviceSubApi):
    ...
    def count(self) -> int:
        ...
        Raises:
            DwfLibraryError: There was an error while retrieving the number of analog output channels.
        """
    ...
    def masterSet(self, channel_index: int, master_channel_index: int) -> None:
        ...
        Raises:
            DwfLibraryError: There was an error while setting the value.
        """
    ...
    def masterGet(self, channel_index: int) -> int:
        ...
        Raises:
            DwfLibraryError: There was an error while getting the value.
        """
    ...
    def modeSet(self, channel_index: int, mode: DwfAnalogOutMode) -> None:
        ...
        Raises:
            DwfLibraryError: There was an error while executing the operation.
        """
    ...
    def idleInfo(self, channel_index: int) -> List[DwfAnalogOutIdle]:
        ...
        Returns:
            List[DwfAnalogOutIdle]: The idle info.
    ...
    def repeatGet(self, channel_index: int) -> int:
        ...
        Returns:
            int: The currently configured repeat value.
    ...
    def nodeOffsetSet(self, channel_index: int, node: DwfAnalogOutNode, offset: float) -> None:
        ...
        Parameters:
            channel_index (int): The |AnalogOut| channel.
            node (DwfAnalogOutNode): The channel node.
            offset (float): The offset, in Volt.
    ...
    def enableSet(self, channel_index: int, enable: bool) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeEnableSet` instead.
    ...
    def enableGet(self, channel_index: int) -> bool:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeEnableGet` instead.
    ...
    def functionInfo(self, channel_index: int) -> List[DwfAnalogOutFunction]:
        """Get |AnalogOut| channel waveshape function info.

        This function is OBSOLETE. Use :py:meth:`nodeFunctionInfo` instead.
    ...
    def functionSet(self, channel_index: int, func: DwfAnalogOutFunction) -> None:
        """Set |AnalogOut| channel waveshape function.

        This function is OBSOLETE. Use :py:meth:`nodeFunctionSet` instead.
    ...
    def functionGet(self, channel_index: int) -> DwfAnalogOutFunction:
        """Get |AnalogOut| channel waveshape function.

        This function is OBSOLETE. Use :py:meth:`nodeFunctionGet` instead.
    ...
    def frequencyInfo(self, channel_index: int) -> Tuple[float, float]:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeFrequencyInfo` instead.
    ...
    def frequencySet(self, channel_index: int, frequency: float) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeFrequencySet` instead.
    ...
    def frequencyGet(self, channel_index: int) -> float:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeFrequencyGet` instead.
    ...
    def amplitudeInfo(self, channel_index: int) -> Tuple[float, float]:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeAmplitudeInfo` instead.
    ...
    def amplitudeSet(self, channel_index: int, amplitude: float) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeAmplitudeSet` instead.
    ...
    def amplitudeGet(self, channel_index: int) -> float:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeAmplitudeGet` instead.
    ...
    def offsetInfo(self, channel_index: int) -> Tuple[float, float]:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeOffsetInfo` instead.
    ...
    def offsetSet(self, channel_index: int, offset: float) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeOffsetSet` instead.
    ...
    def offsetGet(self, channel_index: int) -> float:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeOffsetGet` instead.
    ...
    def symmetryInfo(self, channel_index: int) -> Tuple[float, float]:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeSymmetryInfo` instead.
    ...
    def symmetrySet(self, channel_index: int, symmetry: float) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeSymmetrySet` instead.
    ...
    def symmetryGet(self, channel_index: int) -> float:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeSymmetryGet` instead.
    ...
    def phaseInfo(self, channel_index: int) -> Tuple[float, float]:
        ...
        This function is OBSOLETE. Use :py:meth:`nodePhaseInfo` instead.
    ...
    def phaseSet(self, channel_index: int, phase: float) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodePhaseSet` instead.
    ...
    def phaseGet(self, channel_index: int) -> float:
        ...
        This function is OBSOLETE. Use :py:meth:`nodePhaseGet` instead.
    ...
    def dataInfo(self, channel_index: int) -> Tuple[int, int]:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeDataInfo` instead.
    ...
    def dataSet(self, channel_index: int, data: np.ndarray) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodeDataSet` instead.
    ...
    def playStatus(self, channel_index: int) -> Tuple[int, int, int]:
        ...
        This function is OBSOLETE. Use :py:meth:`nodePlayStatus` instead.
    ...
    def playData(self, channel_index: int, data: np.ndarray) -> None:
        ...
        This function is OBSOLETE. Use :py:meth:`nodePlayData` instead.
