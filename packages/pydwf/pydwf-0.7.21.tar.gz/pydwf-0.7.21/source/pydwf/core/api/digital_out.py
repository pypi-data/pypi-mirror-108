...
class DigitalOut(AbstractDwfDeviceSubApi):
    ...
    def runSet(self, run_duration: float) -> None:
        ...
        Parameters:
            run_duration: The run duration, in seconds.
    ...
    def enableGet(self, channel_index: int) -> bool:
        """Check if a specific digital pin is enabled for output.
    ...
    def idleInfo(self, channel_index: int) -> List[DwfDigitalOutIdle]:
        """Get a list of valid idle behavior setting values.

        Returns:
            List[DwfDigitalOutIdle]: A list of valid digital idle options.
    ...
    def idleSet(self, channel_index: int, idle_mode: DwfDigitalOutIdle) -> None:
        ...
        Parameters:
            channel_index (int): The digital pin.
            idle_mode (DwfDigitalOutIdle): The digital idle setting.
    ...
    def idleGet(self, channel_index: int) -> DwfDigitalOutIdle:
        ...
        Returns:
            DwfDigitalOutIdle: The current digital idle setting.
    ...
    def counterSet(self, channel_index: int, low_count: int, high_count: int) -> None:
        ...
        Parameters:
            channel_index (int): The digital pin.
            low_count (int): The number of cycles the signal should be High.
            high_count (int): The number of cycles the signal should be Low.
    ...
    def counterGet(self, channel_index: int) -> Tuple[int, int]:
        ...
        Parameters:
            channel_index (int): The digital pin.
            Tuple[int, int]: The number of cycles the signal should be High, Low.
    ...
    def playRateSet(self, playback_rate: float) -> None:
        """Set |DigitalOut| playback rate, in Hz.
