...
from pydwf.core.dwf_library_subapi import DwfLibrarySubApi
...
class DeviceEnumeration(DwfLibrarySubApi):
    ...
    def deviceType(self, device_index: int) -> Tuple[int, int]:
        """Return the device ID and version (hardware revision) of the selected device.
