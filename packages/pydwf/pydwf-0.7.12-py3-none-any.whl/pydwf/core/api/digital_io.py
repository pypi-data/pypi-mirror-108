...
class DigitalIO(DwfDeviceSubApi):
    ...
    def reset(self) -> None:
        ...
        It sets the outputs to tri-state (high impedance, not enabled), output value to zero,
        and configures the |DigitalIO|.
    ...
    def configure(self) -> None:
        ...
        This method does not have to be used if auto-configuration is enabled.
