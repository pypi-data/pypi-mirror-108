...
class AnalogImpedance(DwfDevice_SubAPI):
    ...
    def configure(self, start: bool) -> None:
        """Configure the AnalogImpedance measurement.
    ...
    def status(self) -> DwfState:
        ...
        Returns:
            DwfState: Status of the measurement.
    ...
    def referenceSet(self, reference: float) -> None:
        ...
        Parameters:
            reference: Reference load, in Ohms.
    ...
    def compGet(self) -> Tuple[float, float, float, float]:
        ...
        Returns:
            ...
            short-circuit resistance, short-circuit reactance (all in Ohms).
    ...
    def statusInput(self, channel_index: int) -> Tuple[float, float]:
        """Get input measurement status.

        Parameters:
            channel_index(int): The channel for which to get gain and phase information.

        Returns:
            Tuple[float, float]: The gain and phase (radians) information of the current measurement.
    ...
    def statusMeasure(self, measure: DwfAnalogImpedance) -> float:
        """Retrieve analog impedance measurement status value.
