...
class AnalogIO(DwfDevice_SubAPI):
    ...
    def status(self) -> None:
        ...
        Note that this method does not return a value, since the |AnalogIO| functionality is not
    ...
    def enableInfo(self) -> Tuple[bool, bool]:
        ...
        The Master Enable *status* may be different from the Master Enable *setting* if e.g. an overcurrent protection
        circuit has been triggered.

        Returns: Tuple[bool, bool]:
            The elements indicate whether Master Enable 8set* and *status* are supported by the |AnalogIO| device.
    ...
    def channelNodeSetInfo(self, channel_index: int, node_index: int) -> Tuple[float, float, int]:
        ...
        Returns:
            Tuple[float, float, int]: the minimum and maximum values for the specified node's value, and the number of resolution steps.
    ...
    def channelNodeStatusInfo(self, channel_index: int, node_index: int) -> Tuple[float, float, int]:
        ...
        Returns:
            Tuple[float, float, int]: the minimum and maximum values for the specified node, and the number of resolution steps.
    ...
    def channelNodeStatus(self, channel_index: int, node_index: int) -> float:
        """Return the most recent value reading of the node.
