...
class DigitalUart(DwfDeviceSubApi):
    ...
    def txSet(self, channel_index: int) -> None:
        """Set the channel where the UART's outgoing (TX) signal will be transmitted.
    ...
    def rxSet(self, channel_index: int) -> None:
        """Set the channel where the UART's incoming (RX) signal is received.
