...
class DwfLibrary:
    ...
    def __init__(self, check_library_version: bool = True) -> None:
        ...
        When initializing a |DwfLibrary|, the shared library |libdwf| on which |pydwf| is built is loaded into memory.
        ...
        Raises:
            PyDwfError: The version check could not be performed do to an unexpected low-level error while querying the
                shared library version; or a version mismatch was detected.
        """
    ...
    def paramSet(self, parameter: DwfParameter, value: int) -> None:
        ...
        Parameters are settings of a specific |DwfDevice|. Different |DwfDevice| instances
        can have different values for each of the possible |DwfParameter:link| parameters.
