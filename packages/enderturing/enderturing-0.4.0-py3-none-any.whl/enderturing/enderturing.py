...
class EnderTuring:
    ...
    def __init__(self, config: Config = None):
        ...
        self.agent = Agent(self._config, self._http_client)
        self.asr = Asr(self._config, self._http_client)
        self.sessions = Sessions(self._config, self._http_client)
        self.raw = Raw(self._config, self._http_client)
