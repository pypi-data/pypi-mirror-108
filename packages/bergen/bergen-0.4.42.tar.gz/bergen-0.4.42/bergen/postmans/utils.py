...
def build_assign_message(reference, reservation, args, kwargs, with_progress=False, context=None, persist=False):
...
def build_unassign_messsage(reference, assignation, with_progress=False, context=None, persist=False):
    assert reference is not None, "Must have a reference"
    data= {
...
def build_reserve_message(reference, node_id: str, template_id: str, provision: str, params_dict: dict = {}, with_progress=False, context=None):
    assert reference is not None, "Must have a reference"
...
def build_unreserve_messsage(reference, reservation, with_progress=False, context=None):
    assert reference is not None, "Must have a reference"
    data= {
                                        "reservation": reservation
    }
