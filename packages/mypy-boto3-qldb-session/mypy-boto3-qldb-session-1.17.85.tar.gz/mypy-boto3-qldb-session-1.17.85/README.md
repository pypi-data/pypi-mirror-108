# mypy-boto3-qldb-session<a id="mypy-boto3-qldb-session"></a>
...
[boto3.QLDBSession 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/qldb-session.html#QLDBSession)
