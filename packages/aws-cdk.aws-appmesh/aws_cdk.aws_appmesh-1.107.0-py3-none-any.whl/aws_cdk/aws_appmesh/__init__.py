...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appmesh.TlsListener",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appmesh.TlsValidationAcmTrustOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appmesh.TlsValidationFileTrustOptions",
    jsii_struct_bases=[],
    name_mapping={"certificate_chain": "certificateChain"},
)
