...
project_requirements = get_requires("conanx/requirements.txt")

if platform.system() == "Darwin":
    project_requirements.extend(get_requires("conanx/requirements_osx.txt"))
dev_requirements = get_requires("conanx/requirements_dev.txt")
...
setup(
    ...
    url='https://edgetoolkit.github.io/conanx',
    ...
    package_data={'conanx': _DATA_FILES},
    ...
    entry_points={
        'console_scripts': [
            'conanx=conanx.main:main_entry',
            'conanx.test=conanx.main:test_main'
        ],
    },
)
