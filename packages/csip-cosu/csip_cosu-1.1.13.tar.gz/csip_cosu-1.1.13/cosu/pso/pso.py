...
def eval_cost(x, step_param_names, step_objfunc, calib_params, req_queue, files, url, param, conf: Dict, r, s):
    ...
    while pfail_retry > 0:
        ...
        for i_particle in range(no_particles):
            req_queue.put((r, s, i_particle, x, step_param_names, calib_params, step_objfunc, res_queue))
...
def global_best(steps: Dict, rounds: Tuple, args: Dict, n_particles: int, iters: int, options: Dict,
                ...
                full_trace: List = None, rounds_below: int = 1, conf: Dict = None) -> Tuple:
