...
class adquality_reports:
  ...
  @classmethod
  def dataframe_transform(self, requested_value):
    """
  ...
  def report_generator(self, since = None, until = None, country = None, report_type = None):
    ...
    report = adquality_reports.dataframe_transform(requested)
    return report
