...
class EventStub(object):
    ...
    def __init__(self, channel):
        ...
        self.parse = channel.unary_unary(
                ...
                response_deserializer=spaceone_dot_api_dot_monitoring_dot_plugin_dot_event__pb2.EventInfo.FromString,
                )
...
def add_EventServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'parse': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=spaceone_dot_api_dot_monitoring_dot_plugin_dot_event__pb2.EventInfo.SerializeToString,
            ),
    }
...
class Event(object):
    ...
    def parse(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.plugin.Event/parse',
            ...
            spaceone_dot_api_dot_monitoring_dot_plugin_dot_event__pb2.EventInfo.FromString,
