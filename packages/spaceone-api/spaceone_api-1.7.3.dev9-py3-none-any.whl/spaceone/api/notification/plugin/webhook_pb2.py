...
# source: spaceone/api/notification/plugin/webhook.proto
...
InitRequest = _reflection.GeneratedProtocolMessageType('InitRequest', (_message.Message,), {
  ...
  '__module__' : 'spaceone.api.notification.plugin.webhook_pb2'
...
_WEBHOOK = _descriptor.ServiceDescriptor(
  name='Webhook',
  full_name='spaceone.api.notification.plugin.Webhook',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='init',
    full_name='spaceone.api.notification.plugin.Webhook.init',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='verify',
    full_name='spaceone.api.notification.plugin.Webhook.verify',
    index=1,
    containing_service=None,
