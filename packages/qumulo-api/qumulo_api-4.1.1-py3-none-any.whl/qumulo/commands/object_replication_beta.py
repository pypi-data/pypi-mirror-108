...
import qumulo.rest.object_replication_beta as replication_rest

from qumulo.commands.object_replication import (
    BUCKET_STYLE_CHOICES,
...
class CreateObjectRelationshipCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_create_object_relationship'

    SYNOPSIS = """
    (EVALUATION USE ONLY) Create an object replication relationship that initiates
    a copy of file data to or from S3.
    """
    ...
    Create an object replication relationship that initiates a copy of file
    data to or from S3.
    """
...
class ListObjectRelationshipsCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_list_object_relationships'
...
class GetObjectRelationshipCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_get_object_relationship'
...
class DeleteObjectRelationshipCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_delete_object_relationship'
...
class AbortObjectReplicationCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_abort_object_replication'
...
class ListObjectRelationshipStatusesCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_list_object_relationship_statuses'
...
class GetObjectRelationshipStatusCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_get_object_relationship_status'
...
class StartObjectRelationshipCommand(qumulo.lib.opts.Subcommand):
    NAME = 'replication_beta_start_object_relationship'

    SYNOPSIS = (
        'Start a new replication job for an existing object replication relationship'
    )
