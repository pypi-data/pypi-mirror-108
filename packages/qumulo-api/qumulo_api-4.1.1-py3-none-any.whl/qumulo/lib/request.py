...
PagingRequestFunction = TypeVar(
    'PagingRequestFunction', bound=Callable[..., 'PagingIterator']
)
...
class Connection:
    ...
    ) -> HTTPSConnectionWithSocketOptions:
        kwargs: Dict[str, Any] = {
...
class RequestError(Exception):
    ...
    def __init__(
        ...
        status_code: int,
        status_message: str,
        json_error: Optional[Mapping[str, Any]] = None,
    ):
