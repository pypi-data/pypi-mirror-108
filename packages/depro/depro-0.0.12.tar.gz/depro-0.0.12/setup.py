...
__version__ = "0.0.12" # major.minor[.patch[.sub]] 

sys.path.append('.\\main')
sys.path.append('.\\tests')

REQUIRED_PKG = ['numpy','scipy','pandas','sklearn','statsmodels','tqdm','xlrd','matplotlib','seaborn','enan']
...
setup(
    name='depro',
    version=__version__,
    description="a package for Decomposition of Profile Data", # short description
