...
class GeneratePdfCall(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if instance:
            ...
            if pdf:
                ...
                filename = "Contribution_call_%s.pdf" %("1234")
    ...
    def post(self, request, *args, **kwargs):
        ...
        if validators.url(request.data.urlid):
            ...
            if pdf:
                response = HttpResponse(pdf,content_type='application/pdf')
                filename = "Appel à cotisation 2021.pdf"
                content = "inline; filename='%s'" %(filename)
                response['Content-Disposition'] = content
                return response
...
class GeneratePdfReceipt(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if instance:
            ...
            if pdf:
                response = HttpResponse(pdf,content_type='application/pdf')
                filename = "Recu de cotisation 2021.pdf"
                content = "inline; filename='%s'" %(filename)
                response['Content-Disposition'] = content
                return response
    ...
    def post(self, request, *args, **kwargs):
        ...
        if validators.url(request.data.urlid):
            ...
            if pdf:
                response = HttpResponse(pdf,content_type='application/pdf')
                filename = "Contribution_receipt_%s.pdf" %("1234")
                content = "inline; filename='%s'" %(filename)
                response['Content-Disposition'] = content
                return response
