...
from flywheel_gear_toolkit.utils import MetadataEncoder, convert_nan_in_dict
...
class GearToolkitContext:
    ...
    def log_metadata(self):
        log.info(
            ".metadata.json:\n%s",
            json.dumps(self._metadata, indent=2, cls=MetadataEncoder),
        )

    def clean_metadata(self):
        """Clean metadata."""
        # handles nan and inf which are not valid JSON (converting to None)
