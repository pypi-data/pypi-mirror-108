...
def get_featuregenes(G, dat_info, odir, cvidx):
	...
	for i in dat_info.groups:
		for g in st_genes[i]:
			...
			gout.write('%s,%s\t%d\t%s\n'%(dat_info.genelist.index[g], dat_info.genelist.iloc[g,0], g, i))
			feature_genes.append([dat_info.genelist.index[g], dat_info.genelist.iloc[g,0], g, i])
