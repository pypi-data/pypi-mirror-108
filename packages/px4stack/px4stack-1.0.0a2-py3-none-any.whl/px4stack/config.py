...
class Px4ContainerConfig:
    ...
    image: str = attrib(f"registry.gitlab.com/sbtg/px4stack/px4:{pkg_version}", converter=str)
...
class MavsdkContainerConfig:
    ...
    image: str = attrib(f"registry.gitlab.com/sbtg/px4stack/mavsdk:{pkg_version}", converter=str)
    command: Optional[str] = attrib(None, converter=optional(str))
