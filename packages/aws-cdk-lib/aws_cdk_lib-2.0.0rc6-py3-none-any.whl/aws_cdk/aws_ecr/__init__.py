...
class CfnRepository(
    ...
    def encryption_configuration(self) -> typing.Any:
        ...
        '''
        return typing.cast(typing.Any, jsii.get(self, "encryptionConfiguration"))

    @encryption_configuration.setter
    def encryption_configuration(self, value: typing.Any) -> None:
