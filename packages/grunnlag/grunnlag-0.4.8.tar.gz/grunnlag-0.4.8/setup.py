...
packages = \
['grunnlag', 'grunnlag.graphql.mutations', 'grunnlag.graphql.queries']
...
extras_require = \
{':python_version >= "3.6" and python_version < "4.0"': ['s3fs>=2021.5.0,<2022.0.0'],
 ':python_version >= "3.8" and python_version < "4.0"': ['s3fs>=0.6.0,<0.7.0']}
