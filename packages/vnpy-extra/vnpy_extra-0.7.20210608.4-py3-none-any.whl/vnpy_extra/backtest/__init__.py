...
def mock_load_bar_data(
    ...
    if load_continue_data:
        ...
        write_log_func(f"加载{is_main_str}/当期合约分别：\n"
                       f"[{main_symbol:^11}] {data_len:6,d}条，[{symbol:^11}] {data_sub_len:6,d}条，"
...
ALL_VT_SYMBOL_LIST = [
    ...
    "MA9999.CZCE",  # 甲醇
    "TA9999.CZCE",  # PTA
    # "UR9999.CZCE",  # 尿素 2019-08-09 上市，满两年后再说
    "EG9999.DCE",  # 甘醇
    "FU9999.SHFE",  # 燃油
    "L9999.DCE",  # 塑料
    "PP9999.DCE",  # PP 聚丙烯
    ...
    "SP9999.SHFE",  # 纸浆
    "SC9999.INE",  # 原油
    # "NR9999.INE",  # 20号胶  # 2019-08-12 上市，满两年后再说
    ...
    # "JR9999.CZCE",  # 硬稻  # 历史行情不够活跃 2013-11-18
    # "LR9999.CZCE",  # 晚稻  # 交易不活跃
    "M9999.DCE",  # 豆粕
    # "RR9999.DCE",  # 硬米  # 历史数据太短，但行情比流畅，可以使尝试 2019-08-16
    "OI9999.CZCE",  # 菜籽油
    "Y9999.DCE",  # 大豆原油
    "RM9999.CZCE",  # 菜籽粕
    "P9999.DCE",  # 棕榈油
