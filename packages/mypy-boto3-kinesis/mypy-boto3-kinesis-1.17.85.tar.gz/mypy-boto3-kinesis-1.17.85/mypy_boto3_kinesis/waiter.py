...
class StreamExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/kinesis.html#Kinesis.Waiter.StreamExistsWaiter)
...
class StreamNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/kinesis.html#Kinesis.Waiter.StreamNotExistsWaiter)
