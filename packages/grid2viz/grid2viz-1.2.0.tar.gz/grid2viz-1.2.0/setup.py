...
packages = \
['grid2viz',
 'grid2viz.data.rte_case14_realistic',
 'grid2viz.src',
...
{'': ['*'],
 'grid2viz': ['assets/*',
              ...
              'data/agents_test/do-nothing-baseline/*',
              'data/agents_test/do-nothing-baseline/000/*',
              'data/agents_test/do-nothing-baseline/001/*',
              'data/agents_test/multiTopology-baseline/*',
              'data/agents_test/multiTopology-baseline/000/*',
              'data/agents_test/redispatching-baseline/*',
              'data/agents_test/redispatching-baseline/000/*',
              'data/rte_case14_realistic/chronics/000/*',
              'data/rte_case14_realistic/chronics/001/*']}
