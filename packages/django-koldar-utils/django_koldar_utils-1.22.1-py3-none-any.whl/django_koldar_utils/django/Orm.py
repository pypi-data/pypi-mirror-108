...
class Orm:
    ...
    @classmethod
    def required_blank_text(cls, description: str, default_value: Union[str, Callable[[], str]] = None) -> models.TextField:
        """
    ...
    @classmethod
    def required_email(cls, help_text: str, max_length: int = 250, default_value: Union[str, Callable[[], str]] = None) -> models.TextField:
        """
        Tells Django that the model has a string field. If default value is set, it is the value added to the database
        if the user does not provide a value. The field itself is non nullable
    ...
    @classmethod
    def required_unique_string(cls, help_text: str, default_value: Union[str, Callable[[], str]] = None) -> models.TextField:
        """
        Tells Django that the model has a string field. If default value is set, it is the value added to the database
        if the user does not provide a value. The field itself is non nullable
    ...
    @classmethod
    def nullable_string(cls, help_text: str, default_value: Union[str, Callable[[], str]] = None) -> models.TextField:
        """
        Tells Django that the model has a string field. If default value is set, it is the value added to the database
    ...
    @staticmethod
    def required_boolean(help_text: str, default_value: Union[bool, Callable[[], bool]] = None) -> models.BooleanField:
        return Orm.generic_field_simple(
