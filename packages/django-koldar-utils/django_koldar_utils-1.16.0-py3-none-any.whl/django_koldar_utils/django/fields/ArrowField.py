...
class ArrowField(models.DateTimeField):

    description = "A value encapsulating a time using arrow project"
    ...
    def get_prep_value(self, value) -> Optional[datetime.datetime]:
        """
    ...
    def to_python(self, value) -> Optional[arrow.Arrow]:
        """
