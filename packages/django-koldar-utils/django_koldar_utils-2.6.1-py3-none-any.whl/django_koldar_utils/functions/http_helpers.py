...
def send_json_and_return_json(url: str, http_method: str, json_body: Union[str, Dict[str, any]], headers: Dict[str, str] = None, url_params: Dict[str, str] = None) -> Tuple[int, object]:
    """
    ...
    :param json_body: data to send to the request. Can be a dictionary or a string. if it is a string, it is first
        converted into a dictionary via json.loads
