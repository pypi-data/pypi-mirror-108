...
def get_primitive_fields(model_type: type) -> Iterable[models.Field]:
    """
    generates an iterator of fields that are primitive (i.e., not relatonships)

    :param model_type: type of model of django that we need to consider
...
def get_primitive_field_names(model_type: type) -> Iterable[models.Field]:
    """
    generates an iterator of field names that are primitive (i.e., not relatonships)

    :param model_type: type of model of django that we need to consider
    :return: iterator of fields
    """
    yield from map(lambda x: x.attname, get_primitive_fields(model_type))
