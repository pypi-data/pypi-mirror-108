/*! For license information please see chunk.86766f3021d619105f53.js.LICENSE.txt */
(self.webpackChunkopenpeerpower_frontend=self.webpackChunkopenpeerpower_frontend||[]).push([[9568,3122],{63207:(e,t,r)=>{"use strict";r(65660),r(15112);var i=r(9672),o=r(87156),n=r(50856),s=r(65233);(0,i.k)({_template:n.d`
    <style>
      :host {
        @apply --layout-inline;
      ...
      >
        ...
        <ha-config-section .narrow=${this.narrow} .isWide=${this.isWide}>
          ...
          <div slot="introduction">
            ${this.opp.localize("ui.panel.config.zwave_js.dashboard.introduction")}
          </div>
          ${this._network?o.dy`
                <ha-card class="content network-status">
                  <div class="card-content">
                    <div class="heading">
                      <div class="icon">
                        ${"connecting"===this._status?o.dy`<ha-circular-progress
                              active
                            ></ha-circular-progress>`:o.dy`
                              <ha-svg-icon
                                .path=${this._icon}
                      ...
                      ${"connecting"!==this._status?o.dy`
                            <div class="details">
                              ${this.opp.localize("ui.panel.config.zwave_js.common.network")}
                              ${this.opp.localize(`ui.panel.config.zwave_js.network_status.${this._status}`)}<br />
                              <small
                    ...
                    <div class="secondary">
                      ${this.opp.localize("ui.panel.config.zwave_js.dashboard.driver_version")}:
                      ${this._network.client.driver_version}<br />
                      ${this.opp.localize("ui.panel.config.zwave_js.dashboard.server_version")}:
                      ${this._network.client.server_version}<br />
                      ${this.opp.localize("ui.panel.config.zwave_js.dashboard.home_id")}:
                      ${this._network.controller.home_id}<br />
                      ${this.opp.localize("ui.panel.config.zwave_js.dashboard.nodes_ready")}:
                  ...
                  <div class="card-actions">
                    ...
                    <mwc-button @click=${this._addNodeClicked}>
                      ${this.opp.localize("ui.panel.config.zwave_js.common.add_node")}
                    </mwc-button>
                    <mwc-button @click=${this._removeNodeClicked}>
                      ${this.opp.localize("ui.panel.config.zwave_js.common.remove_node")}
                    </mwc-button>
                  </div>
                </ha-card>
              `:""}
          <button class="link dump" @click=${this._dumpDebugClicked}>
            ${this.opp.localize("ui.panel.config.zwave_js.dashboard.dump_debug")}
          </button>
        </ha-config-section>
      </opp-tabs-subpage>
    `}},{kind:"method",key:"_fetchData",value:async function(){this.configEntryId&&(this._network=await(0,a.HV)(this.opp,this.configEntryId),this._status=this._network.client.state,"connected"===this._status&&(this._icon=i.OE9),this._fetchNodeStatus())}},{kind:"method",key:"_fetchNodeStatus",value:async function(){if(!this._network)return;const e=this._network.controller.nodes.map((e=>(0,a.$L)(this.opp,this.configEntryId,e)));this._nodes=await Promise.all(e)}},{kind:"method",key:"_addNodeClicked",value:async function(){var e,t;e=this,t={entry_id:this.configEntryId},(0,d.B)(e,"show-dialog",{dialogTag:"dialog-zwave_js-add-node",dialogImport:p,dialogParams:t})}},{kind:"method",key:"_removeNodeClicked",value:async function(){var e,t;e=this,t={entry_id:this.configEntryId},(0,d.B)(e,"show-dialog",{dialogTag:"dialog-zwave_js-remove-node",dialogImport:h,dialogParams:t})}},{kind:"method",key:"_dumpDebugClicked",value:async function(){var e,t;await this._fetchNodeStatus();const r=null===(e=this._nodes)||void 0===e?void 0:e.filter((e=>!e.ready)),i=null===(t=this._nodes)||void 0===t?void 0:t.filter((e=>e.status===a.e4.Dead));if((null==i?void 0:i.length)&&await(0,l.Ys)(this,{title:this.opp.localize("ui.panel.config.zwave_js.dashboard.dump_dead_nodes_title"),text:this.opp.localize("ui.panel.config.zwave_js.dashboard.dump_dead_nodes_text")}),(null==r?void 0:r.length)&&r.length!==(null==i?void 0:i.length)&&!await(0,l.g7)(this,{title:this.opp.localize("ui.panel.config.zwave_js.dashboard.dump_not_ready_title"),text:this.opp.localize("ui.panel.config.zwave_js.dashboard.dump_not_ready_text"),confirmText:this.opp.localize("ui.panel.config.zwave_js.dashboard.dump_not_ready_confirm")}))return;let o;try{o=await(0,s.iI)(this.opp,`/api/zwave_js/dump/${this.configEntryId}`)}catch(e){return void(0,l.Ys)(this,{title:"Error",text:e.error||e.body||e})}const n=document.createElement("a");n.href=o.path,n.download="zwave_js_dump.jsonl",this.shadowRoot.appendChild(n),n.click(),this.shadowRoot.removeChild(n)}},{kind:"get",static:!0,key:"styles",value:function(){return[c.Qx,o.iv`
        .secondary {
      ...
      `]}}]}}),o.oi)}}]);
//# sourceMappingURL=chunk.86766f3021d619105f53.js.map