      ...
      <hui-generic-entity-row .opp=${this.opp} .config=${this._config}>
        ${"slider"===e.attributes.mode?i.dy`
              <div class="flex">
                ...
                ></ha-slider>
                <span class="state">
                  ${(0,n.D)(this.opp.localize,e,this.opp.locale,e.state)}
                </span>
              </div>
            `:i.dy`
