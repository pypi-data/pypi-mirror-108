(self.webpackChunkopenpeerpower_frontend=self.webpackChunkopenpeerpower_frontend||[]).push([[3699],{93699:(e,i,r)=>{"use strict";r.r(i);r(30879);var o=r(50856),a=r(28426),s=(r(98762),r(22098),r(20482),r(11052)),l=r(1265),n=(r(25409),r(27322));r(88165);class t extends((0,l.Z)((0,s.I)(a.H3))){static get template(){return o.d`
          ...
          <div slot="introduction">
            ...
            <p>
              [[localize('ui.panel.config.cloud.register.information4')]]
                ...
                <li><a href="[[_computeDocumentationUrlTos(opp)]]" target="_blank" rel="noreferrer">[[localize('ui.panel.config.cloud.register.link_terms_conditions')]]</a></li>
                <li><a href="[[_computeDocumentationUrlPrivacy(opp)]]" target="_blank" rel="noreferrer">[[localize('ui.panel.config.cloud.register.link_privacy_policy')]]</a></li>
              </ul>
            </p>
          </div>
...
`}static get properties(){return{opp:Object,isWide:Boolean,narrow:Boolean,email:{type:String,notify:!0},_requestInProgress:{type:Boolean,value:!1},_password:{type:String,value:""},_error:{type:String,value:""}}}static get observers(){return["_inputChanged(email, _password)"]}_inputChanged(){this._error="",this.$.email.invalid=!1,this.$.password.invalid=!1}_keyDown(e){13===e.keyCode&&(this._handleRegister(),e.preventDefault())}_computeDocumentationUrlTos(e){return(0,n.R)(e,"/tos/")}_computeDocumentationUrlPrivacy(e){return(0,n.R)(e,"/privacy/")}_handleRegister(){let e=!1;this.email&&this.email.includes("@")||(this.$.email.invalid=!0,this.$.email.focus(),e=!0),this._password.length<8&&(this.$.password.invalid=!0,e||(e=!0,this.$.password.focus())),e||(this._requestInProgress=!0,this.opp.callApi("post","cloud/register",{email:this.email,password:this._password}).then((()=>this._verificationEmailSent()),(e=>{this._password="",this.setProperties({_requestInProgress:!1,_error:e&&e.body&&e.body.message?e.body.message:"Unknown error"})})))}_handleResendVerifyEmail(){this.email?this.opp.callApi("post","cloud/resend_confirm",{email:this.email}).then((()=>this._verificationEmailSent()),(e=>this.setProperties({_error:e&&e.body&&e.body.message?e.body.message:"Unknown error"}))):this.$.email.invalid=!0}_verificationEmailSent(){this.setProperties({_requestInProgress:!1,_password:""}),this.fire("cloud-done",{flashMessage:this.opp.localize("ui.panel.config.cloud.register.account_created")})}}customElements.define("cloud-register",t)},27322:(e,i,r)=>{"use strict";r.d(i,{R:()=>o});const o=(e,i)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.openpeerpower.io${i}`}}]);
//# sourceMappingURL=chunk.7b0773f431a3ba256410.js.map