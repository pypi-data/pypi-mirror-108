...
void controller_marino2005(){
    ...
    flux_observer();
        ...
        marino.psi_Dmu = AB2M(exact.psi_2_real_output[0], exact.psi_2_real_output[1], CTRL.S->cosT, CTRL.S->sinT);
        marino.psi_Qmu = AB2T(exact.psi_2_real_output[0], exact.psi_2_real_output[1], CTRL.S->cosT, CTRL.S->sinT);
        ...
        /*picorr*/
        marino.psi_Dmu = AB2M(picorr.psi_2[0], picorr.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);
        marino.psi_Qmu = AB2T(picorr.psi_2[0], picorr.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);
        ...
        /*lascu*/
        marino.psi_Dmu = AB2M(lascu.psi_2[0], lascu.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);
        marino.psi_Qmu = AB2T(lascu.psi_2[0], lascu.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);

        /*clest*/
        marino.psi_Dmu = AB2M(clest.psi_2[0], clest.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);
        marino.psi_Qmu = AB2T(clest.psi_2[0], clest.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);

        /*holtz2003*/
        marino.psi_Dmu = AB2M(htz.psi_2[0], htz.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);
        marino.psi_Qmu = AB2T(htz.psi_2[0], htz.psi_2[1], CTRL.S->cosT, CTRL.S->sinT);
