...
class ThreadedProducer(ServiceThread):
    ...
    def _new_producer(self, transactional_id: str = None) -> aiokafka.AIOKafkaProducer:
        default_settings = self._default_producer._settings_default()
        default_settings['client_id'] = f"{default_settings['client_id']}-threaded"
...
class Producer(base.Producer):
    ...
    def _ensure_producer(self) -> aiokafka.AIOKafkaProducer:
        ...
        if not self._producer._metadata:
            self._producer.client.force_metadata_update()
