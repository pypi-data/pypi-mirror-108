# mypy-boto3-autoscaling-plans<a id="mypy-boto3-autoscaling-plans"></a>
...
[boto3.AutoScalingPlans 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/autoscaling-plans.html#AutoScalingPlans)
