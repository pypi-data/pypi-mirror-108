...
from .teiauxiliary import write_html, load_directories, check_iterable,\
    check_bool, check_str, check_scenario
from .cssbuilder import CSSBuilder
from .pathvalidator import PathValidator
from .teixml import TEIXML
from .oddprocessor import ODDProcessor
from .loadsetup import HTMLT_CFG, TT_CFG, filenames
...
#         xsl_path = os.path.join(HTMLT_CFG["PATHS"]["xsl_dir"], filename)
        ...
        xsl_path = filenames['xsl'][filename]
...
#         full_page = etree.parse(HTMLT_CFG['PATHS']['doc_temp'])
		full_page = etree.parse(filenames['templates']['document7.html'])
...
class HTMLBuilder(FullPageMaker, ReferenceFinder):
    ...
    def __init__(self, scenario="drama", output_format='html'):
        ...
        self.modules_available = ['drama', 'verse', 'book']
