...
class GameObject:
    def __init__(self, name: str, images: Image = default_icon, size: Vector2 = Vector2(),
...
class Button:
    def __init__(self, name: str, button_text: TextBox = TextBox("NewButtonTextBox", "Button", 32),
                 ...
                 button_image: Image = Image(
                     os.path.abspath(__file__)[0: len(os.path.abspath(__file__)) - 13] + "Default_Button.PNG")
                 , order: int = 1):
        self.name = name
        self.id = makeId()
        self.order = order
