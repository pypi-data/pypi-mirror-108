...
class TimeManager:
    ...
    def invoke(self,function, delay:int = 1):
        self.invokeFunctions.append([function, time.time(), delay])
...
global Input, Console, StandardColor, default_icon, SoundManager, Time
Input = InputManager()
