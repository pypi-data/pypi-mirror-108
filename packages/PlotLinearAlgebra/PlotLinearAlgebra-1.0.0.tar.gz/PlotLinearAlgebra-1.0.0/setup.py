...
setup(
    ...
    description='Herramientas para la representación gráfica de vectores en el plano y en el espacio',
    long_description=read("README.rst"),
    author='Jhonny Osorio Gallego',
    author_email='osoriojohnny1986@gmail.com',
    url='https://github.com/josorio398',
    download_url='https://github.com/josorio398/ALGEBRA-LINEAL-CON-PYTHON/blob/master/plotvectors.py'.format(
        VERSION),
    keywords=['LinearAlgebra','Linearalgebra','plotvectors','plotvector','vectorplot','vectorsplot','algebralineal'],
    install_requires=[
        'plotly','numpy','sympy',
    ],
    setup_requires=['plotly','numpy','sympy'],
    tests_require=[
        'pytest',
        'pytest-cov',
        'pytest-html',
