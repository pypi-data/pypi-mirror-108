from hestia_earth.schema import CycleFunctionalUnitMeasure, PropertyStatsDefinition
...
def _should_run(cycle: dict):
    should_run = cycle.get('functionalUnitMeasure') == CycleFunctionalUnitMeasure._1_HA.value
    logger.info('model=%s, term=%s, should_run=%s', MODEL, TERM_ID, should_run)
    return should_run
