...
from hestia_earth.models.stehfestBouwman2006GisImplementation.noxToAirCropResidueDecomposition import TERM_ID, run
...
class TestNoxToAirCropResidueDecomposition(unittest.TestCase):
