...
def _should_run(cycle: dict):
    inputs = _filter_list_term_type(cycle.get('inputs', []), TermTermType.SOILAMENDMENT)
    ...
    should_run = valid_site_type(cycle, True) and len(CaCO3_values) > 0 and len(MgCO3_values) > 0
