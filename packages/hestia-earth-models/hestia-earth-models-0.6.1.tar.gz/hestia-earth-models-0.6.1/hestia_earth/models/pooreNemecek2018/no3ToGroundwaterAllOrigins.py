...
from hestia_earth.models.utils.product import get_average_rooting_depth, residue_nitrogen
...
def _should_run(cycle: dict):
    ...
    rainfall = most_relevant_measurement_value(measurements, 'rainfallAnnual', end_date)
    ...
    return should_run, [rooting_depth, list_average(clay), list_average(sand), list_average(rainfall), primary_product]
...
def _get_value(content_list_of_items: list):
    ...
    logger.debug('term=%s, leaching_factor=%s', TERM_ID, value)
