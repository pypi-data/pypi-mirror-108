...
from hestia_earth.models.stehfestBouwman2006GisImplementation.noxToAirAllOrigins import TERM_ID, run, _get_value, \
    _should_run
...
def test_get_value():
    country_id = 'GADM-GBR'
    N_total = 7
    assert _get_value(country_id, N_total) == 0.027810475
