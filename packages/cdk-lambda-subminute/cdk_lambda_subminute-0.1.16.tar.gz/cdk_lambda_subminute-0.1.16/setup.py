    ...
    """
{
    ...
    "package_data": {
        "cdk_lambda_subminute._jsii": [
            "cdk-lambda-subminute@0.1.16.jsii.tgz"
        ],
        "cdk_lambda_subminute": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-nodejs>=1.107.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.107.0, <2.0.0",
        "aws-cdk.aws-logs>=1.107.0, <2.0.0",
        "aws-cdk.aws-stepfunctions-tasks>=1.107.0, <2.0.0",
        "aws-cdk.aws-stepfunctions>=1.107.0, <2.0.0",
