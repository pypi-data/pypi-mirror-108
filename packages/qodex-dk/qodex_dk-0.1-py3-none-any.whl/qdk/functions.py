...
def execute_method(sdk_client, methods_dict, method_name, *args, **kwargs):
...
def get_method(methods_dict, method_name, *args, **kwargs):
    ...
    try:
        ...
        return {'status': 'failed', 'info': 'Метод {} не поддерживается в QDK. Что бы получить список поддреживаемых '
