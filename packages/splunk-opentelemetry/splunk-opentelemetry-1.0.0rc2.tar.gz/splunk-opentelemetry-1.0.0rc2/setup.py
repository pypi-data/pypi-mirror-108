...
['opentelemetry-api>=1.3.0,<2.0.0',
 ...
 'opentelemetry-sdk>=1.3.0,<2.0.0']

extras_require = \
{'all': ['opentelemetry-propagator-b3>=1.3.0,<2.0.0',
         'opentelemetry-exporter-jaeger-thrift>=1.3.0,<2.0.0',
         'opentelemetry-exporter-otlp-proto-grpc>=1.3.0,<2.0.0'],
 'b3': ['opentelemetry-propagator-b3>=1.3.0,<2.0.0'],
 'jaeger': ['opentelemetry-exporter-jaeger-thrift>=1.3.0,<2.0.0'],
 'otlp': ['opentelemetry-exporter-otlp-proto-grpc>=1.3.0,<2.0.0']}
