# mypy-boto3-timestream-query<a id="mypy-boto3-timestream-query"></a>
...
[boto3.TimestreamQuery 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/timestream-query.html#TimestreamQuery)
