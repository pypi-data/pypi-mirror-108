...
class LhystudiosAccelerationChart(MWindow):
    def __init__(self, *args, **kwds):
        ...
        self.checkbox_vraster_accel_enable = wx.CheckBox(self, wx.ID_ANY, "Enable")
        ...
        self.text_vraster_accel_4 = wx.TextCtrl(self, wx.ID_ANY, "infinity")
    ...
    def __set_properties(self):
        ...
        self.text_vraster_accel_2.SetToolTip("Upper limit for accel level 2")
        self.text_vraster_accel_2.Enable(False)
        self.text_vraster_accel_3.SetMinSize((55, 23))
        self.text_vraster_accel_3.SetToolTip("Upper limit for accel level 3")
    ...
    def __do_layout(self):
        ...
        label_10 = wx.StaticText(self, wx.ID_ANY, "mm/s")
        ...
        label_12 = wx.StaticText(self, wx.ID_ANY, "mm/s")
        ...
        label_23 = wx.StaticText(self, wx.ID_ANY, "mm/s")
        ...
        label_25 = wx.StaticText(self, wx.ID_ANY, "mm/s")
