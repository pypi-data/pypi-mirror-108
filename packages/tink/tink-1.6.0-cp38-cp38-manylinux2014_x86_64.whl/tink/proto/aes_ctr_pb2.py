...
AesCtrParams = _reflection.GeneratedProtocolMessageType('AesCtrParams', (_message.Message,), dict(
...
AesCtrKeyFormat = _reflection.GeneratedProtocolMessageType('AesCtrKeyFormat', (_message.Message,), dict(
...
AesCtrKey = _reflection.GeneratedProtocolMessageType('AesCtrKey', (_message.Message,), dict(
