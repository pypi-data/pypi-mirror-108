# mypy-boto3-codepipeline<a id="mypy-boto3-codepipeline"></a>
...
[boto3.CodePipeline 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/codepipeline.html#CodePipeline)
