...
def _join_fetch_query(
    ...
    sync_times_name = sql_item_name(sync_times_table, pipe.instance_connector.flavor)
    id_name = sql_item_name(pipe.columns['id'], pipe.instance_connector.flavor)
    dt_name = sql_item_name(pipe.columns['datetime'], pipe.instance_connector.flavor)
