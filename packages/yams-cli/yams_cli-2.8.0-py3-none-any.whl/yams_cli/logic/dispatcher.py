...
class Dispatcher(object):
    ...
    def image_fetch(self, args):
        ...
        if rule_id:
            self._print_url(self._manager.fetch_object(self.tenant_id, domain_id, bucket_id, object_id, rule_id))
        elif rule_json:
            rule_json = json.loads(rule_json)
            self._print_url(
                self._manager.fetch_object_with_rule(self.tenant_id, domain_id, bucket_id, object_id, rule_json))
        else:
    ...
    def document_fetch(self, args):
        ...
        if rule_id:
            self._print_url(self._manager.fetch_document(self.tenant_id, domain_id, bucket_id, object_id, rule_id))
        elif rule_json:
            rule_json = json.loads(rule_json)
            self._print_url(
                self._manager.fetch_document_with_rule(self.tenant_id, domain_id, bucket_id, object_id, rule_json))
        else:
    ...
    def static_fetch(self, args):
        ...
        bucket_id = args['bucket_id']
        object_id = args['object_id']
        self._print_url(self._manager.fetch_static_object(self.tenant_id, domain_id, bucket_id, object_id))
        return True
