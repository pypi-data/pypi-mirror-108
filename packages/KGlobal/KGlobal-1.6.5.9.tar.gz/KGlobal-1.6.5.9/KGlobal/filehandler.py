...
class FileParser(object):
    ...
    def parse_csv(self, file_path, dialect=None, truncate=False, **kwargs):
        """
        ...
        self.reader = self.__engines['csv'](file_path=file_path, dialect=dialect, truncate=truncate, **kwargs)
