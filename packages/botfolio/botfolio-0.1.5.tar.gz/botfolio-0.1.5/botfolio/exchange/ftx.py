...
class FtxClient:
    ...
    def list_markets(self, symbol: str = None) -> List[dict]:
        if symbol:
            return self._get(f'markets/{symbol}')
    ...
    def get_balance_snapshots(self, start_time: str = None, end_time: str = None, limit: int = None) -> List[dict]:
        return self._get('wallet/usd_value_snapshots', {'start_time': start_time, 'end_time': end_time,'limit': limit})

    def get_deposit_history(self, start_time: str = None, end_time: str = None, limit: int = None) -> List[dict]:
        return self._get('wallet/deposits', {'start_time': start_time, 'end_time': end_time,'limit': limit})

    def get_withdrawal_history(self, start_time: str = None, end_time: str = None, limit: int = None) -> List[dict]:
        return self._get('wallet/withdrawals', {'start_time': start_time, 'end_time': end_time,'limit': limit})

    def get_pnl_historical_changes(self, start_time: str = None, end_time: str = None, limit: int = None) -> dict:
        return self._get('pnl/historical_changes',{'start_time': start_time, 'end_time': end_time,'limit': limit})

    def get_user_rewards(self) -> List[dict]:
        return self._get('user_rewards')

    def lending_info(self) -> List[dict]:
        return self._get('spot_margin/lending_info')

    def get_lending_history(self, start_time: str = None, end_time: str = None, limit: int = None) -> dict:
        return self._get('spot_margin/lending_history', {'start_time': start_time, 'end_time': end_time,'limit': limit})

    def get_funding_payments(self, start_time: str = None, end_time: str = None, limit: int = None) -> dict:
        return self._get('funding_payments', {'start_time': start_time, 'end_time': end_time,'limit': limit})
