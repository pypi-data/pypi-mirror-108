...
class SSOClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.86/reference/services/sso.html#SSO.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.86/reference/services/sso.html#SSO.Client.can_paginate)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.86/reference/services/sso.html#SSO.Client.generate_presigned_url)
    ...
    def get_role_credentials(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.86/reference/services/sso.html#SSO.Client.get_role_credentials)
    ...
    def list_account_roles(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.86/reference/services/sso.html#SSO.Client.list_account_roles)
    ...
    def list_accounts(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.86/reference/services/sso.html#SSO.Client.list_accounts)
        [Show boto3-stubs documentation](./client.md#list_accounts)
        """

    def logout(self, accessToken: str) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.86/reference/services/sso.html#SSO.Client.logout)
