...
class Authenticate():
    ...
    def loginUser(self, request):
        ...
        try:
            ...
            if loginUserRQ.getAuthenticationTypeId() == AuthenticationType.LOCAL:
                ...
                session = SessionService(self.urlEngine).createSessionByGoogleAuth(connection, loginUserRQ.getUserName(), loginUserRQ.getToken())
    ...
    def createUser(self, request):
        ...
        try:
            ...
            user = UserService(self.urlEngine).createUser(createUserRQ.getUserName(), createUserRQ.getToken(), createUserRQ.getAuthenticationTypeId(), createUserRQ.getRoleId())
