...
class Moku:
    ...
    def upload(self, target, file_name, data):
        """
        Upload files to bitstreams, persist.

        :type target: `string`, (bitstreams, persist)
    ...
    def list(self, target):
        """
        List files at bitstreams, logs, persist.
