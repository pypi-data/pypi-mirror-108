...
class PIDController(Moku):
    ...
    def set_trigger(
        ...
        :type source: `string`, {'Input1', 'Input2', 'Output1', 'Output2', 'ProbeA', 'ProbeB'} (defaults to Input1)
    ...
    def set_monitor(self, monitor_channel, source, strict=True):
        ...
        :type source: `string`, {'None', 'Input1', 'Control1', 'Output1', 'Input2', 'Control2', 'Output2'}
        ...
        params = dict(strict=strict, monitor_channel=monitor_channel, source=validate_range(
            source, list(['None', 'Input1', 'Control1', 'Output1', 'Input2', 'Control2', 'Output2'])),)
        return self.session.post(self.operation_group, operation, params)
