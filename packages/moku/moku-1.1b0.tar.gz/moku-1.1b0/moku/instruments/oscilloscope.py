...
class Oscilloscope(Moku):
    ...
    def set_source(self, channel, source, strict=True):
        ...
        :type source: `string`, {'None', 'Input1', 'Input2', 'Output1', 'Output2'}
        :param source: Set channel data source

        """
        operation = "set_source"

        params = dict(strict=strict, channel=channel, source=validate_range(
            source, list(['None', 'Input1', 'Input2', 'Output1', 'Output2'])),)
        return self.session.post(self.operation_group, operation, params)
    ...
    def osc_measurement(
        ...
        :type trigger_source: `string`, {'Input1', 'Input2', 'Output1', 'Output2'}
