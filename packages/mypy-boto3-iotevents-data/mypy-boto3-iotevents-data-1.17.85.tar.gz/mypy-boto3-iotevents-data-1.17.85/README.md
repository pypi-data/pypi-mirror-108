# mypy-boto3-iotevents-data<a id="mypy-boto3-iotevents-data"></a>
...
[boto3.IoTEventsData 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/iotevents-data.html#IoTEventsData)
