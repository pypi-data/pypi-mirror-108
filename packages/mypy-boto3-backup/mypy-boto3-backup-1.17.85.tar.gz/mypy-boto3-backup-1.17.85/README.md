# mypy-boto3-backup<a id="mypy-boto3-backup"></a>
...
[boto3.Backup 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/backup.html#Backup)
