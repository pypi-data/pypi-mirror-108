...
from nlp_tools.processors import ABCProcessor
...
class ABCSimilaryModel(ABCTaskModel,ABC):
    ...
    def to_dict(self) -> Dict:
        ...
        info['config']['use_bert'] = self.use_bert
    ...
    def __init__(self,
        ...
        if label_processor is None:
            label_processor = ClassificationProcessor()
    ...
    def fit(self,
            x_train: TextSamplesVar,
            y_train:ClassificationLabelVar,
            x_validate:TextSamplesVar = None,
            y_validate:ClassificationLabelVar = None,
            *,
            batch_size: int=64,
            epochs:int = 5,
    ...
    def fit_generator(self,
        ...
        """
                        ...
                        Returns:
                            ...
                            and validation metrics values (if applicable).
                        """
        self.build_model_generator([g for g in [train_sample_gen,valid_sample_gen]])
