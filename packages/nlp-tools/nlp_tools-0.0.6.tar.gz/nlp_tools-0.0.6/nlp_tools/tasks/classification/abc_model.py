...
from nlp_tools.metrics.multi_label_classification import multi_label_classification_report
...
class ABCClassificationModel(ABCTaskModel,ABC):
    ...
    def __init__(self,
        ...
        if text_processor is None:
            text_processor = SequenceProcessor(embedding_max_position=self.embedding.max_position)
