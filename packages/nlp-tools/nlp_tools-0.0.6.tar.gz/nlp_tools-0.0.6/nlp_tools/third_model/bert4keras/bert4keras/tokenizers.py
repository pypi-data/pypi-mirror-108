...
from nlp_tools.third_model.bert4keras.bert4keras.snippets import is_string, is_py2
from nlp_tools.third_model.bert4keras.bert4keras.snippets import open
from nlp_tools.third_model.bert4keras.bert4keras.snippets import convert_to_unicode
