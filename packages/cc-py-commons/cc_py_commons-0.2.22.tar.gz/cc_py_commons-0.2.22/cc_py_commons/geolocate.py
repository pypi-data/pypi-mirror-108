...
def __get_google_location(city, state, zipcode, logger):
  try:
    ...
    def __parse_response(response):
      ...
      postcode_localities = response[0].get('postcode_localities')
      ...
      if 'postal_code' in types:
        matches = [l for l in postcode_localities if l.lower() == city.lower()]
