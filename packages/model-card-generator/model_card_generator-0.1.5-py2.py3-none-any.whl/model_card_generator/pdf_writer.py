...
card_logo_path='assets/cne_logo.png'
...
first_page_elements = [
    ...
    { 
        ...
        'align': 'R', 'text': card_logo_path, 'priority': 2, 
    },
    { 
...
def write_first_page(model_data: ModelData, filename: str):
    """Writes model card first PDF page"""
    ...
    print(type(model_data.dataset_validation_percentage))
...
def merge_pdfs(final_filename: str, *filenames: List[str]): 
    """Merge multiples PDF files into one"""
