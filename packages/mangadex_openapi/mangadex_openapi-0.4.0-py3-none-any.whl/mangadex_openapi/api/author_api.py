...
class AuthorApi(object):
    ...
    def delete_author_id(self, id, **kwargs):  # noqa: E501
        """Delete Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_author_id(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Author ID (required)
        :return: Response
        ...
        if kwargs.get("async_req"):
            return self.delete_author_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_author_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_author_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_author_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_author_id" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `delete_author_id`"
            )  # noqa: E501
    ...
    def get_author_id(self, id, **kwargs):  # noqa: E501
        """Get Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_author_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_author_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_author_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_author_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_author_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `get_author_id`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="AuthorResponse",  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def post_author(self, **kwargs):  # noqa: E501
        """Create Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_author(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AuthorCreate body: The size of the body is limited to 2KB.
        :return: AuthorResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_author_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_author_with_http_info(**kwargs)  # noqa: E501
            return data

    def post_author_with_http_info(self, **kwargs):  # noqa: E501
        """Create Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_author_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def put_author_id(self, id, **kwargs):  # noqa: E501
        """Update Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_author_id(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Author ID (required)
        :param AuthorEdit body: The size of the body is limited to 2KB.
        :return: AuthorResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.put_author_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_author_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def put_author_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update Author  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_author_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `put_author_id`"
            )  # noqa: E501
