...
class AtHomeApi(object):
    ...
    def get_at_home_server_chapter_id(self, chapter_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_at_home_server_chapter_id_with_http_info(
                chapter_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_at_home_server_chapter_id_with_http_info(
                chapter_id, **kwargs
            )  # noqa: E501
            return data

    def get_at_home_server_chapter_id_with_http_info(
        self, chapter_id, **kwargs
    ):  # noqa: E501
        """Get MangaDex@Home server URL  # noqa: E501
        ...
        if "chapter_id" not in params or params["chapter_id"] is None:
            raise ValueError(
                "Missing the required parameter `chapter_id` when calling `get_at_home_server_chapter_id`"
            )  # noqa: E501
