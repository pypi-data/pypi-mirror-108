...
class LoginResponseToken(object):
    ...
    """
    swagger_types = {"session": "str", "refresh": "str"}

    attribute_map = {"session": "session", "refresh": "refresh"}

    def __init__(self, session=None, refresh=None):  # noqa: E501
        """LoginResponseToken - a model defined in Swagger"""  # noqa: E501
        self._session = None
        self._refresh = None
    ...
    @property
    def session(self):
        """Gets the session of this LoginResponseToken.  # noqa: E501


        :return: The session of this LoginResponseToken.  # noqa: E501
        :rtype: str
        """
    ...
    def session(self, session):
        """Sets the session of this LoginResponseToken.


        :param session: The session of this LoginResponseToken.  # noqa: E501
        :type: str
        """
    ...
    @property
    def refresh(self):
        """Gets the refresh of this LoginResponseToken.  # noqa: E501


        :return: The refresh of this LoginResponseToken.  # noqa: E501
        :rtype: str
        """
    ...
    def refresh(self, refresh):
        """Sets the refresh of this LoginResponseToken.


        :param refresh: The refresh of this LoginResponseToken.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoginResponseToken, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoginResponseToken):
            return False
