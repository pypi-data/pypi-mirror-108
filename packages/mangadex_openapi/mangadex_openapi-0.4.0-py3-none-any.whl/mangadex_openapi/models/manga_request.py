...
class MangaRequest(object):
    ...
    def __init__(
        ...
        """MangaRequest - a model defined in Swagger"""  # noqa: E501
        self._title = None
        ...
        if mod_notes is not None:
            self.mod_notes = mod_notes
        if version is not None:
            self.version = version

    @property
    def title(self):
        """Gets the title of this MangaRequest.  # noqa: E501


        :return: The title of this MangaRequest.  # noqa: E501
    ...
    def title(self, title):
        """Sets the title of this MangaRequest.


        :param title: The title of this MangaRequest.  # noqa: E501
    ...
    @property
    def alt_titles(self):
        """Gets the alt_titles of this MangaRequest.  # noqa: E501


        :return: The alt_titles of this MangaRequest.  # noqa: E501
    ...
    def alt_titles(self, alt_titles):
        """Sets the alt_titles of this MangaRequest.


        :param alt_titles: The alt_titles of this MangaRequest.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this MangaRequest.  # noqa: E501


        :return: The description of this MangaRequest.  # noqa: E501
        :rtype: LocalizedString
        """
    ...
    def description(self, description):
        """Sets the description of this MangaRequest.


        :param description: The description of this MangaRequest.  # noqa: E501
        :type: LocalizedString
        """
    ...
    @property
    def authors(self):
        """Gets the authors of this MangaRequest.  # noqa: E501


        :return: The authors of this MangaRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def authors(self, authors):
        """Sets the authors of this MangaRequest.


        :param authors: The authors of this MangaRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def artists(self):
        """Gets the artists of this MangaRequest.  # noqa: E501


        :return: The artists of this MangaRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def artists(self, artists):
        """Sets the artists of this MangaRequest.


        :param artists: The artists of this MangaRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def links(self):
        """Gets the links of this MangaRequest.  # noqa: E501


        :return: The links of this MangaRequest.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._links
    ...
    def links(self, links):
        """Sets the links of this MangaRequest.


        :param links: The links of this MangaRequest.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def original_language(self):
        """Gets the original_language of this MangaRequest.  # noqa: E501


        :return: The original_language of this MangaRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def original_language(self, original_language):
        """Sets the original_language of this MangaRequest.


        :param original_language: The original_language of this MangaRequest.  # noqa: E501
        :type: str
        """
    ...
    def last_volume(self):
        """Gets the last_volume of this MangaRequest.  # noqa: E501


        :return: The last_volume of this MangaRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def last_volume(self, last_volume):
        """Sets the last_volume of this MangaRequest.


        :param last_volume: The last_volume of this MangaRequest.  # noqa: E501
        :type: str
        """
    ...
    def last_chapter(self):
        """Gets the last_chapter of this MangaRequest.  # noqa: E501


        :return: The last_chapter of this MangaRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def last_chapter(self, last_chapter):
        """Sets the last_chapter of this MangaRequest.


        :param last_chapter: The last_chapter of this MangaRequest.  # noqa: E501
        :type: str
        """
    ...
    def publication_demographic(self):
        """Gets the publication_demographic of this MangaRequest.  # noqa: E501


        :return: The publication_demographic of this MangaRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def publication_demographic(self, publication_demographic):
        """Sets the publication_demographic of this MangaRequest.


        :param publication_demographic: The publication_demographic of this MangaRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["shounen", "shoujo", "josei", "seinen"]  # noqa: E501
        if publication_demographic not in allowed_values:
            raise ValueError(
                "Invalid value for `publication_demographic` ({0}), must be one of {1}".format(  # noqa: E501
                    publication_demographic, allowed_values
                )
            )
    ...
    @property
    def status(self):
        """Gets the status of this MangaRequest.  # noqa: E501


        :return: The status of this MangaRequest.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this MangaRequest.


        :param status: The status of this MangaRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["ongoing", "completed", "hiatus", "cancelled"]  # noqa: E501
    ...
    @property
    def year(self):
        """Gets the year of this MangaRequest.  # noqa: E501

        Year of release  # noqa: E501

        :return: The year of this MangaRequest.  # noqa: E501
        :rtype: int
        """
        return self._year
    ...
    @year.setter
    def year(self, year):
        """Sets the year of this MangaRequest.

        Year of release  # noqa: E501

        :param year: The year of this MangaRequest.  # noqa: E501
        :type: int
        """
    ...
    def content_rating(self):
        """Gets the content_rating of this MangaRequest.  # noqa: E501


        :return: The content_rating of this MangaRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def content_rating(self, content_rating):
        """Sets the content_rating of this MangaRequest.


        :param content_rating: The content_rating of this MangaRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["safe", "suggestive", "erotica", "pornographic"]  # noqa: E501
        if content_rating not in allowed_values:
            raise ValueError(
                "Invalid value for `content_rating` ({0}), must be one of {1}".format(  # noqa: E501
                    content_rating, allowed_values
                )
            )
    ...
    @property
    def mod_notes(self):
        """Gets the mod_notes of this MangaRequest.  # noqa: E501


        :return: The mod_notes of this MangaRequest.  # noqa: E501
        :rtype: str
        """
        return self._mod_notes

    @mod_notes.setter
    def mod_notes(self, mod_notes):
        """Sets the mod_notes of this MangaRequest.


        :param mod_notes: The mod_notes of this MangaRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this MangaRequest.  # noqa: E501


        :return: The version of this MangaRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this MangaRequest.


        :param version: The version of this MangaRequest.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MangaRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MangaRequest):
            return False
