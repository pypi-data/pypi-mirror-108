...
class InlineResponse2004(object):
    ...
    """
    swagger_types = {"result": "str", "statuses": "dict(str, str)"}

    attribute_map = {"result": "result", "statuses": "statuses"}

    def __init__(self, result="ok", statuses=None):  # noqa: E501
    ...
    @property
    def statuses(self):
        """Gets the statuses of this InlineResponse2004.  # noqa: E501


        :return: The statuses of this InlineResponse2004.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def statuses(self, statuses):
        """Sets the statuses of this InlineResponse2004.


        :param statuses: The statuses of this InlineResponse2004.  # noqa: E501
        :type: dict(str, str)
        """
        allowed_values = [
            "reading",
        ...
        if not set(statuses.keys()).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid keys in `statuses` [{0}], must be a subset of [{1}]".format(  # noqa: E501
                    ", ".join(
                        map(str, set(statuses.keys()) - set(allowed_values))
                    ),  # noqa: E501
