...
class InlineResponse2003(object):
    ...
    attribute_map = {"base_url": "baseUrl"}
    ...
    @property
    def base_url(self):
        """Gets the base_url of this InlineResponse2003.  # noqa: E501

        The base URL to construct final image URLs from. The URL returned is valid for the requested chapter only, and for a duration of 15 minutes from the time of the response.  # noqa: E501

        :return: The base_url of this InlineResponse2003.  # noqa: E501
        :rtype: str
        """
    ...
    def base_url(self, base_url):
        """Sets the base_url of this InlineResponse2003.

        The base URL to construct final image URLs from. The URL returned is valid for the requested chapter only, and for a duration of 15 minutes from the time of the response.  # noqa: E501

        :param base_url: The base_url of this InlineResponse2003.  # noqa: E501
        :type: str
        """
