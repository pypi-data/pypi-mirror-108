...
class AccountApi(object):
    ...
    def get_account_activate_code(self, code, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_account_activate_code_with_http_info(
                code, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_account_activate_code_with_http_info(
                code, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_account_activate_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if "code" not in params or params["code"] is None:
            raise ValueError(
                "Missing the required parameter `code` when calling `get_account_activate_code`"
            )  # noqa: E501
    ...
    def post_account_activate_resend(self, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_account_activate_resend_with_http_info(
                **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_account_activate_resend_with_http_info(
                **kwargs
            )  # noqa: E501
            return data
    ...
    def post_account_recover_code(self, code, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_account_recover_code_with_http_info(
                code, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_account_recover_code_with_http_info(
                code, **kwargs
            )  # noqa: E501
            return data
    ...
    def post_account_recover_code_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if "code" not in params or params["code"] is None:
            raise ValueError(
                "Missing the required parameter `code` when calling `post_account_recover_code`"
            )  # noqa: E501
