...
class LegacyApi(object):
    ...
    def post_legacy_mapping(self, **kwargs):  # noqa: E501
        """Legacy ID mapping  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_legacy_mapping(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param MappingIdBody body: The size of the body is limited to 10KB.
        :return: list[MappingIdResponse]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_legacy_mapping_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_legacy_mapping_with_http_info(**kwargs)  # noqa: E501
            return data

    def post_legacy_mapping_with_http_info(self, **kwargs):  # noqa: E501
        """Legacy ID mapping  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_legacy_mapping_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method post_legacy_mapping" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        return self.api_client.call_api(
            ...
            response_type="list[MappingIdResponse]",  # noqa: E501
