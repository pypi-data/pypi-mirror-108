...
class AuthorCreate(object):
    ...
    @property
    def name(self):
        """Gets the name of this AuthorCreate.  # noqa: E501


        :return: The name of this AuthorCreate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AuthorCreate.


        :param name: The name of this AuthorCreate.  # noqa: E501
        :type: str
        """
        if name is None:
            raise ValueError(
    ...
    @property
    def version(self):
        """Gets the version of this AuthorCreate.  # noqa: E501


        :return: The version of this AuthorCreate.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this AuthorCreate.


        :param version: The version of this AuthorCreate.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthorCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorCreate):
            return False
