...
class LogoutResponse(object):
    ...
    def __init__(self, result=None):  # noqa: E501
        """LogoutResponse - a model defined in Swagger"""  # noqa: E501
        self._result = None
    ...
    @property
    def result(self):
        """Gets the result of this LogoutResponse.  # noqa: E501


        :return: The result of this LogoutResponse.  # noqa: E501
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        """Sets the result of this LogoutResponse.


        :param result: The result of this LogoutResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LogoutResponse, dict):
