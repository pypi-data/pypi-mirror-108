...
class RefreshToken(object):
    ...
    def __init__(self, token=None):  # noqa: E501
        """RefreshToken - a model defined in Swagger"""  # noqa: E501
        self._token = None
    ...
    @property
    def token(self):
        """Gets the token of this RefreshToken.  # noqa: E501


        :return: The token of this RefreshToken.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this RefreshToken.


        :param token: The token of this RefreshToken.  # noqa: E501
        :type: str
        """
        if token is None:
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RefreshToken, dict):
