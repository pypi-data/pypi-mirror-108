...
class ChapterApi(object):
    ...
    def chapter_id_read(self, id, **kwargs):  # noqa: E501
        """Mark Chapter read  # noqa: E501

        Mark chapter as read for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chapter_id_read(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.chapter_id_read_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.chapter_id_read_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def chapter_id_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Mark Chapter read  # noqa: E501

        Mark chapter as read for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chapter_id_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `chapter_id_read`"
            )  # noqa: E501
    ...
    def chapter_id_unread(self, id, **kwargs):  # noqa: E501
        """Mark Chapter unread  # noqa: E501

        Mark chapter as unread for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chapter_id_unread(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.chapter_id_unread_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.chapter_id_unread_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def chapter_id_unread_with_http_info(self, id, **kwargs):  # noqa: E501
        """Mark Chapter unread  # noqa: E501

        Mark chapter as unread for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chapter_id_unread_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method chapter_id_unread" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'id' is set
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `chapter_id_unread`"
            )  # noqa: E501
    ...
    def delete_chapter_id(self, id, **kwargs):  # noqa: E501
        """Delete Chapter  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_chapter_id(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Chapter ID (required)
        :return: Response
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_chapter_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_chapter_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_chapter_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete Chapter  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_chapter_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_chapter_id" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'id' is set
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `delete_chapter_id`"
            )  # noqa: E501
    ...
    def get_chapter_id(self, id, **kwargs):  # noqa: E501
        """Get Chapter  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_chapter_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_chapter_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_chapter_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_chapter_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get Chapter  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_chapter_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `get_chapter_id`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="ChapterResponse",  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def put_chapter_id(self, id, **kwargs):  # noqa: E501
        """Update Chapter  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_chapter_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.put_chapter_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_chapter_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def put_chapter_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update Chapter  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_chapter_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `put_chapter_id`"
            )  # noqa: E501
