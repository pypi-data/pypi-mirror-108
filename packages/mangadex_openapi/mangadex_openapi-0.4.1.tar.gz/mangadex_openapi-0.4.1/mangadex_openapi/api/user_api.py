...
class UserApi(object):
    ...
    def get_user_follows_user(self, **kwargs):  # noqa: E501
        """Get logged User followed User list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_follows_user(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_user_follows_user_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_user_follows_user_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_user_follows_user_with_http_info(self, **kwargs):  # noqa: E501
        """Get logged User followed User list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_follows_user_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_follows_user" % key
                )
            params[key] = val
        del params["kwargs"]
    ...
    def get_user_id(self, id, **kwargs):  # noqa: E501
        """Get User  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_user_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_user_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get User  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `get_user_id`"
            )  # noqa: E501
    ...
    def get_user_me(self, **kwargs):  # noqa: E501
        """Logged User details  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_user_me_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_user_me_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_user_me_with_http_info(self, **kwargs):  # noqa: E501
        """Logged User details  # noqa: E501
