...
class AuthApi(object):
    ...
    def get_auth_check(self, **kwargs):  # noqa: E501
        """Check token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_auth_check(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.get_auth_check_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_auth_check_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_auth_check_with_http_info(self, **kwargs):  # noqa: E501
        """Check token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_auth_check_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def post_auth_login(self, **kwargs):  # noqa: E501
        """Login  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_auth_login(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_auth_login_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_auth_login_with_http_info(**kwargs)  # noqa: E501
            return data

    def post_auth_login_with_http_info(self, **kwargs):  # noqa: E501
        """Login  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_auth_login_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def post_auth_logout(self, **kwargs):  # noqa: E501
        """Logout  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_auth_logout(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_auth_logout_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_auth_logout_with_http_info(**kwargs)  # noqa: E501
            return data

    def post_auth_logout_with_http_info(self, **kwargs):  # noqa: E501
        """Logout  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_auth_logout_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_auth_logout" % key
                )
            params[key] = val
        del params["kwargs"]
    ...
    def post_auth_refresh(self, **kwargs):  # noqa: E501
        """Refresh token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_auth_refresh(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_auth_refresh_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_auth_refresh_with_http_info(**kwargs)  # noqa: E501
            return data

    def post_auth_refresh_with_http_info(self, **kwargs):  # noqa: E501
        """Refresh token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_auth_refresh_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_auth_refresh" % key
                )
            params[key] = val
        del params["kwargs"]
