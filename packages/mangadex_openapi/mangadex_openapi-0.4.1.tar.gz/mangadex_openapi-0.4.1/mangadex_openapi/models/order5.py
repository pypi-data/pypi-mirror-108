...
class Order5(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """Order5 - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this Order5.  # noqa: E501


        :return: The name of this Order5.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Order5.


        :param name: The name of this Order5.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Order5):
            return False
