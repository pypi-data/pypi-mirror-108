...
class UpdateMangaStatus(object):
    ...
    def __init__(self, status=None):  # noqa: E501
        """UpdateMangaStatus - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this UpdateMangaStatus.  # noqa: E501


        :return: The status of this UpdateMangaStatus.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this UpdateMangaStatus.


        :param status: The status of this UpdateMangaStatus.  # noqa: E501
        :type: str
        """
        if status is None:
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateMangaStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateMangaStatus):
            return False
