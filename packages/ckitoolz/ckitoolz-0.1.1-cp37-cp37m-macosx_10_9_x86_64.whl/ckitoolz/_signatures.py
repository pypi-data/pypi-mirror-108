from kitoolz._signatures import *
from kitoolz._signatures import (_is_arity, _has_varargs, _has_keywords,
                               _num_required_args, _is_partial_args, _is_valid_args)

ckitoolz_info = {}

ckitoolz_info['ckitoolz.dicttoolz'] = dict(
    assoc=[
...
ckitoolz_info['ckitoolz.functoolz'] = dict(
    apply=[
...
ckitoolz_info['ckitoolz.itertoolz'] = dict(
    accumulate=[
...
ckitoolz_info['ckitoolz.recipes'] = dict(
    countby=[
        lambda key, seq: None],
    partitionby=[
...
def update_signature_registry():
    create_signature_registry(ckitoolz_info)
    module_info.update(ckitoolz_info)
