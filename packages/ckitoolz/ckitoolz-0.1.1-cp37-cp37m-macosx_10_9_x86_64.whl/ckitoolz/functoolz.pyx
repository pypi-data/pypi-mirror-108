...
from ckitoolz.utils import no_default
import ckitoolz._signatures as _sigs

from kitoolz.functoolz import (InstanceProperty, instanceproperty, is_arity,
...
cdef class curry:
    ...
    See Also:
        ckitoolz.curried - namespace of curried functions
...
cpdef object do(object func, object x):
    ...
    >>> from ckitoolz import compose
    >>> from ckitoolz.curried import do
