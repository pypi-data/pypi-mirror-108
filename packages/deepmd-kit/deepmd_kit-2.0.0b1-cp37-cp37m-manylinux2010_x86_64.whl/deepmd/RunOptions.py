...
global_install_prefix='/tmp/pip-req-build-nlth9rzd/_skbuild/linux-x86_64-3.7/cmake-install'
global_git_summ='v2.0.0.b1'
global_git_hash='773ed37'
global_git_date='2021-05-29 19:11:32 +0800'
global_git_branch='HEAD'
global_tf_include_dir='/tmp/pip-build-env-cev3oihh/normal/lib/python3.7/site-packages/tensorflow/include'
global_tf_libs=''
