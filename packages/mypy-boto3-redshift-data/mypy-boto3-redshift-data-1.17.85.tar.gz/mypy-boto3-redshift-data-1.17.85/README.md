# mypy-boto3-redshift-data<a id="mypy-boto3-redshift-data"></a>
...
[boto3.RedshiftDataAPIService 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/redshift-data.html#RedshiftDataAPIService)
