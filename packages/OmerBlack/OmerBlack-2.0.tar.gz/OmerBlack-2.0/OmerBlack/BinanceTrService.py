...
class ApiService:
    ...
    def postBuyMarketOrder(self,side, symbol, origQuantity):
        """
    ...
    def postSellMarketOrder(self,side, symbol, origQuoteQuantity):
        """
    ...
    def postgfSellMarketOrder(self, param, param1):
        pass
