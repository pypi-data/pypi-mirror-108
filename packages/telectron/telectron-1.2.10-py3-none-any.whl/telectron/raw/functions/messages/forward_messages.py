...
class ForwardMessages(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["from_peer", "id", "random_id", "to_peer", "silent", "background", "with_my_score", "schedule_date"]

    ID = 0xd9fee60e
    QUALNAME = "functions.messages.ForwardMessages"

    def __init__(self, *, from_peer: "raw.base.InputPeer", id: List[int], random_id: List[int], to_peer: "raw.base.InputPeer", silent: Union[None, bool] = None, background: Union[None, bool] = None, with_my_score: Union[None, bool] = None, schedule_date: Union[None, int] = None) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "ForwardMessages":
        ...
        return ForwardMessages(from_peer=from_peer, id=id, random_id=random_id, to_peer=to_peer, silent=silent, background=background, with_my_score=with_my_score, schedule_date=schedule_date)
