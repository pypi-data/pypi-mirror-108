...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        settings (optional): :obj:`InputThemeSettings <telectron.raw.base.InputThemeSettings>`
    ...
    def __init__(self, *, format: str, theme: "raw.base.InputTheme", slug: Union[None, str] = None, title: Union[None, str] = None, document: "raw.base.InputDocument" = None, settings: "raw.base.InputThemeSettings" = None) -> None:
