...
class AppUpdate(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: int, version: str, text: str, entities: List["raw.base.MessageEntity"], can_not_skip: Union[None, bool] = None, document: "raw.base.Document" = None, url: Union[None, str] = None) -> None:
        self.id = id  # int
