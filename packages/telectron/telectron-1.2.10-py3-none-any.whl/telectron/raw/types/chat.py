...
class Chat(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "title", "photo", "participants_count", "date", "version", "creator", "kicked", "left", "deactivated", "call_active", "call_not_empty", "migrated_to", "admin_rights", "default_banned_rights"]
    ...
    def read(data: BytesIO, *args: Any) -> "Chat":
        ...
        return Chat(id=id, title=title, photo=photo, participants_count=participants_count, date=date, version=version, creator=creator, kicked=kicked, left=left, deactivated=deactivated, call_active=call_active, call_not_empty=call_not_empty, migrated_to=migrated_to, admin_rights=admin_rights, default_banned_rights=default_banned_rights)
