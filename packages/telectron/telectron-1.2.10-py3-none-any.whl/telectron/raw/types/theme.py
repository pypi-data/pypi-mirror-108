...
class Theme(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "access_hash", "slug", "title", "installs_count", "creator", "default", "document", "settings"]

    ID = 0x28f1114
    QUALNAME = "types.Theme"

    def __init__(self, *, id: int, access_hash: int, slug: str, title: str, installs_count: int, creator: Union[None, bool] = None, default: Union[None, bool] = None, document: "raw.base.Document" = None, settings: "raw.base.ThemeSettings" = None) -> None:
        self.id = id  # long
