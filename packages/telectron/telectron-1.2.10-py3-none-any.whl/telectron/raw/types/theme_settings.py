...
class ThemeSettings(TLObject):  # type: ignore
    ...
    def __init__(self, *, base_theme: "raw.base.BaseTheme", accent_color: int, message_top_color: Union[None, int] = None, message_bottom_color: Union[None, int] = None, wallpaper: "raw.base.WallPaper" = None) -> None:
