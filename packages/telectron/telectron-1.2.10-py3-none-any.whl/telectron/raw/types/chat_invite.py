...
class ChatInvite(TLObject):  # type: ignore
    ...
    def __init__(self, *, title: str, photo: "raw.base.Photo", participants_count: int, channel: Union[None, bool] = None, broadcast: Union[None, bool] = None, public: Union[None, bool] = None, megagroup: Union[None, bool] = None, participants: Union[None, List["raw.base.User"]] = None) -> None:
