...
class InputBotInlineMessageMediaInvoice(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["title", "description", "invoice", "payload", "provider", "provider_data", "start_param", "multiple_allowed", "can_forward", "photo", "reply_markup"]

    ID = 0xd5348d85
    QUALNAME = "types.InputBotInlineMessageMediaInvoice"

    def __init__(self, *, title: str, description: str, invoice: "raw.base.Invoice", payload: bytes, provider: str, provider_data: "raw.base.DataJSON", start_param: str, multiple_allowed: Union[None, bool] = None, can_forward: Union[None, bool] = None, photo: "raw.base.InputWebDocument" = None, reply_markup: "raw.base.ReplyMarkup" = None) -> None:
        ...
        self.can_forward = can_forward  # flags.3?true
    ...
    def read(data: BytesIO, *args: Any) -> "InputBotInlineMessageMediaInvoice":
        ...
        can_forward = True if flags & (1 << 3) else False
        ...
        return InputBotInlineMessageMediaInvoice(title=title, description=description, invoice=invoice, payload=payload, provider=provider, provider_data=provider_data, start_param=start_param, multiple_allowed=multiple_allowed, can_forward=can_forward, photo=photo, reply_markup=reply_markup)
    ...
    def write(self) -> bytes:
        ...
        flags |= (1 << 3) if self.can_forward else 0
