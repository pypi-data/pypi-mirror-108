...
class Survey:
    ...
    def __init__(self, verbose=True, path_sample='info/TOIs_perfect.csv', path_survey='info/survey_info.csv',
                 path_priority=None, path_ignore=None, iter=1, hours=10., nights=50., progress=True, 
                 save=True, unique=['1B'], note=''):
    ...
    def get_programs(self, path_survey, path_ignore, path_priority, unique):
        ...
        for program in programs.index.values.tolist():
            ...
            print(program, programs.loc[program,'remaining_hours'], type(programs.loc[program,'remaining_hours']))
