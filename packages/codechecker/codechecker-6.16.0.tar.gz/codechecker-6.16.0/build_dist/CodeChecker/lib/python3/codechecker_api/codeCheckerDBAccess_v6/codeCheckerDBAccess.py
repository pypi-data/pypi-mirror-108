...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i265 in range(_size261):
                        ...
                        self.reportHashes.append(_elem266)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i271 in range(_size267):
                        ...
                        self.skipDetectionStatuses.append(_elem272)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter280 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter281 in self.skipDetectionStatuses:
...
class getRunResults_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter302 in self.runIds:
                oprot.writeI64(iter302)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.limit is not None:
            oprot.writeFieldBegin('limit', TType.I64, 2)
                ...
                if ftype == TType.MAP:
                    ...
                    for _i350 in range(_size346):
                        ...
                        for _i357 in range(_size353):
                            _elem358 = AnalysisFailureInfo()
                            _elem358.read(iprot)
                            _val352.append(_elem358)
                        iprot.readListEnd()
                        self.success[_key351] = _val352
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter359, viter360 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRUCT, len(viter360))
                for iter361 in viter360:
                    iter361.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i366 in range(_size362):
                        _elem367 = LinesInFilesRequested()
                        _elem367.read(iprot)
                        self.linesInFilesRequested.append(_elem367)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter368 in self.linesInFilesRequested:
                iter368.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i373 in range(_size369):
                        ...
                        for _i380 in range(_size376):
                            ...
                            _val382 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _val375[_key381] = _val382
                        iprot.readMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter383, viter384 in self.success.items():
                oprot.writeI64(kiter383)
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter384))
                for kiter385, viter386 in viter384.items():
                    oprot.writeI64(kiter385)
                    oprot.writeString(viter386.encode('utf-8') if sys.version_info[0] == 2 else viter386)
                oprot.writeMapEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
...
class getSeverityCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter414 in self.runIds:
                oprot.writeI64(iter414)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
...
class getSeverityCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter422, viter423 in self.success.items():
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter454, viter455 in self.success.items():
                oprot.writeI32(kiter454)
                oprot.writeI64(viter455)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i467 in range(_size463):
                        _key468 = iprot.readI32()
                        _val469 = iprot.readI64()
                        self.success[_key468] = _val469
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter470, viter471 in self.success.items():
                oprot.writeI32(kiter470)
                oprot.writeI64(viter471)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i536 in range(_size532):
                        ...
                        self.sourceComponentFilter.append(_elem537)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter538 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i550 in range(_size546):
                        ...
                        self.fileHashes.append(_elem551)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter552 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i564 in range(_size560):
                        ...
                        self.trimPathPrefixes.append(_elem565)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter566 in self.trimPathPrefixes:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i580 in range(_size576):
                        _key581 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val582 = AnalyzerStatistics()
                        _val582.read(iprot)
