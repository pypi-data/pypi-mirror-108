...
setup(
    ...
    package_data = {'elf_company': ['~/Documents/stage_delpha/company_name_matching/elf_company.csv'], 'abbreviations': ['~/Documents/stage_delpha/company_name_matching/abbreviations.json']},
