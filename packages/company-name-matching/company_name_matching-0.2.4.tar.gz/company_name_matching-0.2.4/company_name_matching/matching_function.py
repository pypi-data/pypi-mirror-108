...
class Elf:
    def __init__(self):
        file_path = pkg_resources.resource_string(__name__, 'data/elf_company.csv')
...
class MatchingParameters:
    ...
    def __init__(self, typographies_in_raw=1, typographies_in_word=1, entity_words_unmatched=2, 
        ...
        self.abbreviations = json.load(open(pkg_resources.resource_string(__name__, 'data/abbreviations.json')))
