...
setup(
    ...
    install_requires=[
        ...
        'Products.Archetypes==1.16.1',
        #'collective.transmogrifier@ git+https://github.com/collective/collective.transmogrifier.git@python3#egg=collective.transmogrifier-1.5.3.dev0',
