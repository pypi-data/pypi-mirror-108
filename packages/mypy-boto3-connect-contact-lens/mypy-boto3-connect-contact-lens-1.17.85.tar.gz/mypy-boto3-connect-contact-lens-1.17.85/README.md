# mypy-boto3-connect-contact-lens<a id="mypy-boto3-connect-contact-lens"></a>
...
[boto3.ConnectContactLens 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/connect-contact-lens.html#ConnectContactLens)
