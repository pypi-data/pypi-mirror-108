...
class BatchUtils():
    ...
    @classmethod
    def add_rows_analyzed(cls, di_dict: dict, data: DataFrame, inputs: dict, data_types: dict) -> dict:
        """
        Calculates and adds rows analyzed from the DI variable values.
        :di_dict: The DI dictionary.
        :data: The data on which the disparate impact variables are calculated.
        :inputs: The inputs dictionary.
        :data_types: The data types of the fairness attributes.
        """
