...
class RemoteEngineClient(Client):
    ...
    def run_job(self, job_name, job_class, job_args, data_file_list=None, background=True, timeout=constants.SYNC_JOB_MAX_WAIT_TIME):
        ...
        # If SSL certificate is specified in job parameters, then creating certificate file
        ...
        if certificate_file:
            ...
            job_args["arguments"]["storage"]["connection"]["ssl_cert_file_name"] = cert_file_name
