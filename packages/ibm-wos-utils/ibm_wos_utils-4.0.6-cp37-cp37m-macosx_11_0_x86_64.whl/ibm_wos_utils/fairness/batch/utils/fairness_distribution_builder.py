...
class FairnessDistributionBuilder():
    ...
    def __init__(self, fairness_parameters: dict, training_df: DataFrame):
        """
        Constructor for the class.
        :parameters: The fairness parameters.
        :training_df: The training data in a spark data frame.
        """
    ...
    def generate_distribution(self) -> (dict, int):
        """
    ...
    def get_group_distribution(self, fairness_attribute: str, group_vals: list, group_type: str, is_categorical: bool, is_classification: bool) -> (list, int):
        """
    ...
    def get_label_count(self, fairness_attribute: str, group_df: DataFrame, label, is_classification: bool) -> int:
        """
        ...
        :group_df: The data frame with rows of group for which the rows are to be counted.
