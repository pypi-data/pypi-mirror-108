...
class DataReader():
    ...
    def read_data_by_storage_type(self, spark, location_type, db_name, table_name, schema_name, sql_query=None, connection_properties=None, probability_column=None):
        spark_df = None
        if location_type is None or location_type == LocationType.HIVE_METASTORE.value:
