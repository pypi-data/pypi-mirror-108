...
class BancoCentralData(BaseData):
    ...
    * due_total (float)                 Total Due Amount.
    * past_due_30 (float)               Due Amount up to 30d and past 14d.
    * past_due_60 (float)               Due Amount up to 60d.
    * past_due_90 (float)               Due Amount up to 90d.
    * past_due_180 (float)              Due Amount up to 180d.
    * past_due_360 (float)              Due Amount up to 360d.
    * past_due_no_date (float)          Due Amount with no date specified.
    ...
    * risk_total (float)                Total Risk Amount.
    ...
    past_due_no_date: Optional[float] = None
...
class BancoCentralSerializer(BaseSchema):
    ...
    past_due_no_date = fields.Float(allow_none=True)
