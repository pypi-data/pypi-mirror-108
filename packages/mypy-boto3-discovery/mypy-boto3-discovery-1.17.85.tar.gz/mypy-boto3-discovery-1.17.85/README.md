# mypy-boto3-discovery<a id="mypy-boto3-discovery"></a>
...
[boto3.ApplicationDiscoveryService 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/discovery.html#ApplicationDiscoveryService)
