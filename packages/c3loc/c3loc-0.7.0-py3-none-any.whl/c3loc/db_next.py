...
from .api2.schemas.types import SensorType
...
tags = sa.Table(
    ...
    sa.Column('type', sa.Enum(
        ...
        'SecureLocationAnchor', 'SecureSmartRelay', name='tag_type')),
...
sensors = sa.Table(
    ...
    sa.Column('tag_id', sa.ForeignKey('tags.id'),
              nullable=False),
    sa.Column('type', sa.Enum(SensorType, name='sensor_type'), nullable=False),
