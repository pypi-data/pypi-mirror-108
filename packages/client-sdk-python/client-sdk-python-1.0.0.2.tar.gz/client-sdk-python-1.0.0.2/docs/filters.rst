...
* Event Logs
    ...
    Or built manually by supplying `valid filter params <https://github.com/ethereum/wiki/wiki/JSON-RPC#platon_newfilter/>`_:
...
See the JSON-RPC documentation for `platon_newFilter <https://github.com/ethereum/wiki/wiki/JSON-RPC#platon_newfilter>`_ more information on the standard filter parameters.
