...
def read_as_pd(path, columns: typing.Optional[typing.List[str]] = None) -> pd.DataFrame:
    """
    ...
    with open(path, "r") as f:
        ...
        return pd.DataFrame.from_dict(converted_data, orient='columns')
