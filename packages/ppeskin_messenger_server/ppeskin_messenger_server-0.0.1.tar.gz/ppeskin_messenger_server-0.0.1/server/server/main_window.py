...
from server_dist.server import StatWindow
from server_dist.server import ConfigWindow
from server_dist.server import RegisterUser
from server_dist.server import DelUserDialog
