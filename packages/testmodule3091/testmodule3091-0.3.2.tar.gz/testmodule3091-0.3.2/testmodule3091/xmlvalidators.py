...
from .loadsetup import filenames, TT_CFG
from lxml import etree
from .pathvalidator import PathValidator
from .teiauxiliary import DATA_DIR
...
class SchemaValidator:
    ...
    def validator_generator(self, scenario):
        ...
        print(filenames['schema']['scenarios'][scenario])
        print(TT_CFG['FORMATS']['default_schema'])
        
#         schema_folder = filenames['schema']['scenarios'][scenario][TT_CFG['FORMATS']['default_schema']]
        
        schema_folder = os.path.join(
            DATA_DIR, 'data/schema/scenarios', 
