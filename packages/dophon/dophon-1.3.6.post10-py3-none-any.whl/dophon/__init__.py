...
def blue_print(name, import_name, inject_config: dict = {}, static_folder=None,
    ...
    :param name:同Blueprint.name替换为--
           2021-06-02: blueprint名称不允许包含.,
    ...
    :return:
    """
    blue_print_obj = Blueprint(
        name=re.sub(r'\.', '--', name), import_name=import_name, static_folder=static_folder,
