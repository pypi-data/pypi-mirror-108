...
def run(app_source_dir: str, work_dir: str, exec_mode: str, apprunner_version: str = None,
    ...
    #
    if apprunner_version is None:
        print("WARNING: Old version of Xpress Insight server detected. Please upgrade to the latest version.")
        from .sqlite_connector import SQLiteConnector
        app_type.app_cfg._AppConfig__data_connector_cls = SQLiteConnector
