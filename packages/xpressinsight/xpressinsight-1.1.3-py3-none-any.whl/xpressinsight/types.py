...
class integer(BasicType):
    """
    Declare the entity to be (or to contain) integer (whole number) values. Each value must
    fit into a signed 32-bit integer, i.e., it must be representable as a 32-bit integer.
