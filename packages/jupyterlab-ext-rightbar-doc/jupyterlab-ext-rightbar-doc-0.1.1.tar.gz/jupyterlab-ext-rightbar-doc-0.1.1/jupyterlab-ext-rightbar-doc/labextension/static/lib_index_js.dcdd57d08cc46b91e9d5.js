(self["webpackChunkjupyterlab_ext_rightbar_doc"] = self["webpackChunkjupyterlab_ext_rightbar_doc"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'codelab/api', // API Namespace
    endPoint);
    let response;
    try {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DocumentOfContent": () => (/* binding */ DocumentOfContent)
/* harmony export */ });
 ...
 */
class DocumentOfContent extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_2__.Widget {
    /**
    ...
    updateDOC() {
        let title = '操作手册';
        let url = this._url;
        let renderedJSX = (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "jp-BookOfContents" }, react__WEBPACK_IMPORTED_MODULE_0__.createElement("header", null, title), react__WEBPACK_IMPORTED_MODULE_0__.createElement("iframe", { style: {
                width: '100%',
                height: '100%'
            }, src: url })));
        react_dom__WEBPACK_IMPORTED_MODULE_1__.render(renderedJSX, this.node, () => { });
    }
    /**
...
/* harmony import */ var _doc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./doc */ "./lib/doc.js");
...
function activateDOC(app, docmanager, labShell, restorer, rendermime) {
    const getCodelabURL = async function () {
        const res = await (0,_api__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('getCodeLabDocument', {
            method: 'GET'
        });
        if (res.status == 200) {
            var url = res.data;
            var tab = new _doc__WEBPACK_IMPORTED_MODULE_5__.DocumentOfContent({
                docmanager,
                rendermime,
                url
            });
...
//# sourceMappingURL=lib_index_js.dcdd57d08cc46b91e9d5.js.map