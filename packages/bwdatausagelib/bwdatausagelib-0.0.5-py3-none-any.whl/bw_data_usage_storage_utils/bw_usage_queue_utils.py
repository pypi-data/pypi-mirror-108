...
def get_data_usage_provider_queue(data_usage_provider: str = "", connection_string: str = None):
    '''
    Get the queue client based on data_usage_provider given.
    ...
    try:
        ...
        try:
            ...
            logging.warn(f'function: get_data_usage_provider_queue -> {err}')
            pass
        return queue
    except :
        logging.error(f'function: get_data_usage_provider_queue -> QueueClient')
        raise
