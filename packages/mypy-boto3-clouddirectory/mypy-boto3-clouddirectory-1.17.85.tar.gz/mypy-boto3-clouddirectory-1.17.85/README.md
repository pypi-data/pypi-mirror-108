# mypy-boto3-clouddirectory<a id="mypy-boto3-clouddirectory"></a>
...
[boto3.CloudDirectory 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/clouddirectory.html#CloudDirectory)
