...
class CloudFront:
    def __init__(self, content_manager:ContentManager, app:Chalice):
        """
    ...
    def template(self, filename:str, status_code:int=200, headers:Optional[dict]=None, cache_control=None, **kwargs) -> Response:
        """
    ...
    def static(self, filename:str, status_code:int=200, headers:Optional[dict]=None, cache_control=None) -> Response:
        """
    ...
    def asset(self, get_asset:Callable[[],bytes], get_etag:Callable[[],str], status_code:int=200, headers:Optional[dict]=None, cache_control=None) -> Response:
        """
