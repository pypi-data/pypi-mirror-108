...
DiscoveryTypes.__str__ = lambda self: self.value
DiscoveryTypes.__repr__ = lambda self: self.value
    ...
    if cache_strategy.context:
        ...
        if config_version == request.version_info:
            return ProcessedTemplate(
                version_info=config_version, resources=[], type_url=str(xds_type)
            )
