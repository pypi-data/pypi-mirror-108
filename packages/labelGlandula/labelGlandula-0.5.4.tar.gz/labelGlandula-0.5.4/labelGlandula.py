...
from libs.excelGlandula import Ui_Dialog
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        self.actions = struct(save=save, save_format=save_format, saveAs=saveAs, open=open, close=close,
                              resetAll=resetAll,
                              lineColor=color1, create=create, delete=delete, edit=edit, #createRegion=createRegion,createScale=createScale,
        ...
        addActions(self.menus.glandula, (create,  detect,  excel, close)) #createRegion,trainModel,close,createScale,))
        ...
        self.actions.beginner = (
            open, opendir, openNextImg, openPrevImg,None, save,  detect,excel,None,create, delete) #,trainModel, createRegion, createScale,
    ...
    def generarExcel(self):
        ...
        #print(ui.es)
        if ui.genera:
            generaExcel(os.path.dirname(ustr(self.filePath)), ui.esca, ui.pixe, ui.uni)
