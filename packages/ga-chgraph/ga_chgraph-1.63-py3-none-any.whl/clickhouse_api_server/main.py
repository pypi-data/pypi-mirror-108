...
class Application(tornado.web.Application):
    ...
    _routes = [
        tornado.web.url(r"/graph-db/api/v1/ga-build", gaBuildHandler, {"model_service": model_serviceGABuild, "config_params": config_params}),
        tornado.web.url(r"/graph-db/api/v1/graph", graphHandler, {"model_service": model_serviceGraph, "config_params": config_params}),
        tornado.web.url(r"/graph-db/api/v1/graph-insert", graphInsertHandler, {"model_service": model_serviceGraphInsert, "config_params": config_params}),
        tornado.web.url(r"/graph-db/api/v1/graph-delete", graphDeleteHandler, {"model_service": model_serviceGraphDelete, "config_params": config_params}),
        tornado.web.url(r"/graph-db/api/v1/graph-update", graphUpdateHandler, {"model_service": model_serviceGraphUpdate, "config_params": config_params}),
