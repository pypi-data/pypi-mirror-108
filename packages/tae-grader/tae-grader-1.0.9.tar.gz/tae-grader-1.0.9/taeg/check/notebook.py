...
from taeg.test_files.match_test import MatchTestFile

from .logs import LogEntry, EventType, Log
from ..execute import check
from ..export import export_notebook
from taeg.test_files.abstract_test import TestCollection
...
class Notebook:
    ...
    def check_matches(self, tests, global_env=None, test_dir="tests"):
        """
        ...
        test_paths = [ os.path.join(test_dir, str(i)) for i in tests ]
        testCollection = TestCollection(test_paths, MatchTestFile)
        ...
        return testCollection.run(global_env, include_grade=False)
