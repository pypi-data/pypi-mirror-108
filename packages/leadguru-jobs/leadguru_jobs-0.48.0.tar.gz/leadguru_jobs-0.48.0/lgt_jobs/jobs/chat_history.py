...
class LoadChatHistoryJob(BaseBackgroundJob, ABC):
    ...
    @staticmethod
    def _update_history(bots_map: dict, user: UserModel, lead: UserLeadModel) -> Optional[SlackHistoryMessageModel]:
    ...
    def exec(self, data: LoadChatHistoryJobData):
        ...
        for lead in leads:
            ...
            message = LoadChatHistoryJob._update_history(bots_map=bots_map, user=user, lead=lead)
