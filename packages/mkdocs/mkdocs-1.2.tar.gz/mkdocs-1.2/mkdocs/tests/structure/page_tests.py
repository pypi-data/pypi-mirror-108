...
class PageTests(unittest.TestCase):
    ...
    def test_homepage(self):
        ...
        self.assertEqual(pg.canonical_url, 'https://example.com/')
    ...
    def test_nested_index_page_no_parent_no_directory_urls(self):
        ...
        self.assertEqual(pg.abs_url, '/sub1/index.html')
        self.assertEqual(pg.canonical_url, 'https://example.com/sub1/index.html')
        self.assertEqual(pg.edit_url, None)
        self.assertEqual(pg.file, fl)
        self.assertEqual(pg.content, None)
        self.assertFalse(pg.is_homepage)
    ...
    def test_nested_nonindex_page(self):
        ...
        self.assertEqual(pg.canonical_url, 'https://example.com/sub1/non-index/')
        self.assertEqual(pg.edit_url, None)
        self.assertEqual(pg.file, fl)
        self.assertEqual(pg.content, None)
        self.assertFalse(pg.is_homepage)
    ...
    def test_page_no_directory_url(self):
        ...
        self.assertEqual(pg.abs_url, '/testing.html')
        self.assertEqual(pg.canonical_url, 'https://example.com/testing.html')
        self.assertEqual(pg.edit_url, None)
        self.assertEqual(pg.file, fl)
        self.assertEqual(pg.content, None)
        self.assertFalse(pg.is_homepage)
    ...
    def test_page_site_url_empty(self):
        cfg = load_config(site_url='', use_directory_urls=False)
        fl = File('testing.md', cfg['docs_dir'], cfg['site_dir'], cfg['use_directory_urls'])
        pg = Page('Foo', fl, cfg)
        self.assertEqual(pg.url, 'testing.html')
    ...
    def test_homepage_site_url_empty(self):
        cfg = load_config(site_url='', use_directory_urls=False)
        fl = File('index.md', cfg['docs_dir'], cfg['site_dir'], cfg['use_directory_urls'])
        pg = Page('Foo', fl, cfg)
    ...
    def test_page_title_from_filename(self):
        ...
        self.assertEqual(pg.canonical_url, 'https://example.com/page-title/')
        self.assertEqual(pg.edit_url, None)
        self.assertEqual(pg.file, fl)
        self.assertEqual(pg.content, None)
        self.assertFalse(pg.is_homepage)
    ...
    def test_page_title_from_capitalized_filename(self):
        ...
        self.assertEqual(pg.canonical_url, 'https://example.com/pageTitle/')
        self.assertEqual(pg.edit_url, None)
        self.assertEqual(pg.file, fl)
        self.assertEqual(pg.content, None)
        self.assertFalse(pg.is_homepage)
