...
setup(
    ...
    name='patract-interface',  # Required
    ...
    description='Substrate Contract SDK for Python As a part of Himalia',  # Optional
    ...
    url='https://github.com/patractlabs/py-patract',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='patractlabs',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='polkadev@protonmail.com',  # Optional
    ...
    # larger catalog.
    keywords='contract interface polkascan polkadot substrate blockchain rpc kusama',  # Optional
