...
class Cluster(str, Enum):
    ...
    def base_url(self):
        ...
        return "https://well-service.cognitedata-production.cognite.ai"

    @property
    def requires_cluster_selection(self):
        """
        The azure clusters shouldn't be used with an `?env` query parameter. The
        url selects the cluster. For cognitedata-production, api is the
...
class _DefaultConfig:
    def __init__(self):
        ...
        self.client_name: str = "cognite-wells-client"
        self.cluster: Optional[Cluster] = Cluster.API
        self.base_url: str = Cluster.API.base_url
