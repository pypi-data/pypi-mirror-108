...
class WellboreIds(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True
...
class DoubleRange(WellsBaseModel):
    ...
    min: Optional[float] = Field(None, example=123.123)
    max: Optional[float] = Field(None, example=153.123)
...
class NPT(WellsBaseModel):
    ...
    parent_external_id: str = Field(
        ...,
        alias="parentExternalId",
        description="parent external Id (either well external id or wellbore external id).",
        example="well:27/3/10",
    )
    parent_type: str = Field(
        ..., alias="parentType", description="Parent of an Event. Well or wellbore", example="Well"
    )
    ...
    source_event_external_id: str = Field(
        ...,
        alias="sourceEventExternalId",
        description="The CDF external Id of the source event.",
        example="ijiefe3:3463:npt",
    )
    source: str = Field(..., description="The source of this event.", example="EDM-NPT")
...
class WellNDSFilter(WellsBaseModel):
    ...
    risk_types: Optional[List[str]] = Field(None, alias="riskTypes")
...
class NDSIngestion(WellsBaseModel):
    ...
    severity: int = Field(..., description="NDS event severity, between 0-4")
...
class NDS(WellsBaseModel):
    ...
    source_event_external_id: str = Field(
        ...
        alias="sourceEventExternalId",
        description="The CDF external Id of the source event.",
        example="ijiefe3:3463:nds",
    )
    parent_external_id: Optional[str] = Field(
        None, alias="parentExternalId", description="The external id of the parent asset"
    )
    parent_type: Optional[str] = Field(
        None, alias="parentType", description="Parent of an Event. Well or wellbore", example="Well"
    )
    description: Optional[str] = Field(
        None, description="Textual description of the event.", example="factual description of event"
    )
    hole_diameter: Optional[float] = Field(None, alias="holeDiameter")
    hole_start: float = Field(..., alias="holeStart")
    hole_end: float = Field(..., alias="holeEnd")
    risk_type: Optional[str] = Field(None, alias="riskType", description="Type of NDS risk.", example="some risk type")
    subtype: Optional[str] = Field(None, description="subtype of NDS risk.", example="some subtype")
    severity: int = Field(..., description="NDS event severity, between 0-4")
    probability: int = Field(..., description="NDS event probability, between 0-5")
...
class TrajectoryFilter(WellsBaseModel):
    ...
    depth_unit: Optional[LengthUnitEnum] = Field(None, alias="depthUnit")
...
class WellboreSourceAsset(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True
...
class WellsLimits(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    spud_date: SpudDateLimits = Field(..., alias="spudDate")
    water_depth: WaterDepthLimits = Field(..., alias="waterDepth")
    npt_duration: DoubleRange = Field(..., alias="nptDuration")
...
class EventIngestion(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    wellbore_name: Optional[str] = Field(None, alias="wellboreName", example="25/5-5")
    well_name: Optional[str] = Field(None, alias="wellName", description="Name of the well parent of this wellbore")
    npt_ingestion: Optional[List[NPTIngestion]] = Field(None, alias="nptIngestion")
    nds_ingestion: Optional[List[NDSIngestion]] = Field(None, alias="ndsIngestion")
...
class NPTIngestionItems(WellsBaseModel):
    ...
    npt_items: List[NPTIngestion] = Field(..., alias="nptItems")
    wellbore_name: Optional[str] = Field(None, alias="wellboreName", example="25/5-5")
    well_name: Optional[str] = Field(None, alias="wellName", description="Name of the well parent of this wellbore")
...
class NPTFilter(WellsBaseModel):
    ...
    wellbore_ids: Optional[List[int]] = Field(None, alias="wellboreIds", description="match on wellbore ids")
...
class NDSIngestionItems(WellsBaseModel):
    ...
    nds_items: List[NDSIngestion] = Field(..., alias="ndsItems")
    wellbore_name: Optional[str] = Field(None, alias="wellboreName", example="25/5-5")
    well_name: Optional[str] = Field(None, alias="wellName", description="Name of the well parent of this wellbore")
...
class Wellbore(WellsBaseModel):
    ...
    source_wellbores: Optional[List[WellboreSourceAsset]] = Field(None, alias="sourceWellbores")
...
class WellboreIngestion(WellsBaseModel):
    ...
    parent_type: ParentType = Field(..., alias="parentType")
...
class EventIngestionItems(WellsBaseModel):
    __root__: List[EventIngestion]


class NPTIngestionItemsList(WellsBaseModel):
    __root__: List[NPTIngestionItems]


class NDSIngestionItemsList(WellsBaseModel):
    __root__: List[NDSIngestionItems]
