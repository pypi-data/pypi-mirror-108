...
class TourBase:
    ...
    def reset_app_flow(self):
        """ delayed reset of flow path/id to be processed after dispatch of popups dismiss. """
        self.main_app.vpo("TourBase.reset_app_flow")
        # optionally set/overwrite current app flow, e.g. like:
        # main_app = self.main_app
        # main_app.change_app_state('flow_id', '')
        # main_app.change_app_state('flow_path', list())
...
class HelpAppBase(MainAppBase, ABC):
    ...
    def widget_tourable_children_page_ids(self, parent_widget: Any) -> List:
        ...
        :return:                list of tourable children of the passed parent widget.
        """
