...
from pyrasgo.storage.dataframe.prune  import Prune
from pyrasgo.storage.dataframe.transform import Transform
...
class Rasgo():
    ...
    def __init__(self, api_key: str):
        ...
        self.evaluate = Evaluate(api_key=api_key)
        self.prune = Prune(api_key=api_key)
    ...
    def activate_experiment(
        ...
        self.evaluate = Evaluate(experiment_id=self._experiment_id, api_key=self._session_api_key)
        self.prune = Prune(experiment_id=self._experiment_id, api_key=self._session_api_key)
    ...
    def end_experiment(self):
        ...
        """
        self._experiment_id = None
        self.evaluate = Evaluate(api_key=self._session_api_key)
        self.prune = Prune(api_key=self._session_api_key)
