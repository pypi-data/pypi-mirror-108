...
class Prune(Connection):
    ...
    def __init__(self, experiment_id = None, **kwargs):
        ...
        self.evaluate = Evaluate(experiment_id=experiment_id, api_key=self._api_key)
    ...
    def features(self, df: pd.DataFrame, 
        ...
        fi_dict = self.evaluate.feature_importance(df=p_df, target_column=target_column, exclude_columns=exclude_columns, return_cli_only=True)
