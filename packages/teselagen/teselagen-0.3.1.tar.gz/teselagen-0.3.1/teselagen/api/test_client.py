...
class TESTClient():
    ...
    def get_assay_results(
        ...
        try:
            ...
            if len(assay_results) == 0:
                raise Exception(f"Error getting assay results from assay with ID={assay_id}. Make sure assay has imported results.")
    ...
    def _get_assay_results_from_api(self, assay_id: int) -> Optional[Any]:
        ...
        try:
            ...
            raise Exception(f"Error getting assay results from assay with ID={assay_id}. Make sure assay exists or that has imported results.")
