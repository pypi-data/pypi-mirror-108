# mypy-boto3-marketplace-catalog<a id="mypy-boto3-marketplace-catalog"></a>
...
[boto3.MarketplaceCatalog 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/marketplace-catalog.html#MarketplaceCatalog)
