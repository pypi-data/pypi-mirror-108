...
class Actor(with_metaclass(ActorMetaClass, type('NewBase', (actions.Parametrizable, Permittable), {}))):
    ...
    """
    Have the toolbar at the bottom of the window instead of the top.

    See :ref:`dev.actor_config.hide_top_toolbar`.

    Deprecated. Supported only in :term:`ExtJS front end`.
    """

    hide_navigator = False  # 20210509
    """
    Whether to hide navigation functionality.
    ...
    def init_layouts(cls):
        ...
        for name, main in cls.get_extra_layouts():
            ...
            cls.extra_layouts.append(layout_instance)
