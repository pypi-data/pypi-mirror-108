# mypy-boto3-config<a id="mypy-boto3-config"></a>
...
[boto3.ConfigService 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/config.html#ConfigService)
