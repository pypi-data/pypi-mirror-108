# mypy-boto3-mediaconvert<a id="mypy-boto3-mediaconvert"></a>
...
[boto3.MediaConvert 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/mediaconvert.html#MediaConvert)
