# mypy-boto3-logs<a id="mypy-boto3-logs"></a>
...
[boto3.CloudWatchLogs 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/logs.html#CloudWatchLogs)
