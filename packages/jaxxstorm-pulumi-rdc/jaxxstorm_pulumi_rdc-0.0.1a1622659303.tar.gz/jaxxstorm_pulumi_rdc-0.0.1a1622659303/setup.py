...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rdc', '0.0.1-alpha.1622659303+64064f31'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rdc 0.0.1-alpha.1622659303+64064f31`
                """)
            else:
                raise
