...
class RepositoryRelationshipResponse:
    def __init__(self, repo_relationship_id: str, space_id: str, deployment_type: str, account_repository_name: str,
        ...
        self.account_repository_name = account_repository_name
        self.branch = branch
