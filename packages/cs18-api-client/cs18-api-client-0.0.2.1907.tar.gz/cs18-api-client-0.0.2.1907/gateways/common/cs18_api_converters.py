...
from gateways.common.cs18_api_requests import AwsCloudProviderSettingsModel, InsidedTokenResponseModel
...
class Converters:
    ...
    def create_repository_relationship_response(repo: dict) -> RepositoryRelationshipResponse:
        ...
        return RepositoryRelationshipResponse(
            ...
            account_repository_name=repo["account_repository_name"],
            branch=repo["branch"],
            account_id=repo["account_id"],
            is_valid=repo["is_valid"],
            errors=[Error(e) for e in repo["errors"]],
    ...
    @staticmethod
    def insided_token_model(data: dict):
        return InsidedTokenResponseModel(
