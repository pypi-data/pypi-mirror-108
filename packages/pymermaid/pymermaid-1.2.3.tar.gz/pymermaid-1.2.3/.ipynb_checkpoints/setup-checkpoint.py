...
setup(name='pymermaid',
      version='1.2.3',
      description='a package in getting images output from mermaid markdown tags. Especially this package could be used in jupyter lab or notebook, cause it is lack of flowchart\gatt\seqeunses',
      author='Gavin Long',
