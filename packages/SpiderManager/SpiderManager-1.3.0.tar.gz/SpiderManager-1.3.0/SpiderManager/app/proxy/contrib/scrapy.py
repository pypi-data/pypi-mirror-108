...
from SpiderManager.app.proxy.spiderctrl import SpiderServiceProxy
from SpiderManager.app.spider.model import SpiderStatus, Project, SpiderInstance
from SpiderManager.app.util.http import request
