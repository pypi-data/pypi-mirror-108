...
class DarkRunTest(ModuleBase, unittest.TestCase):
    ...
    def test_create_dark_run(self):
        ...
        dark_run_01.calcat_url = self.dark_01_upd['calcat_url']
        dark_run_01.globus_url = self.dark_01_upd['globus_url']
        ...
        dark_run_01.calcat_url = self.dark_01_orig['calcat_url']
        dark_run_01.globus_url = self.dark_01_orig['globus_url']
        ...
        #
        dark_run_01.globus_url = '#' * 251  # String with length of 251
        dark_run_01.description = self.dark_01_upd['description']
