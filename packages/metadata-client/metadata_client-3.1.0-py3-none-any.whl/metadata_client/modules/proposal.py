...
class Proposal:
    ...
    # def check_daq_status(self, proposal, instruments_list):
    #
    #     if not proposal_instruments.include? (instruments_list)
    #         return "This proposal does not belong to the RC selected list of instrument"
