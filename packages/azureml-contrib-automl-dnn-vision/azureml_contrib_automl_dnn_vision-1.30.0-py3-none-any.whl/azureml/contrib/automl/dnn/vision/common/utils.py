...
def freeze_model_layers(model_wrapper, layers_to_freeze):
    ...
    if model_wrapper.model_name == ic_ModelNames.SERESNEXT:
        name_key = 'seresnext'
    elif model_wrapper.model_name == ic_ModelNames.MOBILENETV2:
        name_key = 'mobilenetv2'
    elif model_wrapper.model_name in [ic_ModelNames.RESNET18, ic_ModelNames.RESNET34, ic_ModelNames.RESNET50]:
        name_key = 'resnet'
    elif model_wrapper.model_name == od_ModelNames.YOLO_V5:
        name_key = 'yolov5_backbone'
    else:
        name_key = 'resnet_backbone'

    model_specific_layers = model_layers[name_key]
