...
from azureml.contrib.automl.dnn.vision.classification.models.classification_model_wrappers import ModelFactory, \
    Resnet18Wrapper, Resnet34Wrapper, Resnet50Wrapper, Mobilenetv2Wrapper, SeresnextWrapper, ResNest50Wrapper, \
    ResNest101Wrapper
from azureml.contrib.automl.dnn.vision.classification.common.constants import ModelNames, ModelLiterals, \
...
class TestModelWrappers:
    ...
    def test_wrappers(self):
        ...
        model_wapper_args = dict(num_classes=20, resize_size=256, crop_size=224)
    ...
    def test_wrappers_export_onnx(self, root_dir):
        ...
        res34 = Resnet34Wrapper(num_classes=20, resize_size=96, crop_size=64)
        ...
        res50 = Resnet50Wrapper(num_classes=20, resize_size=256 + 32, crop_size=224 + 32)
        ...
        mv2 = Mobilenetv2Wrapper(num_classes=20, resize_size=256 - 32, crop_size=224 - 32)
        ...
        sn = SeresnextWrapper(num_classes=20, resize_size=256 + 32, crop_size=224 + 32)
        ...
        resnest50 = ResNest50Wrapper(num_classes=20, resize_size=256 - 32, crop_size=224 - 32)
        ...
        # pass non-default values for input image size
        resnest101 = ResNest101Wrapper(num_classes=20, resize_size=256 + 32, crop_size=224 + 32)
    ...
    def test_model_factory(self):
        ...
        model_wrapper = model_factory.get_model_wrapper(model_name=ModelNames.RESNET18, num_classes=5,
                                                        ...
                                                        settings={ModelLiterals.RESIZE_SIZE: 256,
                                                                  ModelLiterals.CROP_SIZE: 224})
        assert model_wrapper.resize_size == 256 and model_wrapper.crop_size == 224
        # resnet34
        model_wrapper = model_factory.get_model_wrapper(model_name=ModelNames.RESNET34, num_classes=5,
                                                        multilabel=True, device='cpu', distributed=False, rank=0,
                                                        settings={ModelLiterals.RESIZE_SIZE: 96,
                                                                  ModelLiterals.CROP_SIZE: 64})
        assert model_wrapper.resize_size == 96 and model_wrapper.crop_size == 64
        # resnet50
        model_wrapper = model_factory.get_model_wrapper(ModelNames.RESNET50, 5, True, 'cpu', False, 0,
                                                        {ModelLiterals.RESIZE_SIZE: 256 + 32,
                                                         ModelLiterals.CROP_SIZE: 224 + 32})
        assert model_wrapper.resize_size == 256 + 32 and model_wrapper.crop_size == 224 + 32
        # mobilenetv2
        model_wrapper = model_factory.get_model_wrapper(ModelNames.MOBILENETV2, 5, True, 'cpu', False, 0)
        assert model_wrapper.resize_size == ModelParameters.DEFAULT_RESIZE_SIZE
        assert model_wrapper.crop_size == ModelParameters.DEFAULT_CROP_SIZE
        # seresnext
        ...
        model_wrapper = model_factory.get_model_wrapper(model_name=ModelNames.RESNEST50, num_classes=5,
                                                        multilabel=True, device='cpu', distributed=False, rank=0,
                                                        settings={ModelLiterals.RESIZE_SIZE: 256 - 32,
                                                                  ModelLiterals.CROP_SIZE: 224 - 32})
        assert model_wrapper.resize_size == 256 - 32 and model_wrapper.crop_size == 224 - 32
        # resnest101
