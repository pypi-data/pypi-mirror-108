# mypy-boto3-codestar-notifications<a id="mypy-boto3-codestar-notifications"></a>
...
[boto3.CodeStarNotifications 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/codestar-notifications.html#CodeStarNotifications)
