...
* Rules
  -t  --standard                          Only show standard rules (with --list-rules)
  -u  --user                              Only show user rules (with --list-rules)
* Filters
  -y  --sync                              Update remote filters repository
  -c  --custom                            Only show custom filters (with --list)
  -k  --subscribing                       Only show subscribed filters (with --list)
  -n  --unsubscribing                     Only show unsubscribed filters (with --list)
  -w  --on-remote-repo                    Only show filters available on remote repository (with --list)
