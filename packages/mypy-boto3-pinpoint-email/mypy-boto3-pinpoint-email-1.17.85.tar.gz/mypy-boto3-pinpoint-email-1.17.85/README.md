# mypy-boto3-pinpoint-email<a id="mypy-boto3-pinpoint-email"></a>
...
[boto3.PinpointEmail 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/pinpoint-email.html#PinpointEmail)
