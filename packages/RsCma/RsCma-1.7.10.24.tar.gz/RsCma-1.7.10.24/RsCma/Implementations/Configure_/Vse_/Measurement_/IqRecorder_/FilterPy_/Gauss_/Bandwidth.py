...
class Bandwidth:
	...
	def set(self, gauss_bw: float, standard: enums.Standard = None) -> None:
		...
		Sets or queries the bandwidth of the Gauss filter and the related digital standard. \n
			...
			:param standard: DMR | NXDN | P25 | TETRa | LTE | UDEFined Unit: Hz
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('gauss_bw', gauss_bw, DataType.Float), ArgSingle('standard', standard, DataType.Enum, True))
