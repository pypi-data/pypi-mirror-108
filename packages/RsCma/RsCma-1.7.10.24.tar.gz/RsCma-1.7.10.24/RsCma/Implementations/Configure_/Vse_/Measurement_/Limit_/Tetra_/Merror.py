...
class Merror:
	...
	def get_rms(self) -> RmsStruct:
		...
		Snippet: value: RmsStruct = driver.configure.vse.measurement.limit.tetra.merror.get_rms() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:TETRa:MERRor:RMS?', self.__class__.RmsStruct())

	def set_rms(self, value: RmsStruct) -> None:
		"""SCPI: CONFigure:VSE:MEASurement<Instance>:LIMit:TETRa:MERRor:RMS \n
		Snippet: driver.configure.vse.measurement.limit.tetra.merror.set_rms(value = RmsStruct()) \n
		Enables/disables limit evaluation and sets the upper limit for the RMS magnitude error. \n
			:param value: see the help for RmsStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:TETRa:MERRor:RMS', value)
	...
	def get_peak(self) -> PeakStruct:
		...
		Snippet: value: PeakStruct = driver.configure.vse.measurement.limit.tetra.merror.get_peak() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:TETRa:MERRor:PEAK?', self.__class__.PeakStruct())

	def set_peak(self, value: PeakStruct) -> None:
		"""SCPI: CONFigure:VSE:MEASurement<Instance>:LIMit:TETRa:MERRor:PEAK \n
		Snippet: driver.configure.vse.measurement.limit.tetra.merror.set_peak(value = PeakStruct()) \n
		Enables/disables limit evaluation and sets the upper limit for the peak magnitude error. \n
			:param value: see the help for PeakStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:TETRa:MERRor:PEAK', value)
