...
class FfError:
	...
	def get_peak(self) -> PeakStruct:
		...
		Snippet: value: PeakStruct = driver.configure.vse.measurement.limit.ptFive.ffError.get_peak() \n
		No command help available \n
			:return: structure: for return value, see the help for PeakStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:PTFive:FFERor:PEAK?', self.__class__.PeakStruct())

	def set_peak(self, value: PeakStruct) -> None:
		"""SCPI: CONFigure:VSE:MEASurement<Instance>:LIMit:PTFive:FFERor:PEAK \n
		Snippet: driver.configure.vse.measurement.limit.ptFive.ffError.set_peak(value = PeakStruct()) \n
		No command help available \n
			:param value: see the help for PeakStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:PTFive:FFERor:PEAK', value)
	...
	def get_rms(self) -> RmsStruct:
		...
		Snippet: value: RmsStruct = driver.configure.vse.measurement.limit.ptFive.ffError.get_rms() \n
		No command help available \n
			:return: structure: for return value, see the help for RmsStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:PTFive:FFERor:RMS?', self.__class__.RmsStruct())

	def set_rms(self, value: RmsStruct) -> None:
		"""SCPI: CONFigure:VSE:MEASurement<Instance>:LIMit:PTFive:FFERor:RMS \n
		Snippet: driver.configure.vse.measurement.limit.ptFive.ffError.set_rms(value = RmsStruct()) \n
		No command help available \n
			:param value: see the help for RmsStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:VSE:MEASurement<Instance>:LIMit:PTFive:FFERor:RMS', value)
