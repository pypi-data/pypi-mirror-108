...
class First:
	"""First commands group definition. 1 total commands, 1 Sub-groups, 0 group commands"""
	...
	def multiTone(self):
		...
		if not hasattr(self, '_multiTone'):
			from .First_.MultiTone import MultiTone
	...
	def clone(self) -> 'First':
		...
		new_group = First(self._core, self._base.parent)
