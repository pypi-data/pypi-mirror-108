...
class Marker:
	...
	def fetch(self, trace: enums.Statistic, freq_value: float, marker=repcap.Marker.Nr1) -> FetchStruct:
		...
		Moves marker number <no> to a specified x-value and returns the absolute coordinates. Absolute placement is used. Marker
		number one is the reference marker. Select the trace to be evaluated and the x-value. \n
