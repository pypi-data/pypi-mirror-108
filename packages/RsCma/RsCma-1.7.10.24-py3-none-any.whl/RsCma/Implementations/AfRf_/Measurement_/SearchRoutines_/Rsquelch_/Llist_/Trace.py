...
class Trace:
	...
	def fetch(self) -> List[float]:
		...
		Fetches the list of RF levels for the squelch measurement. These levels are the x-values for the points in the RX squelch
		diagram. \n
		Use RsCma.reliability.last_value to read the updated reliability indicator. \n
			:return: level_list: Unit: dBm"""
	...
	def read(self) -> List[float]:
		...
		Use RsCma.reliability.last_value to read the updated reliability indicator. \n
			:return: level_list: No help available"""
		suppressed = ArgSingleSuppressed(0, DataType.Integer, False, 1, 'Reliability')
