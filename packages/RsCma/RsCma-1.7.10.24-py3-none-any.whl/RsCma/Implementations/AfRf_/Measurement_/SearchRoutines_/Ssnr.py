...
class Ssnr:
	"""Ssnr commands group definition. 8 total commands, 4 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Ssnr_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Ssnr_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Ssnr_.Maximum import Maximum
	...
	def deviation(self):
		...
		if not hasattr(self, '_deviation'):
			from .Ssnr_.Deviation import Deviation
