...
class Pdeviation:
	"""Pdeviation commands group definition. 5 total commands, 1 Sub-groups, 3 group commands"""
	...
	def trace(self):
		...
		if not hasattr(self, '_trace'):
			from .Pdeviation_.Trace import Trace
	...
	def fetch(self) -> float:
		...
		Use RsCma.reliability.last_value to read the updated reliability indicator. \n
			:return: phase_dev: No help available"""
