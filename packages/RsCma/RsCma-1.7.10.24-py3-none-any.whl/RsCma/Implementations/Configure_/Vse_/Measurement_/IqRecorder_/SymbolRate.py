...
class SymbolRate:
	...
	def set(self, sample_rate: float, standard: enums.Standard = None) -> None:
		...
		The sample rate of the IQ recorder. \n
			:param sample_rate: Range: 0 Hz to 100 MHz, Unit: Hz
			:param standard: DMR | NXDN | P25 | TETRa | LTE | UDEFined
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('sample_rate', sample_rate, DataType.Float), ArgSingle('standard', standard, DataType.Enum, True))
