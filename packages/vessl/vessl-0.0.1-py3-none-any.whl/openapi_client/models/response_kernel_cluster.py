...
class ResponseKernelCluster(object):
    ...
    openapi_types = {
        'created_dt': 'datetime',
        'global_kernel_cluster_id': 'int',
        'id': 'int',
        'immutable_slug': 'str',
        'is_savvihub_managed': 'bool',
        'kernel_cluster_workspace': 'int',
    ...
    attribute_map = {
        ...
        'global_kernel_cluster_id': 'global_kernel_cluster_id',
        'id': 'id',
        'immutable_slug': 'immutable_slug',
        'is_savvihub_managed': 'is_savvihub_managed',
        'kernel_cluster_workspace': 'kernel_cluster_workspace',
    ...
    def __init__(self, created_dt=None, global_kernel_cluster_id=None, id=None, immutable_slug=None, is_savvihub_managed=None, kernel_cluster_workspace=None, kubernetes_service_type=None, name=None, provider=None, region=None, updated_dt=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._global_kernel_cluster_id = None
        self._id = None
        self._immutable_slug = None
        self._is_savvihub_managed = None
        self._kernel_cluster_workspace = None
        ...
        self.global_kernel_cluster_id = global_kernel_cluster_id
        self.id = id
        self.immutable_slug = immutable_slug
        self.is_savvihub_managed = is_savvihub_managed
        self.kernel_cluster_workspace = kernel_cluster_workspace
    ...
    @property
    def global_kernel_cluster_id(self):
        """Gets the global_kernel_cluster_id of this ResponseKernelCluster.  # noqa: E501


        :return: The global_kernel_cluster_id of this ResponseKernelCluster.  # noqa: E501
        :rtype: int
        """
        return self._global_kernel_cluster_id

    @global_kernel_cluster_id.setter
    def global_kernel_cluster_id(self, global_kernel_cluster_id):
        """Sets the global_kernel_cluster_id of this ResponseKernelCluster.


        :param global_kernel_cluster_id: The global_kernel_cluster_id of this ResponseKernelCluster.  # noqa: E501
        :type global_kernel_cluster_id: int
        """

        self._global_kernel_cluster_id = global_kernel_cluster_id
    ...
    @property
    def kernel_cluster_workspace(self):
        """Gets the kernel_cluster_workspace of this ResponseKernelCluster.  # noqa: E501


        :return: The kernel_cluster_workspace of this ResponseKernelCluster.  # noqa: E501
        :rtype: int
        """
        return self._kernel_cluster_workspace

    @kernel_cluster_workspace.setter
    def kernel_cluster_workspace(self, kernel_cluster_workspace):
        """Sets the kernel_cluster_workspace of this ResponseKernelCluster.


        :param kernel_cluster_workspace: The kernel_cluster_workspace of this ResponseKernelCluster.  # noqa: E501
        :type kernel_cluster_workspace: int
        """
        if self.local_vars_configuration.client_side_validation and kernel_cluster_workspace is None:  # noqa: E501
            raise ValueError("Invalid value for `kernel_cluster_workspace`, must not be `None`")  # noqa: E501

        self._kernel_cluster_workspace = kernel_cluster_workspace
