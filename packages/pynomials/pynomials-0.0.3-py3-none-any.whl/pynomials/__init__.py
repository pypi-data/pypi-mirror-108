...
class Polynomial():
    ...
    def __init__(self, /, *coefficients):
        ...
        all coefficients should be Real 'int' / 'float' numbers
        ...
        for coeff in coefficients:
            ...
            if str(abs(coeff)) in {"nan", "inf"}:
                raise ValueError(
                    f"invalid coefficient for 'Polynomial': '{coeff}'"
                )
    ...
    def __call__(self, /, q):
        ...
        Polynomial Function at x = q, i.e., P(q) where = self
    ...
    def __contains__(self, point, /):
        ...
        (x, y) must be a tuple of 'int' / 'float'"""
    ...
    def __floordiv__(self, other, /):
        ...
        returns the result for (self // other)
        i.e., returns the Quotient obtained when self is divided by other and
        returns None if the result is NOT a Polynomial, but a Rational Function
        Note: cannot divide Polynomial by Polynomial(0)"""
    ...
    def __mod__(self, other, /):
        ...
        returns the result for (self % other)
        i.e., returns the Remainder when self is divided by other and returns
        None if (self // other) is NOT a Polynomial, but a Rational Function
        Note: cannot divide Polynomial by Polynomial(0)"""
    ...
    @staticmethod
    def plot_polynomials(*polynomials, limits=(-100, 100), show_legend=True):
    ...
    def integral(self, /, *, c=0):
        ...
        constant = c which must be 'int' / 'float'"""
