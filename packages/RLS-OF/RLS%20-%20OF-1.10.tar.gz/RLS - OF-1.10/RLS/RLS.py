...
class RLS():
    ...
    def compute_minimum(self):
        ...
        self.inversion_algorithm.gamma = self.gamma
        f0 = self.LS_function(self.current_estimate)
        ...
        self.gamma = self.inversion_algorithm.gamma

        return reconstructed, self.f_c, self.measurement
