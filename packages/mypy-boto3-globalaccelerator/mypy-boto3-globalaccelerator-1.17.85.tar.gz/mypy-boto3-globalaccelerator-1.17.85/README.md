# mypy-boto3-globalaccelerator<a id="mypy-boto3-globalaccelerator"></a>
...
[boto3.GlobalAccelerator 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/globalaccelerator.html#GlobalAccelerator)
