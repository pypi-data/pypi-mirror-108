import sys,os
sys.path.append(os.path.abspath('/root/pydata/tpexe/tpexe/login'))
sys.path.append(os.path.abspath('/root/pydata/tpexe/tpexe/conf'))
...
class Delete(object):
    ...
    def delete_host_run(self):
        ...
        _sid = login.login(conf_data['url'], conf_data['secret'], conf_data['login_user'], conf_data['login_passwd'], login.get_login_headers(conf_data))
