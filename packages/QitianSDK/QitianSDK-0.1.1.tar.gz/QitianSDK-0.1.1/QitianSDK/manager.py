...
class QitianManager:
    QITIAN_HOST = 'https://api.qt.6-79.cn'
    GET_TOKEN_URL = '%s/oauth/token' % QITIAN_HOST
    GET_USER_INFO_URL = '%s/user/' % QITIAN_HOST
    GET_USER_PHONE_URL = '%s/user/phone' % QITIAN_HOST
