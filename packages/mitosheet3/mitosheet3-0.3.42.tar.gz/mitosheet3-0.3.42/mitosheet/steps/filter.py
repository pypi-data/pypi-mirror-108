...
def get_applied_filter(df, column_header, filter_):
    ...
    if type_ == STRING_SERIES:
        ...
        elif condition == 'string_not_exactly':
            return df[column_header] != value
        ...
        if condition == 'number_exactly':
            return df[column_header] == value
        elif condition == 'number_not_exactly':
            return df[column_header] != value
...
def get_filter_string(df_name, column_header, filter_):
    ...
    FILTER_FORMAT_STRING_DICT = {
        ...
        'number_not_exactly': '{df_name}[\'{column_header}\'] != {value}',
        ...
        'string_not_exactly': '{df_name}[\'{column_header}\'] != \'{value}\'',
