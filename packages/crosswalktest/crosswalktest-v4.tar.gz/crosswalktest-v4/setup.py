...
setup(
  ...
  version = 'v4',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/nikbpetrov/crosswalktest/archive/refs/tags/v4.tar.gz',    # I explain this later on
