...
class AlertCreator:
    ...
    Args:
        ...
        minimum_length_of_alert (int): In ms. The length an alert needs to have to be a valid alert.
        maximumg_length_of_alert (int): In ms. (not implemented) If the alert is longer
        than this parameter, a new alert will be created.
        alert_window (int): In ms.
    ...
    def _retrieve_previous_open_alerts(self, end_point):
    ...
    def create_alerts(
        ...
        Args:
            air_client (AIRClient): air client!
            df (Union[pd.DataFrame, List[List]): Either pandas DataFrame with a boolean column named "deviation" or a
            list of lists.
        ...
        # remove duplicates
        non_duplicated_new_events = _duplication_removal(new_events, open_alerts)
