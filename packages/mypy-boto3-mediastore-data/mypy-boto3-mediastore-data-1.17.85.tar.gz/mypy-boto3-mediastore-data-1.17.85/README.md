# mypy-boto3-mediastore-data<a id="mypy-boto3-mediastore-data"></a>
...
[boto3.MediaStoreData 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/mediastore-data.html#MediaStoreData)
