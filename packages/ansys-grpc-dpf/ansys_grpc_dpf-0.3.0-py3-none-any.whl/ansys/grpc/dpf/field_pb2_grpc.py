...
class FieldServiceServicer(object):
    ...
    def UpdateData(self, request_iterator, context):
        """streams bytes from client to server if floats are used instead of doubles add client metadata with "float_or_double"="float"
        optional: for efficiency purpose, please give the total array size in the client metadata with "size_bytes", "size_double" or "size_float"
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def List(self, request, context):
        """sends streamed data, to choose the size set metadata with "num_float", "num_double", "num_int" or "num_bytes"
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def ListDataPointer(self, request, context):
        """sends streamed data, to choose the size set metadata "num_int" or "num_bytes"
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
