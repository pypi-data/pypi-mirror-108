...
class PlanSettings(object):
    ...
    def __init__(self, configuration='default', planning_time=20, result_ttl=20, result_timezone=0, predict_slots=0, transport_factor=[], capacity_factor=[], routing=[], assumptions=None, penalties=None, precision=2, local_vars_configuration=None):  # noqa: E501
