...
class Engine:
  ...
  def __init__(self,start_date, portfolio, weights=None, benchmark=['SPY'], end_date=today, optimizer=None):
    ...
    if optimizer== "EF":
      self.weights = efficient_frontier(self)
    
    if optimizer== "HRP":
      self.weights = hrp(self)

    if optimizer== "MV":
      self.weights = mean_var(self)
    
    if optimizer== "EW":
      self.weights = equal_weighting(self)
...
def hrp(my_portfolio, periods="max"):
  ...
  return flatten(result)
#-----------------------------------------------------------------------------
def mean_var(my_portfolio, periods="max"):
  ...
  return flatten(result)
#--------------------------------------------------------------------------------
def optimizer(my_portfolio, method, periods="max"):
  ...
  if method == "MV":
    wts = mean_var(my_portfolio, periods)
