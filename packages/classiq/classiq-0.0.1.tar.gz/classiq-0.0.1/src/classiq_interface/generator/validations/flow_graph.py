...
def _parse_segment_inputs(segment: Segment, wires: Dict[str, Wire]) -> None:
...
def _parse_segment_outputs(segment: Segment, wires: Dict[str, Wire]) -> None:
...
def create_flow_graph(segment_list: List[Segment]) -> nx.DiGraph:
    input_names = sorted(
