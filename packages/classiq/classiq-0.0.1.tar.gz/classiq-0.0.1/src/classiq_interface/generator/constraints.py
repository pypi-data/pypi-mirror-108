...
from classiq_interface.generator.segments import Segment
...
class QuantumCircuitConstraints(pydantic.BaseModel):
    ...
    segments: List[Segment] = pydantic.Field(
        ...
        description="List of segment objects to be assigned in the circuit",
    )
    ...
    allowed_gates: Optional[List[QiskitBuiltinQuantumGates]] = None
    ...
    combinatorial_optimization: Optional[CombinatorialOptimization] = None
