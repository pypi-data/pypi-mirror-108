...
class ImageMetrics():
	def __init__(self, img, m=2, n=2, path=False):
		...
		left_img, right_img = self.crop_for_left_vs_right_differences(left_img, 
		                                                              right_img)
		self.left_grids = self.create_image_grids(left_img, m=m, n=n)
		self.right_grids = self.create_image_grids(right_img, m=m, n=n)
	...
	def create_image_grids(self, img, m=2, n=2):
