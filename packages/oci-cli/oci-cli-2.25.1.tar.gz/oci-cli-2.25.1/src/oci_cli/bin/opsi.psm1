...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi database-insights create-em-external-db' = 'compartment-id defined-tags em-bridge-id em-entity-id em-id freeform-tags from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'opsi database-insights list' = 'all compartment-id database-id database-type em-bridge-id fields from-json help id lifecycle-state limit page page-size sort-by sort-order status'
        ...
        'opsi database-insights list-sql-texts' = 'all compartment-id database-id from-json help id page sql-identifier'
        'opsi database-insights summarize-database-insight-resource-capacity-trend' = 'analysis-time-interval compartment-id database-id database-type from-json help host-name id page resource-metric sort-by sort-order tablespace-name time-interval-end time-interval-start utilization-level'
        'opsi database-insights summarize-database-insight-resource-forecast-trend' = 'analysis-time-interval compartment-id confidence database-id database-type forecast-days forecast-model from-json help host-name id page resource-metric statistic tablespace-name time-interval-end time-interval-start utilization-level'
        'opsi database-insights summarize-database-insight-resource-statistics' = 'analysis-time-interval compartment-id database-id database-type forecast-days from-json help host-name id insight-by limit page percentile resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi database-insights summarize-database-insight-resource-usage' = 'analysis-time-interval compartment-id database-id database-type from-json help id page percentile resource-metric time-interval-end time-interval-start'
        'opsi database-insights summarize-database-insight-resource-usage-trend' = 'analysis-time-interval compartment-id database-id database-type from-json help id page resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi database-insights summarize-database-insight-resource-utilization-insight' = 'analysis-time-interval compartment-id database-id database-type forecast-days from-json help id page resource-metric time-interval-end time-interval-start'
        ...
        'opsi database-insights summarize-sql-insights' = 'analysis-time-interval compartment-id database-id database-time-pct-greater-than database-type from-json help id page time-interval-end time-interval-start'
        ...
        'opsi database-insights summarize-sql-statistics' = 'analysis-time-interval category compartment-id database-id database-time-pct-greater-than database-type from-json help id limit page sort-by sort-order sql-identifier time-interval-end time-interval-start'
        'opsi database-insights summarize-sql-statistics-time-series' = 'analysis-time-interval compartment-id database-id from-json help id page sql-identifier time-interval-end time-interval-start'
        ...
        'opsi enterprise-manager-bridges list' = 'all compartment-id display-name from-json help id lifecycle-state limit page page-size sort-by sort-order'
        'opsi enterprise-manager-bridges list-importable-enterprise-manager-entities' = 'all enterprise-manager-bridge-id from-json help limit page page-size'
        ...
        'opsi host-insights list' = 'all compartment-id from-json help host-type id lifecycle-state limit page page-size platform-type sort-by sort-order status'
        'opsi host-insights list-hosted-entities' = 'all analysis-time-interval compartment-id from-json help id limit page page-size platform-type sort-by sort-order time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-capacity-trend' = 'analysis-time-interval compartment-id from-json help id page platform-type resource-metric sort-by sort-order time-interval-end time-interval-start utilization-level'
        'opsi host-insights summarize-host-insight-resource-forecast-trend' = 'analysis-time-interval compartment-id confidence forecast-days forecast-model from-json help id page platform-type resource-metric statistic time-interval-end time-interval-start utilization-level'
        'opsi host-insights summarize-host-insight-resource-statistics' = 'analysis-time-interval compartment-id forecast-days from-json help id insight-by limit page percentile platform-type resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-usage' = 'analysis-time-interval compartment-id from-json help id page percentile platform-type resource-metric time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-usage-trend' = 'analysis-time-interval compartment-id from-json help id page platform-type resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-utilization-insight' = 'analysis-time-interval compartment-id forecast-days from-json help id page platform-type resource-metric time-interval-end time-interval-start'
        ...
        'opsi work-requests list' = 'all compartment-id from-json help limit page page-size'
    }
