...
class LegacyTranslationEnum:
    ...
    ACTIONS_FILTER = (1, 18)
    ACTIONS_FORGET = (1, 19)
    ACTIONS_FORGET_CARD = (1, 20)
    ACTIONS_GREEN_FLAG = (1, 21)
    ACTIONS_HELP = (1, 22)
    ACTIONS_IMPORT = (1, 23)
    ACTIONS_MANAGE = (1, 24)
    ACTIONS_NAME = (1, 25)
    ACTIONS_NEW = (1, 26)
    ACTIONS_NEW_NAME = (1, 27)
    ACTIONS_OPTIONS = (1, 28)
    ACTIONS_OPTIONS_FOR = (1, 29)
    ACTIONS_ORANGE_FLAG = (1, 30)
    ACTIONS_PINK_FLAG = (1, 31)
    ACTIONS_PREVIEW = (1, 32)
    ACTIONS_PURPLE_FLAG = (1, 33)
    ACTIONS_REBUILD = (1, 34)
    ACTIONS_RED_FLAG = (1, 35)
    ACTIONS_REMOVE_NOTETYPE = (1, 36)
    ACTIONS_REMOVE_TAG = (1, 37)
    ACTIONS_RENAME = (1, 38)
    ACTIONS_RENAME_DECK = (1, 39)
    ACTIONS_RENAME_TAG = (1, 40)
    ACTIONS_REPLAY_AUDIO = (1, 41)
    ACTIONS_REPOSITION = (1, 42)
    ACTIONS_SAVE = (1, 43)
    ACTIONS_SEARCH = (1, 44)
    ACTIONS_SELECT = (1, 45)
    ACTIONS_SET_DUE_DATE = (1, 46)
    ACTIONS_SET_FLAG = (1, 47)
    ACTIONS_SHORTCUT_KEY = (1, 48)
    ACTIONS_SUSPEND_CARD = (1, 49)
    ACTIONS_TURQUOISE_FLAG = (1, 50)
    ACTIONS_UNBURY_UNSUSPEND = (1, 51)
    ACTIONS_UPDATE_CARD = (1, 52)
    ACTIONS_UPDATE_CONFIG = (1, 53)
    ACTIONS_UPDATE_DECK = (1, 54)
    ACTIONS_UPDATE_NOTE = (1, 55)
    ACTIONS_UPDATE_NOTETYPE = (1, 56)
    ACTIONS_UPDATE_TAG = (1, 57)
    ADDING_ADD_SHORTCUT_CTRLANDENTER = (2, 0)
    ADDING_ADDED = (2, 1)
    ADDING_CLOSE_AND_LOSE_CURRENT_INPUT = (2, 2)
    ADDING_EDIT = (2, 3)
    ADDING_HISTORY = (2, 4)
    ADDING_NOTE_DELETED = (2, 5)
    ADDING_SHORTCUT = (2, 6)
    ADDING_THE_FIRST_FIELD_IS_EMPTY = (2, 7)
    ADDING_YOU_HAVE_A_CLOZE_DELETION_NOTE = (2, 8)
    ...
    BROWSING_CHANGE_TO = (4, 27)
    BROWSING_CHANGED_NEW_POSITION = (4, 28)
    BROWSING_CLEAR_UNUSED = (4, 29)
    BROWSING_CLEAR_UNUSED_TAGS = (4, 30)
    BROWSING_CONFIRM_SAVED_SEARCH_OVERWRITE = (4, 31)
    BROWSING_CREATED = (4, 32)
    BROWSING_CTRLANDSHIFTANDE = (4, 33)
    BROWSING_CURRENT_DECK = (4, 34)
    BROWSING_CURRENT_NOTE_TYPE = (4, 35)
    BROWSING_DELETE_NOTES = (4, 36)
    BROWSING_DELETE_TAGS = (4, 37)
    BROWSING_DUPLICATE = (4, 38)
    BROWSING_EASE = (4, 39)
    BROWSING_EDITED_TODAY = (4, 40)
    BROWSING_END = (4, 41)
    BROWSING_ENTER_TAGS_TO_ADD = (4, 42)
    BROWSING_ENTER_TAGS_TO_DELETE = (4, 43)
    BROWSING_FILTERED = (4, 44)
    BROWSING_FIND = (4, 45)
    BROWSING_FIND_AND_REPLACE = (4, 46)
    BROWSING_FIND_DUPLICATES = (4, 47)
    BROWSING_FIRST_CARD = (4, 48)
    BROWSING_FLAG = (4, 49)
    BROWSING_FONT = (4, 50)
    BROWSING_FONT_SIZE = (4, 51)
    BROWSING_FOUND_AS_ACROSS_BS = (4, 52)
    BROWSING_GROUP = (4, 53)
    BROWSING_HOME = (4, 54)
    BROWSING_IGNORE_CASE = (4, 55)
    BROWSING_IN = (4, 56)
    BROWSING_INTERVAL = (4, 57)
    BROWSING_LAST_CARD = (4, 58)
    BROWSING_LEARNING = (4, 59)
    BROWSING_LINE_SIZE = (4, 60)
    BROWSING_MANAGE_NOTE_TYPES = (4, 61)
    BROWSING_MOVE_CARDS = (4, 62)
    BROWSING_MOVE_CARDS_TO_DECK = (4, 63)
    BROWSING_ND_NAMES = (4, 64)
    BROWSING_NEW = (4, 65)
    BROWSING_NEW_NOTE_TYPE = (4, 66)
    BROWSING_NO_FLAG = (4, 67)
    BROWSING_NO_SELECTION = (4, 68)
    BROWSING_NOTE = (4, 69)
    BROWSING_NOTE_COUNT = (4, 70)
    BROWSING_NOTE_DELETED = (4, 71)
    BROWSING_NOTE_INITIAL = (4, 72)
    BROWSING_NOTES_TAGGED = (4, 73)
    BROWSING_NOTES_UPDATED = (4, 74)
    BROWSING_NOTHING = (4, 75)
    BROWSING_ONLY_NEW_CARDS_CAN_BE_REPOSITIONED = (4, 76)
    BROWSING_OPTIONAL_FILTER = (4, 77)
    BROWSING_OVERRIDE_BACK_TEMPLATE = (4, 78)
    BROWSING_OVERRIDE_FONT = (4, 79)
    BROWSING_OVERRIDE_FRONT_TEMPLATE = (4, 80)
    BROWSING_PLEASE_GIVE_YOUR_FILTER_A_NAME = (4, 81)
    BROWSING_PLEASE_SELECT_CARDS_FROM_ONLY_ONE = (4, 82)
    BROWSING_PREVIEW_SELECTED_CARD = (4, 83)
    BROWSING_QUESTION = (4, 84)
    BROWSING_QUEUE_BOTTOM = (4, 85)
    BROWSING_QUEUE_TOP = (4, 86)
    BROWSING_RANDOMIZE_ORDER = (4, 87)
    BROWSING_REMOVE_TAGS = (4, 88)
    BROWSING_REMOVED_UNUSED_TAGS_COUNT = (4, 89)
    BROWSING_REPARENTED_DECKS = (4, 90)
    BROWSING_REPLACE_WITH = (4, 91)
    BROWSING_REPOSITION = (4, 92)
    BROWSING_REPOSITION_NEW_CARDS = (4, 93)
    BROWSING_RESCHEDULE = (4, 94)
    BROWSING_ROW_DELETED = (4, 95)
    BROWSING_SEARCH_BAR_HINT = (4, 96)
    BROWSING_SEARCH_IN = (4, 97)
    BROWSING_SEARCH_WITHIN_FORMATTING_SLOW = (4, 98)
    BROWSING_SHIFT_POSITION_OF_EXISTING_CARDS = (4, 99)
    BROWSING_SIDEBAR = (4, 100)
    BROWSING_SIDEBAR_CARD_STATE = (4, 101)
    BROWSING_SIDEBAR_COLLAPSE = (4, 102)
    BROWSING_SIDEBAR_COLLAPSE_CHILDREN = (4, 103)
    BROWSING_SIDEBAR_DECKS = (4, 104)
    BROWSING_SIDEBAR_DUE_TODAY = (4, 105)
    BROWSING_SIDEBAR_EXPAND = (4, 106)
    BROWSING_SIDEBAR_EXPAND_CHILDREN = (4, 107)
    BROWSING_SIDEBAR_FILTER = (4, 108)
    BROWSING_SIDEBAR_FIRST_REVIEW = (4, 109)
    BROWSING_SIDEBAR_FLAGS = (4, 110)
    BROWSING_SIDEBAR_NOTETYPES = (4, 111)
    BROWSING_SIDEBAR_OVERDUE = (4, 112)
    BROWSING_SIDEBAR_SAVE_CURRENT_SEARCH = (4, 113)
    BROWSING_SIDEBAR_SAVED_SEARCHES = (4, 114)
    BROWSING_SIDEBAR_TAGS = (4, 115)
    BROWSING_SIDEBAR_UNTAGGED = (4, 116)
    BROWSING_SORT_FIELD = (4, 117)
    BROWSING_SORTING_ON_THIS_COLUMN_IS_NOT = (4, 118)
    BROWSING_START_POSITION = (4, 119)
    BROWSING_STEP = (4, 120)
    BROWSING_STUDIED_TODAY = (4, 121)
    BROWSING_SUSPENDED = (4, 122)
    BROWSING_TAG_DUPLICATES = (4, 123)
    BROWSING_TAG_RENAME_WARNING_EMPTY = (4, 124)
    BROWSING_TARGET_FIELD = (4, 125)
    BROWSING_TODAY = (4, 126)
    BROWSING_TOGGLE_MARK = (4, 127)
    BROWSING_TOGGLE_SHOWING_CARDS_NOTES = (4, 128)
    BROWSING_TOGGLE_SUSPEND = (4, 129)
    ...
    CUSTOM_STUDY_ALL_CARDS_IN_RANDOM_ORDER_DONT = (8, 0)
    CUSTOM_STUDY_ALL_REVIEW_CARDS_IN_RANDOM_ORDER = (8, 1)
    CUSTOM_STUDY_CARDS = (8, 2)
    CUSTOM_STUDY_CARDS_FROM_THE_DECK = (8, 3)
    CUSTOM_STUDY_CHOOSE_TAGS = (8, 4)
    CUSTOM_STUDY_CUSTOM_STUDY_SESSION = (8, 5)
    CUSTOM_STUDY_DUE_CARDS_ONLY = (8, 6)
    CUSTOM_STUDY_INCREASE_TODAYS_NEW_CARD_LIMIT = (8, 7)
    CUSTOM_STUDY_INCREASE_TODAYS_NEW_CARD_LIMIT_BY = (8, 8)
    CUSTOM_STUDY_INCREASE_TODAYS_REVIEW_CARD_LIMIT = (8, 9)
    CUSTOM_STUDY_INCREASE_TODAYS_REVIEW_LIMIT_BY = (8, 10)
    CUSTOM_STUDY_MUST_RENAME_DECK = (8, 11)
    CUSTOM_STUDY_NEW_CARDS_IN_DECK_OVER_TODAY = (8, 12)
    CUSTOM_STUDY_NEW_CARDS_ONLY = (8, 13)
    CUSTOM_STUDY_NO_CARDS_MATCHED_THE_CRITERIA_YOU = (8, 14)
    CUSTOM_STUDY_OK = (8, 15)
    CUSTOM_STUDY_PREVIEW_NEW_CARDS = (8, 16)
    CUSTOM_STUDY_PREVIEW_NEW_CARDS_ADDED_IN_THE = (8, 17)
    CUSTOM_STUDY_REQUIRE_ONE_OR_MORE_OF_THESE = (8, 18)
    CUSTOM_STUDY_REVIEW_AHEAD = (8, 19)
    CUSTOM_STUDY_REVIEW_AHEAD_BY = (8, 20)
    CUSTOM_STUDY_REVIEW_CARDS_FORGOTTEN_IN_LAST = (8, 21)
    CUSTOM_STUDY_REVIEW_FORGOTTEN_CARDS = (8, 22)
    CUSTOM_STUDY_REVIEWS_DUE_IN_DECK_OVER_TODAY = (8, 23)
    CUSTOM_STUDY_SELECT = (8, 24)
    CUSTOM_STUDY_SELECT_TAGS_TO_EXCLUDE = (8, 25)
    CUSTOM_STUDY_SELECTIVE_STUDY = (8, 26)
    CUSTOM_STUDY_STUDY_BY_CARD_STATE_OR_TAG = (8, 27)
    DATABASE_CHECK_CARD_MISSING_NOTE = (9, 0)
    DATABASE_CHECK_CARD_PROPERTIES = (9, 1)
    DATABASE_CHECK_CHECKING_CARDS = (9, 2)
    DATABASE_CHECK_CHECKING_HISTORY = (9, 3)
    DATABASE_CHECK_CHECKING_INTEGRITY = (9, 4)
    DATABASE_CHECK_CHECKING_NOTES = (9, 5)
    DATABASE_CHECK_CORRUPT = (9, 6)
    DATABASE_CHECK_DUPLICATE_CARD_ORDS = (9, 7)
    DATABASE_CHECK_FIELD_COUNT = (9, 8)
    DATABASE_CHECK_MISSING_DECKS = (9, 9)
    DATABASE_CHECK_MISSING_TEMPLATES = (9, 10)
    DATABASE_CHECK_NEW_CARD_HIGH_DUE = (9, 11)
    DATABASE_CHECK_NOTES_WITH_INVALID_UTF8 = (9, 12)
    DATABASE_CHECK_NOTETYPES_RECOVERED = (9, 13)
    DATABASE_CHECK_REBUILDING = (9, 14)
    DATABASE_CHECK_REBUILT = (9, 15)
    DATABASE_CHECK_REVLOG_PROPERTIES = (9, 16)
    DATABASE_CHECK_TITLE = (9, 17)
    DECK_CONFIG_ADD_GROUP = (10, 0)
    DECK_CONFIG_ADVANCED_TITLE = (10, 1)
    DECK_CONFIG_ALWAYS_INCLUDE_QUESTION_AUDIO_TOOLTIP = (10, 2)
    DECK_CONFIG_AUDIO_TITLE = (10, 3)
    DECK_CONFIG_BURY_NEW_SIBLINGS = (10, 4)
    DECK_CONFIG_BURY_REVIEW_SIBLINGS = (10, 5)
    DECK_CONFIG_BURY_TITLE = (10, 6)
    DECK_CONFIG_BURY_TOOLTIP = (10, 7)
    DECK_CONFIG_CLONE_GROUP = (10, 8)
    DECK_CONFIG_CONFIRM_NORMAL = (10, 9)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (10, 10)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (10, 11)
    DECK_CONFIG_DAILY_LIMITS = (10, 12)
    DECK_CONFIG_DEFAULT_NAME = (10, 13)
    DECK_CONFIG_DESCRIPTION_MARKDOWN = (10, 14)
    DECK_CONFIG_DESCRIPTION_MARKDOWN_HINT = (10, 15)
    DECK_CONFIG_DISABLE_AUTOPLAY = (10, 16)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (10, 17)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (10, 18)
    DECK_CONFIG_GOOD_ABOVE_EASY = (10, 19)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (10, 20)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (10, 21)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (10, 22)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (10, 23)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (10, 24)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (10, 25)
    DECK_CONFIG_LEARNING_STEPS = (10, 26)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (10, 27)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (10, 28)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (10, 29)
    DECK_CONFIG_LIMIT_DECK_V3 = (10, 30)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (10, 31)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (10, 32)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (10, 33)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (10, 34)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (10, 35)
    DECK_CONFIG_NAME_PROMPT = (10, 36)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (10, 37)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP = (10, 38)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (10, 39)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (10, 40)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION = (10, 41)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP = (10, 42)
    DECK_CONFIG_NEW_INSERTION_ORDER = (10, 43)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (10, 44)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (10, 45)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (10, 46)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (10, 47)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (10, 48)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (10, 49)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (10, 50)
    DECK_CONFIG_ORDERING_TITLE = (10, 51)
    DECK_CONFIG_RELEARNING_STEPS = (10, 52)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (10, 53)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (10, 54)
    DECK_CONFIG_REMOVE_GROUP = (10, 55)
    DECK_CONFIG_RENAME_GROUP = (10, 56)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (10, 57)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (10, 58)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (10, 59)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (10, 60)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (10, 61)
    DECK_CONFIG_REVIEW_SORT_ORDER = (10, 62)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (10, 63)
    DECK_CONFIG_REVIEWS_TOO_LOW = (10, 64)
    DECK_CONFIG_SAVE_BUTTON = (10, 65)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (10, 66)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (10, 67)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (10, 68)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_POSITION = (10, 69)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (10, 70)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (10, 71)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (10, 72)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (10, 73)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (10, 74)
    DECK_CONFIG_SORT_ORDER_POSITION = (10, 75)
    DECK_CONFIG_SORT_ORDER_RANDOM = (10, 76)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (10, 77)
    DECK_CONFIG_TIMER_TITLE = (10, 78)
    DECK_CONFIG_TITLE = (10, 79)
    DECK_CONFIG_USED_BY_DECKS = (10, 80)
    DECK_CONFIG_WHICH_DECK = (10, 81)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (10, 82)
    DECKS_ADD_NEW_DECK_CTRLANDN = (11, 0)
    DECKS_BUILD = (11, 1)
    DECKS_CARDS_SELECTED_BY = (11, 2)
    DECKS_CREATE_DECK = (11, 3)
    DECKS_CUSTOM_STEPS_IN_MINUTES = (11, 4)
    DECKS_DECK = (11, 5)
    DECKS_DECREASING_INTERVALS = (11, 6)
    DECKS_DELETE_DECK = (11, 7)
    DECKS_ENABLE_SECOND_FILTER = (11, 8)
    DECKS_FILTER = (11, 9)
    DECKS_FILTER_2 = (11, 10)
    DECKS_FILTERED_DECK_SEARCH_EMPTY = (11, 11)
    DECKS_GET_SHARED = (11, 12)
    DECKS_IMPORT_FILE = (11, 13)
    DECKS_INCREASING_INTERVALS = (11, 14)
    DECKS_LATEST_ADDED_FIRST = (11, 15)
    DECKS_LIMIT_TO = (11, 16)
    DECKS_MINUTES = (11, 17)
    DECKS_MOST_LAPSES = (11, 18)
    DECKS_NAME_FOR_DECK = (11, 19)
    DECKS_NEW_DECK_NAME = (11, 20)
    DECKS_NO_DECK = (11, 21)
    DECKS_OLDEST_SEEN_FIRST = (11, 22)
    DECKS_ORDER_ADDED = (11, 23)
    DECKS_ORDER_DUE = (11, 24)
    DECKS_PLEASE_SELECT_SOMETHING = (11, 25)
    DECKS_RANDOM = (11, 26)
    DECKS_RELATIVE_OVERDUENESS = (11, 27)
    DECKS_REPEAT_FAILED_CARDS_AFTER = (11, 28)
    DECKS_RESCHEDULE_CARDS_BASED_ON_MY_ANSWERS = (11, 29)
    DECKS_STUDY = (11, 30)
    DECKS_STUDY_DECK = (11, 31)
    DECKS_UNMOVABLE_CARDS = (11, 32)
    EDITING_ADD_MEDIA = (12, 0)
    EDITING_ALIGN_LEFT = (12, 1)
    EDITING_ALIGN_RIGHT = (12, 2)
    EDITING_AN_ERROR_OCCURRED_WHILE_OPENING = (12, 3)
    EDITING_ATTACH_PICTURESAUDIOVIDEO = (12, 4)
    EDITING_ATTACH_PICTURESAUDIOVIDEO_F3 = (12, 5)
    EDITING_BOLD_TEXT = (12, 6)
    EDITING_BOLD_TEXT_CTRLANDB = (12, 7)
    EDITING_CARDS = (12, 8)
    EDITING_CENTER = (12, 9)
    EDITING_CHANGE_COLOR = (12, 10)
    EDITING_CHANGE_COLOUR_F8 = (12, 11)
    EDITING_CLOZE_DELETION = (12, 12)
    EDITING_CLOZE_DELETION_CTRLANDSHIFTANDC = (12, 13)
    EDITING_COULDNT_RECORD_AUDIO_HAVE_YOU_INSTALLED = (12, 14)
    EDITING_CUSTOMIZE_CARD_TEMPLATES = (12, 15)
    EDITING_CUSTOMIZE_CARD_TEMPLATES_CTRLANDL = (12, 16)
    EDITING_CUSTOMIZE_FIELDS = (12, 17)
    EDITING_CUT = (12, 18)
    EDITING_EDIT_CURRENT = (12, 19)
    EDITING_EDIT_HTML = (12, 20)
    EDITING_FIELDS = (12, 21)
    EDITING_HTML_EDITOR = (12, 22)
    EDITING_INDENT = (12, 23)
    EDITING_ITALIC_TEXT = (12, 24)
    EDITING_ITALIC_TEXT_CTRLANDI = (12, 25)
    EDITING_JUMP_TO_TAGS_WITH_CTRLANDSHIFTANDT = (12, 26)
    EDITING_JUSTIFY = (12, 27)
    EDITING_LATEX = (12, 28)
    EDITING_LATEX_EQUATION = (12, 29)
    EDITING_LATEX_MATH_ENV = (12, 30)
    EDITING_MATHJAX_BLOCK = (12, 31)
    EDITING_MATHJAX_CHEMISTRY = (12, 32)
    EDITING_MATHJAX_INLINE = (12, 33)
    EDITING_MEDIA = (12, 34)
    EDITING_ORDERED_LIST = (12, 35)
    EDITING_OUTDENT = (12, 36)
    EDITING_PASTE = (12, 37)
    EDITING_RECORD_AUDIO = (12, 38)
    EDITING_RECORD_AUDIO_F5 = (12, 39)
    EDITING_REMOVE_FORMATTING = (12, 40)
    EDITING_REMOVE_FORMATTING_CTRLANDR = (12, 41)
    EDITING_SET_FOREGROUND_COLOR = (12, 42)
    EDITING_SET_FOREGROUND_COLOUR_F7 = (12, 43)
    EDITING_SHOW_DUPLICATES = (12, 44)
    EDITING_SUBSCRIPT = (12, 45)
    EDITING_SUBSCRIPT_CTRLAND = (12, 46)
    EDITING_SUPERSCRIPT = (12, 47)
    EDITING_SUPERSCRIPT_CTRLANDAND = (12, 48)
    EDITING_TAGS = (12, 49)
    EDITING_TO_MAKE_A_CLOZE_DELETION_ON = (12, 50)
    EDITING_UNDERLINE_TEXT = (12, 51)
    EDITING_UNDERLINE_TEXT_CTRLANDU = (12, 52)
    EDITING_UNORDERED_LIST = (12, 53)
    EDITING_WARNING_CLOZE_DELETIONS_WILL_NOT_WORK = (12, 54)
    EMPTY_CARDS_COUNT_LINE = (13, 0)
    EMPTY_CARDS_DELETE_BUTTON = (13, 1)
    EMPTY_CARDS_DELETE_EMPTY_CARDS = (13, 2)
    EMPTY_CARDS_DELETE_EMPTY_NOTES = (13, 3)
    EMPTY_CARDS_DELETED_COUNT = (13, 4)
    EMPTY_CARDS_DELETING = (13, 5)
    EMPTY_CARDS_FOR_NOTE_TYPE = (13, 6)
    EMPTY_CARDS_NOT_FOUND = (13, 7)
    EMPTY_CARDS_PRESERVE_NOTES_CHECKBOX = (13, 8)
    EMPTY_CARDS_WINDOW_TITLE = (13, 9)
    ERRORS_100_TAGS_MAX = (14, 0)
    ERRORS_ACCESSING_DB = (14, 1)
    ERRORS_ADDONS_ACTIVE_POPUP = (14, 2)
    ERRORS_FILTERED_DECK_REQUIRED = (14, 3)
    ERRORS_FILTERED_PARENT_DECK = (14, 4)
    ERRORS_INVALID_INPUT_DETAILS = (14, 5)
    ERRORS_INVALID_INPUT_EMPTY = (14, 6)
    ERRORS_PARSE_NUMBER_FAIL = (14, 7)
    ERRORS_STANDARD_POPUP = (14, 8)
    ERRORS_UNABLE_OPEN_COLLECTION = (14, 9)
    ERRORS_WINDOWS_TTS_RUNTIME_ERROR = (14, 10)
    EXPORTING_ALL_DECKS = (15, 0)
    EXPORTING_ANKI_20_DECK = (15, 1)
    EXPORTING_ANKI_COLLECTION_PACKAGE = (15, 2)
    EXPORTING_ANKI_DECK_PACKAGE = (15, 3)
    EXPORTING_CARD_EXPORTED = (15, 4)
    EXPORTING_CARDS_IN_PLAIN_TEXT = (15, 5)
    EXPORTING_COLLECTION = (15, 6)
    EXPORTING_COLLECTION_EXPORTED = (15, 7)
    EXPORTING_COULDNT_SAVE_FILE = (15, 8)
    EXPORTING_EXPORT = (15, 9)
    EXPORTING_EXPORT_FORMAT = (15, 10)
    EXPORTING_EXPORTED_MEDIA_FILE = (15, 11)
    EXPORTING_INCLUDE = (15, 12)
    EXPORTING_INCLUDE_HTML_AND_MEDIA_REFERENCES = (15, 13)
    EXPORTING_INCLUDE_MEDIA = (15, 14)
    EXPORTING_INCLUDE_SCHEDULING_INFORMATION = (15, 15)
    EXPORTING_INCLUDE_TAGS = (15, 16)
    EXPORTING_NOTE_EXPORTED = (15, 17)
    EXPORTING_NOTES_IN_PLAIN_TEXT = (15, 18)
    EXPORTING_SELECTED_NOTES = (15, 19)
    FIELDS_ADD_FIELD = (16, 0)
    FIELDS_DELETE_FIELD_FROM = (16, 1)
    FIELDS_EDITING_FONT = (16, 2)
    FIELDS_FIELD = (16, 3)
    FIELDS_FIELD_NAME = (16, 4)
    FIELDS_FIELDS_FOR = (16, 5)
    FIELDS_FONT = (16, 6)
    FIELDS_NAME_FIRST_LETTER_NOT_VALID = (16, 7)
    FIELDS_NAME_INVALID_LETTER = (16, 8)
    FIELDS_NEW_POSITION_1 = (16, 9)
    FIELDS_NOTES_REQUIRE_AT_LEAST_ONE_FIELD = (16, 10)
    FIELDS_REMEMBER_LAST_INPUT_WHEN_ADDING = (16, 11)
    FIELDS_REVERSE_TEXT_DIRECTION_RTL = (16, 12)
    FIELDS_SIZE = (16, 13)
    FIELDS_SORT_BY_THIS_FIELD_IN_THE = (16, 14)
    FIELDS_THAT_FIELD_NAME_IS_ALREADY_USED = (16, 15)
    FINDREPLACE_NOTES_UPDATED = (17, 0)
    IMPORTING_ABORTED = (18, 0)
    IMPORTING_ADDED_DUPLICATE_WITH_FIRST_FIELD = (18, 1)
    IMPORTING_ALLOW_HTML_IN_FIELDS = (18, 2)
    IMPORTING_ANKI_FILES_ARE_FROM_A_VERY = (18, 3)
    IMPORTING_ANKI2_FILES_ARE_NOT_DIRECTLY_IMPORTABLE = (18, 4)
    IMPORTING_APPEARED_TWICE_IN_FILE = (18, 5)
    IMPORTING_BY_DEFAULT_ANKI_WILL_DETECT_THE = (18, 6)
    IMPORTING_CHANGE = (18, 7)
    IMPORTING_COLON = (18, 8)
    IMPORTING_COMMA = (18, 9)
    IMPORTING_EMPTY_FIRST_FIELD = (18, 10)
    IMPORTING_FAILED_DEBUG_INFO = (18, 11)
    IMPORTING_FIELD_MAPPING = (18, 12)
    IMPORTING_FIELD_OF_FILE_IS = (18, 13)
    IMPORTING_FIELDS_SEPARATED_BY = (18, 14)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (18, 15)
    IMPORTING_FIRST_FIELD_MATCHED = (18, 16)
    IMPORTING_IDENTICAL = (18, 17)
    IMPORTING_IGNORE_FIELD = (18, 18)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (18, 19)
    IMPORTING_IGNORED = (18, 20)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (18, 21)
    IMPORTING_IMPORT_OPTIONS = (18, 22)
    IMPORTING_IMPORTING_COMPLETE = (18, 23)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (18, 24)
    IMPORTING_MAP_TO = (18, 25)
    IMPORTING_MAP_TO_TAGS = (18, 26)
    IMPORTING_MAPPED_TO = (18, 27)
    IMPORTING_MAPPED_TO_TAGS = (18, 28)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (18, 29)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (18, 30)
    IMPORTING_NOTE_ADDED = (18, 31)
    IMPORTING_NOTE_IMPORTED = (18, 32)
    IMPORTING_NOTE_UNCHANGED = (18, 33)
    IMPORTING_NOTE_UPDATED = (18, 34)
    IMPORTING_NOTES_ADDED_FROM_FILE = (18, 35)
    IMPORTING_NOTES_FOUND_IN_FILE = (18, 36)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (18, 37)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (18, 38)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (18, 39)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (18, 40)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (18, 41)
    IMPORTING_PROCESSED_MEDIA_FILE = (18, 42)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (18, 43)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (18, 44)
    IMPORTING_SEMICOLON = (18, 45)
    IMPORTING_SKIPPED = (18, 46)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (18, 47)
    IMPORTING_TAB = (18, 48)
    IMPORTING_TAG_MODIFIED_NOTES = (18, 49)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (18, 50)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (18, 51)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (18, 52)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (18, 53)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (18, 54)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (18, 55)
    IMPORTING_UNKNOWN_FILE_FORMAT = (18, 56)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (18, 57)
    IMPORTING_UPDATED = (18, 58)
    KEYBOARD_CTRL = (19, 0)
    KEYBOARD_SHIFT = (19, 1)
    MEDIA_ERROR_EXECUTING = (20, 0)
    MEDIA_ERROR_RUNNING = (20, 1)
    MEDIA_FOR_SECURITY_REASONS_IS_NOT = (20, 2)
    MEDIA_GENERATED_FILE = (20, 3)
    MEDIA_HAVE_YOU_INSTALLED_LATEX_AND_DVIPNGDVISVGM = (20, 4)
    MEDIA_RECORDINGTIME = (20, 5)
    MEDIA_SOUND_AND_VIDEO_ON_CARDS_WILL = (20, 6)
    MEDIA_CHECK_ALL_LATEX_RENDERED = (21, 0)
    MEDIA_CHECK_CHECK_MEDIA_ACTION = (21, 1)
    MEDIA_CHECK_CHECKED = (21, 2)
    MEDIA_CHECK_DELETE_UNUSED = (21, 3)
    MEDIA_CHECK_DELETE_UNUSED_COMPLETE = (21, 4)
    MEDIA_CHECK_DELETE_UNUSED_CONFIRM = (21, 5)
    MEDIA_CHECK_EMPTY_TRASH = (21, 6)
    MEDIA_CHECK_FILES_REMAINING = (21, 7)
    MEDIA_CHECK_MISSING_COUNT = (21, 8)
    MEDIA_CHECK_MISSING_FILE = (21, 9)
    MEDIA_CHECK_MISSING_HEADER = (21, 10)
    MEDIA_CHECK_OVERSIZE_COUNT = (21, 11)
    MEDIA_CHECK_OVERSIZE_FILE = (21, 12)
    MEDIA_CHECK_OVERSIZE_HEADER = (21, 13)
    MEDIA_CHECK_RENAMED_COUNT = (21, 14)
    MEDIA_CHECK_RENAMED_FILE = (21, 15)
    MEDIA_CHECK_RENAMED_HEADER = (21, 16)
    MEDIA_CHECK_RENDER_LATEX = (21, 17)
    MEDIA_CHECK_RESTORE_TRASH = (21, 18)
    MEDIA_CHECK_SUBFOLDER_COUNT = (21, 19)
    MEDIA_CHECK_SUBFOLDER_FILE = (21, 20)
    MEDIA_CHECK_SUBFOLDER_HEADER = (21, 21)
    MEDIA_CHECK_TRASH_COUNT = (21, 22)
    MEDIA_CHECK_TRASH_EMPTIED = (21, 23)
    MEDIA_CHECK_TRASH_RESTORED = (21, 24)
    MEDIA_CHECK_UNUSED_COUNT = (21, 25)
    MEDIA_CHECK_UNUSED_FILE = (21, 26)
    MEDIA_CHECK_UNUSED_HEADER = (21, 27)
    MEDIA_CHECK_WINDOW_TITLE = (21, 28)
    NETWORK_DETAILS = (22, 0)
    NETWORK_OFFLINE = (22, 1)
    NETWORK_OTHER = (22, 2)
    NETWORK_PROXY_AUTH = (22, 3)
    NETWORK_TIMEOUT = (22, 4)
    NOTETYPES_ADD = (23, 0)
    NOTETYPES_ADD_NOTE_TYPE = (23, 1)
    NOTETYPES_ADD_REVERSE_FIELD = (23, 2)
    NOTETYPES_BACK_EXTRA_FIELD = (23, 3)
    NOTETYPES_BACK_FIELD = (23, 4)
    NOTETYPES_BASIC_NAME = (23, 5)
    NOTETYPES_BASIC_OPTIONAL_REVERSED_NAME = (23, 6)
    NOTETYPES_BASIC_REVERSED_NAME = (23, 7)
    NOTETYPES_BASIC_TYPE_ANSWER_NAME = (23, 8)
    NOTETYPES_CARD_1_NAME = (23, 9)
    NOTETYPES_CARD_2_NAME = (23, 10)
    NOTETYPES_CARDS = (23, 11)
    NOTETYPES_CLONE = (23, 12)
    NOTETYPES_CLOZE_NAME = (23, 13)
    NOTETYPES_COPY = (23, 14)
    NOTETYPES_CREATE_SCALABLE_IMAGES_WITH_DVISVGM = (23, 15)
    NOTETYPES_DELETE_THIS_NOTE_TYPE_AND_ALL = (23, 16)
    NOTETYPES_DELETE_THIS_UNUSED_NOTE_TYPE = (23, 17)
    NOTETYPES_FIELDS = (23, 18)
    NOTETYPES_FOOTER = (23, 19)
    NOTETYPES_FRONT_FIELD = (23, 20)
    NOTETYPES_HEADER = (23, 21)
    NOTETYPES_NOTE_TYPES = (23, 22)
    NOTETYPES_OPTIONS = (23, 23)
    NOTETYPES_PLEASE_ADD_ANOTHER_NOTE_TYPE_FIRST = (23, 24)
    NOTETYPES_TEXT_FIELD = (23, 25)
    NOTETYPES_TYPE = (23, 26)
    PREFERENCES_AUTOMATICALLY_SYNC_ON_PROFILE_OPENCLOSE = (24, 0)
    PREFERENCES_BACKUPS = (24, 1)
    PREFERENCES_BACKUPS2 = (24, 2)
    PREFERENCES_BACKUPSANKI_WILL_CREATE_A_BACKUP_OF = (24, 3)
    PREFERENCES_BASIC = (24, 4)
    PREFERENCES_CHANGE_DECK_DEPENDING_ON_NOTE_TYPE = (24, 5)
    PREFERENCES_CHANGES_WILL_TAKE_EFFECT_WHEN_YOU = (24, 6)
    PREFERENCES_HOURS_PAST_MIDNIGHT = (24, 7)
    PREFERENCES_INTERFACE_LANGUAGE = (24, 8)
    PREFERENCES_INTERRUPT_CURRENT_AUDIO_WHEN_ANSWERING = (24, 9)
    PREFERENCES_KEEP = (24, 10)
    PREFERENCES_LEARN_AHEAD_LIMIT = (24, 11)
    PREFERENCES_LEGACY_TIMEZONE_HANDLING = (24, 12)
    PREFERENCES_MINS = (24, 13)
    PREFERENCES_NETWORK = (24, 14)
    PREFERENCES_NEXT_DAY_STARTS_AT = (24, 15)
    PREFERENCES_NIGHT_MODE = (24, 16)
    PREFERENCES_NOTE_MEDIA_IS_NOT_BACKED_UP = (24, 17)
    PREFERENCES_ON_NEXT_SYNC_FORCE_CHANGES_IN = (24, 18)
    PREFERENCES_PASTE_CLIPBOARD_IMAGES_AS_PNG = (24, 19)
    PREFERENCES_PASTE_WITHOUT_SHIFT_KEY_STRIPS_FORMATTING = (24, 20)
    PREFERENCES_PERIODICALLY_SYNC_MEDIA = (24, 21)
    PREFERENCES_PLEASE_RESTART_ANKI_TO_COMPLETE_LANGUAGE = (24, 22)
    PREFERENCES_PREFERENCES = (24, 23)
    PREFERENCES_SCHEDULING = (24, 24)
    PREFERENCES_SHOW_LEARNING_CARDS_WITH_LARGER_STEPS = (24, 25)
    PREFERENCES_SHOW_NEXT_REVIEW_TIME_ABOVE_ANSWER = (24, 26)
    PREFERENCES_SHOW_PLAY_BUTTONS_ON_CARDS_WITH = (24, 27)
    PREFERENCES_SHOW_REMAINING_CARD_COUNT_DURING_REVIEW = (24, 28)
    PREFERENCES_SOME_SETTINGS_WILL_TAKE_EFFECT_AFTER = (24, 29)
    PREFERENCES_SYNCHRONISATION = (24, 30)
    PREFERENCES_SYNCHRONIZATIONNOT_CURRENTLY_ENABLED_CLICK_THE_SYNC = (24, 31)
    PREFERENCES_SYNCHRONIZE_AUDIO_AND_IMAGES_TOO = (24, 32)
    PREFERENCES_THIS_WILL_RESET_ANY_CARDS_IN = (24, 33)
    PREFERENCES_TIMEBOX_TIME_LIMIT = (24, 34)
    PREFERENCES_USER_INTERFACE_SIZE = (24, 35)
    PREFERENCES_VIDEO_DRIVER = (24, 36)
    PREFERENCES_VIDEO_DRIVER_ANGLE = (24, 37)
    PREFERENCES_VIDEO_DRIVER_OPENGL_MAC = (24, 38)
    PREFERENCES_VIDEO_DRIVER_OPENGL_OTHER = (24, 39)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_MAC = (24, 40)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_OTHER = (24, 41)
    PREFERENCES_WHEN_ADDING_DEFAULT_TO_CURRENT_DECK = (24, 42)
    PREFERENCES_YOU_CAN_RESTORE_BACKUPS_VIA_FILESWITCH = (24, 43)
    PROFILES_ANKI_COULD_NOT_READ_YOUR_PROFILE = (25, 0)
    PROFILES_ANKI_COULD_NOT_RENAME_YOUR_PROFILE = (25, 1)
    PROFILES_CONFIRM_LANG_CHOICE = (25, 2)
    PROFILES_COULD_NOT_CREATE_DATA_FOLDER = (25, 3)
    PROFILES_DOWNGRADE_AND_QUIT = (25, 4)
    PROFILES_FOLDER_ALREADY_EXISTS = (25, 5)
    PROFILES_FOLDER_README = (25, 6)
    PROFILES_OPEN = (25, 7)
    PROFILES_OPEN_BACKUP = (25, 8)
    PROFILES_PLEASE_REMOVE_THE_FOLDER_AND = (25, 9)
    PROFILES_PREFS_CORRUPT_TITLE = (25, 10)
    PROFILES_PREFS_FILE_IS_CORRUPT = (25, 11)
    PROFILES_PROFILE_CORRUPT = (25, 12)
    PROFILES_PROFILE_DOES_NOT_EXIST = (25, 13)
    PROFILES_PROFILES = (25, 14)
    PROFILES_QUIT = (25, 15)
    PROFILES_USER_1 = (25, 16)
    QT_ACCEL_ABOUT = (26, 0)
    QT_ACCEL_BROWSE_AND_INSTALL = (26, 1)
    QT_ACCEL_CARDS = (26, 2)
    QT_ACCEL_CHECK_DATABASE = (26, 3)
    QT_ACCEL_CHECK_MEDIA = (26, 4)
    QT_ACCEL_EDIT = (26, 5)
    QT_ACCEL_EXIT = (26, 6)
    QT_ACCEL_EXPORT = (26, 7)
    QT_ACCEL_EXPORT_NOTES = (26, 8)
    QT_ACCEL_FILE = (26, 9)
    QT_ACCEL_FILTER = (26, 10)
    QT_ACCEL_FIND = (26, 11)
    QT_ACCEL_FIND_AND_REPLACE = (26, 12)
    QT_ACCEL_FIND_DUPLICATES = (26, 13)
    QT_ACCEL_FORGET = (26, 14)
    QT_ACCEL_GO = (26, 15)
    QT_ACCEL_GUIDE = (26, 16)
    QT_ACCEL_HELP = (26, 17)
    QT_ACCEL_IMPORT = (26, 18)
    QT_ACCEL_INFO = (26, 19)
    QT_ACCEL_INVERT_SELECTION = (26, 20)
    QT_ACCEL_NEXT_CARD = (26, 21)
    QT_ACCEL_NOTE = (26, 22)
    QT_ACCEL_NOTES = (26, 23)
    QT_ACCEL_OPEN_ADDONS_FOLDER = (26, 24)
    QT_ACCEL_PREFERENCES = (26, 25)
    QT_ACCEL_PREVIOUS_CARD = (26, 26)
    QT_ACCEL_REDO = (26, 27)
    QT_ACCEL_SELECT_ALL = (26, 28)
    QT_ACCEL_SELECT_NOTES = (26, 29)
    QT_ACCEL_SET_DUE_DATE = (26, 30)
    QT_ACCEL_SUPPORT_ANKI = (26, 31)
    QT_ACCEL_SWITCH_PROFILE = (26, 32)
    QT_ACCEL_TOOLS = (26, 33)
    QT_ACCEL_UNDO = (26, 34)
    QT_MISC_ADDON_WILL_BE_INSTALLED_WHEN_A = (27, 0)
    QT_MISC_ADDONS = (27, 1)
    QT_MISC_ALL_CARDS_NOTES_AND_MEDIA_FOR = (27, 2)
    QT_MISC_ANKI_IS_RUNNING = (27, 3)
    QT_MISC_ANKI_UPDATEDANKI_HAS_BEEN_RELEASED = (27, 4)
    QT_MISC_AUTOMATIC_SYNCING_AND_BACKUPS_HAVE_BEEN = (27, 5)
    QT_MISC_BACK_SIDE_ONLY = (27, 6)
    QT_MISC_BACKING_UP = (27, 7)
    QT_MISC_BROWSE = (27, 8)
    QT_MISC_CHANGE_NOTE_TYPE_CTRLANDN = (27, 9)
    QT_MISC_CHECK_THE_FILES_IN_THE_MEDIA = (27, 10)
    QT_MISC_CHOOSE_DECK = (27, 11)
    QT_MISC_CHOOSE_NOTE_TYPE = (27, 12)
    QT_MISC_CLOSING = (27, 13)
    QT_MISC_CONFIGURE_INTERFACE_LANGUAGE_AND_OPTIONS = (27, 14)
    QT_MISC_COPY_TO_CLIPBOARD = (27, 15)
    QT_MISC_CREATE_FILTERED_DECK = (27, 16)
    QT_MISC_DEBUG_CONSOLE = (27, 17)
    QT_MISC_DECK_WILL_BE_IMPORTED_WHEN_A = (27, 18)
    QT_MISC_DEFAULT = (27, 19)
    QT_MISC_EMPTY_CARDS = (27, 20)
    QT_MISC_ERROR = (27, 21)
    QT_MISC_ERROR_DURING_STARTUP = (27, 22)
    QT_MISC_ERROR_LOADING_GRAPHICS_DRIVER = (27, 23)
    QT_MISC_FILTERED_DECK = (27, 24)
    QT_MISC_IF_INSTANCE_IS_NOT_RESPONDING = (27, 25)
    QT_MISC_IGNORE_THIS_UPDATE = (27, 26)
    QT_MISC_IN_ORDER_TO_ENSURE_YOUR_COLLECTION = (27, 27)
    QT_MISC_INCOMPATIBLE_VIDEO_DRIVER = (27, 28)
    QT_MISC_INVALID_PROPERTY_FOUND_ON_CARD_PLEASE = (27, 29)
    QT_MISC_LOADING = (27, 30)
    QT_MISC_MANAGE = (27, 31)
    QT_MISC_MANAGE_NOTE_TYPES = (27, 32)
    QT_MISC_NAME_EXISTS = (27, 33)
    QT_MISC_NO_TEMP_FOLDER = (27, 34)
    QT_MISC_NON_UNICODE_TEXT = (27, 35)
    QT_MISC_OPTIMIZING = (27, 36)
    QT_MISC_PLEASE_ENSURE_A_PROFILE_IS_OPEN = (27, 37)
    QT_MISC_PLEASE_SELECT_1_CARD = (27, 38)
    QT_MISC_PLEASE_SELECT_A_DECK = (27, 39)
    QT_MISC_PLEASE_USE_FILEIMPORT_TO_IMPORT_THIS = (27, 40)
    QT_MISC_PROCESSING = (27, 41)
    QT_MISC_REPLACE_YOUR_COLLECTION_WITH_AN_EARLIER = (27, 42)
    QT_MISC_RESUME_NOW = (27, 43)
    QT_MISC_REVERT_TO_BACKUP = (27, 44)
    QT_MISC_REVERTED_TO_STATE_PRIOR_TO = (27, 45)
    QT_MISC_SECOND = (27, 46)
    QT_MISC_SEGOE_UI = (27, 47)
    QT_MISC_SHIFT_KEY_WAS_HELD_DOWN_SKIPPING = (27, 48)
    QT_MISC_SHORTCUT_KEY_LEFT_ARROW = (27, 49)
    QT_MISC_SHORTCUT_KEY_RIGHT_ARROW_OR_ENTER = (27, 50)
    QT_MISC_STATS = (27, 51)
    QT_MISC_STUDY_DECK = (27, 52)
    QT_MISC_SYNC = (27, 53)
    QT_MISC_TARGET_DECK_CTRLANDD = (27, 54)
    QT_MISC_THE_FOLLOWING_CHARACTER_CAN_NOT_BE = (27, 55)
    QT_MISC_THE_REQUESTED_CHANGE_WILL_REQUIRE_A = (27, 56)
    QT_MISC_THERE_MUST_BE_AT_LEAST_ONE = (27, 57)
    QT_MISC_THIS_FILE_EXISTS_ARE_YOU_SURE = (27, 58)
    QT_MISC_UNABLE_TO_ACCESS_ANKI_MEDIA_FOLDER = (27, 59)
    QT_MISC_UNABLE_TO_MOVE_EXISTING_FILE_TO = (27, 60)
    QT_MISC_UNABLE_TO_RECORD = (27, 61)
    QT_MISC_UNDO = (27, 62)
    QT_MISC_UNDO2 = (27, 63)
    QT_MISC_UNEXPECTED_RESPONSE_CODE = (27, 64)
    QT_MISC_WAITING_FOR_EDITING_TO_FINISH = (27, 65)
    QT_MISC_WOULD_YOU_LIKE_TO_DOWNLOAD_IT = (27, 66)
    QT_MISC_YOUR_COLLECTION_FILE_APPEARS_TO_BE = (27, 67)
    QT_MISC_YOUR_COMPUTERS_STORAGE_MAY_BE_FULL = (27, 68)
    QT_MISC_YOUR_FIREWALL_OR_ANTIVIRUS_PROGRAM_IS = (27, 69)
    SCHEDULING_ALWAYS_INCLUDE_QUESTION_SIDE_WHEN_REPLAYING = (28, 0)
    SCHEDULING_ANSWER_BUTTON_TIME_DAYS = (28, 1)
    SCHEDULING_ANSWER_BUTTON_TIME_HOURS = (28, 2)
    SCHEDULING_ANSWER_BUTTON_TIME_MINUTES = (28, 3)
    SCHEDULING_ANSWER_BUTTON_TIME_MONTHS = (28, 4)
    SCHEDULING_ANSWER_BUTTON_TIME_SECONDS = (28, 5)
    SCHEDULING_ANSWER_BUTTON_TIME_YEARS = (28, 6)
    SCHEDULING_AT_LEAST_ONE_STEP_IS_REQUIRED = (28, 7)
    SCHEDULING_AUTOMATICALLY_PLAY_AUDIO = (28, 8)
    SCHEDULING_BURIED_CARDS_FOUND = (28, 9)
    SCHEDULING_BURY_RELATED_NEW_CARDS_UNTIL_THE = (28, 10)
    SCHEDULING_BURY_RELATED_REVIEWS_UNTIL_THE_NEXT = (28, 11)
    SCHEDULING_CONGRATULATIONS_FINISHED = (28, 12)
    SCHEDULING_CUSTOM_STUDY = (28, 13)
    SCHEDULING_DAYS = (28, 14)
    SCHEDULING_DECK_UPDATED = (28, 15)
    SCHEDULING_DESCRIPTION = (28, 16)
    SCHEDULING_DESCRIPTION_TO_SHOW_ON_OVERVIEW_SCREEN = (28, 17)
    SCHEDULING_EASY_BONUS = (28, 18)
    SCHEDULING_EASY_INTERVAL = (28, 19)
    SCHEDULING_END = (28, 20)
    SCHEDULING_FORGOT_CARDS = (28, 21)
    SCHEDULING_GENERAL = (28, 22)
    SCHEDULING_GRADUATING_INTERVAL = (28, 23)
    SCHEDULING_HARD_INTERVAL = (28, 24)
    SCHEDULING_HOW_TO_CUSTOM_STUDY = (28, 25)
    SCHEDULING_IGNORE_ANSWER_TIMES_LONGER_THAN = (28, 26)
    SCHEDULING_INTERVAL_MODIFIER = (28, 27)
    SCHEDULING_LAPSES = (28, 28)
    SCHEDULING_LAPSES2 = (28, 29)
    SCHEDULING_LEARN_REMAINING = (28, 30)
    SCHEDULING_LEARNING = (28, 31)
    SCHEDULING_LEECH_ACTION = (28, 32)
    SCHEDULING_LEECH_THRESHOLD = (28, 33)
    SCHEDULING_MAXIMUM_INTERVAL = (28, 34)
    SCHEDULING_MAXIMUM_REVIEWSDAY = (28, 35)
    SCHEDULING_MINIMUM_INTERVAL = (28, 36)
    SCHEDULING_MIX_NEW_CARDS_AND_REVIEWS = (28, 37)
    SCHEDULING_NEW_CARDS = (28, 38)
    SCHEDULING_NEW_CARDSDAY = (28, 39)
    SCHEDULING_NEW_INTERVAL = (28, 40)
    SCHEDULING_NEW_OPTIONS_GROUP_NAME = (28, 41)
    SCHEDULING_NEXT_LEARN_DUE = (28, 42)
    SCHEDULING_OPTIONS_GROUP = (28, 43)
    SCHEDULING_ORDER = (28, 44)
    SCHEDULING_PARENT_LIMIT = (28, 45)
    SCHEDULING_REVIEW = (28, 46)
    SCHEDULING_REVIEWS = (28, 47)
    SCHEDULING_SECONDS = (28, 48)
    SCHEDULING_SET_ALL_DECKS_BELOW_TO = (28, 49)
    SCHEDULING_SET_DUE_DATE_DONE = (28, 50)
    SCHEDULING_SET_DUE_DATE_PROMPT = (28, 51)
    SCHEDULING_SET_DUE_DATE_PROMPT_HINT = (28, 52)
    SCHEDULING_SET_FOR_ALL_SUBDECKS = (28, 53)
    SCHEDULING_SHOW_ANSWER_TIMER = (28, 54)
    SCHEDULING_SHOW_NEW_CARDS_AFTER_REVIEWS = (28, 55)
    SCHEDULING_SHOW_NEW_CARDS_BEFORE_REVIEWS = (28, 56)
    SCHEDULING_SHOW_NEW_CARDS_IN_ORDER_ADDED = (28, 57)
    SCHEDULING_SHOW_NEW_CARDS_IN_RANDOM_ORDER = (28, 58)
    SCHEDULING_STARTING_EASE = (28, 59)
    SCHEDULING_STEPS_IN_MINUTES = (28, 60)
    SCHEDULING_STEPS_MUST_BE_NUMBERS = (28, 61)
    SCHEDULING_TAG_ONLY = (28, 62)
    SCHEDULING_THE_DEFAULT_CONFIGURATION_CANT_BE_REMOVED = (28, 63)
    SCHEDULING_TIME_SPAN_DAYS = (28, 64)
    SCHEDULING_TIME_SPAN_HOURS = (28, 65)
    SCHEDULING_TIME_SPAN_MINUTES = (28, 66)
    SCHEDULING_TIME_SPAN_MONTHS = (28, 67)
    SCHEDULING_TIME_SPAN_SECONDS = (28, 68)
    SCHEDULING_TIME_SPAN_YEARS = (28, 69)
    SCHEDULING_TODAY_NEW_LIMIT_REACHED = (28, 70)
    SCHEDULING_TODAY_REVIEW_LIMIT_REACHED = (28, 71)
    SCHEDULING_UNBURY_THEM = (28, 72)
    SCHEDULING_UPDATE_BUTTON = (28, 73)
    SCHEDULING_UPDATE_DONE = (28, 74)
    SCHEDULING_UPDATE_LATER_BUTTON = (28, 75)
    SCHEDULING_UPDATE_MORE_INFO_BUTTON = (28, 76)
    SCHEDULING_UPDATE_SOON = (28, 77)
    SCHEDULING_YOUR_CHANGES_WILL_AFFECT_MULTIPLE_DECKS = (28, 78)
    SEARCH_CARD_MODIFIED = (29, 0)
    SEARCH_EMPTY_GROUP = (29, 1)
    SEARCH_EMPTY_QUOTE = (29, 2)
    SEARCH_INVALID_ANSWER_BUTTON = (29, 3)
    SEARCH_INVALID_ARGUMENT = (29, 4)
    SEARCH_INVALID_FLAG = (29, 5)
    SEARCH_INVALID_NEGATIVE_WHOLE_NUMBER = (29, 6)
    SEARCH_INVALID_NUMBER = (29, 7)
    SEARCH_INVALID_OTHER = (29, 8)
    SEARCH_INVALID_POSITIVE_WHOLE_NUMBER = (29, 9)
    SEARCH_INVALID_PROP_OPERATOR = (29, 10)
    SEARCH_INVALID_SEARCH = (29, 11)
    SEARCH_INVALID_WHOLE_NUMBER = (29, 12)
    SEARCH_MISPLACED_AND = (29, 13)
    SEARCH_MISPLACED_OR = (29, 14)
    SEARCH_MISSING_KEY = (29, 15)
    SEARCH_NOTE_MODIFIED = (29, 16)
    SEARCH_UNCLOSED_GROUP = (29, 17)
    SEARCH_UNCLOSED_QUOTE = (29, 18)
    SEARCH_UNKNOWN_ESCAPE = (29, 19)
    SEARCH_UNOPENED_GROUP = (29, 20)
    SEARCH_VIEW_IN_BROWSER = (29, 21)
    STATISTICS_ADDED_SUBTITLE = (30, 0)
    STATISTICS_ADDED_TITLE = (30, 1)
    STATISTICS_AMOUNT_OF_TOTAL_WITH_PERCENTAGE = (30, 2)
    STATISTICS_ANSWER_BUTTONS_BUTTON_NUMBER = (30, 3)
    STATISTICS_ANSWER_BUTTONS_BUTTON_PRESSED = (30, 4)
    STATISTICS_ANSWER_BUTTONS_SUBTITLE = (30, 5)
    STATISTICS_ANSWER_BUTTONS_TITLE = (30, 6)
    STATISTICS_AVERAGE = (30, 7)
    STATISTICS_AVERAGE_ANSWER_TIME = (30, 8)
    STATISTICS_AVERAGE_ANSWER_TIME_LABEL = (30, 9)
    STATISTICS_AVERAGE_EASE = (30, 10)
    STATISTICS_AVERAGE_FOR_DAYS_STUDIED = (30, 11)
    STATISTICS_AVERAGE_INTERVAL = (30, 12)
    STATISTICS_AVERAGE_OVER_PERIOD = (30, 13)
    STATISTICS_BACKLOG_CHECKBOX = (30, 14)
    STATISTICS_CALENDAR_TITLE = (30, 15)
    STATISTICS_CARD_EASE_SUBTITLE = (30, 16)
    STATISTICS_CARD_EASE_TITLE = (30, 17)
    STATISTICS_CARD_EASE_TOOLTIP = (30, 18)
    STATISTICS_CARDS = (30, 19)
    STATISTICS_CARDS_DUE = (30, 20)
    STATISTICS_CARDS_PER_DAY = (30, 21)
    STATISTICS_CARDS_PER_MIN = (30, 22)
    STATISTICS_COUNTS_BURIED_CARDS = (30, 23)
    STATISTICS_COUNTS_EARLY_CARDS = (30, 24)
    STATISTICS_COUNTS_LEARNING_CARDS = (30, 25)
    STATISTICS_COUNTS_MATURE_CARDS = (30, 26)
    STATISTICS_COUNTS_NEW_CARDS = (30, 27)
    STATISTICS_COUNTS_RELEARNING_CARDS = (30, 28)
    STATISTICS_COUNTS_SEPARATE_SUSPENDED_BURIED_CARDS = (30, 29)
    STATISTICS_COUNTS_SUSPENDED_CARDS = (30, 30)
    STATISTICS_COUNTS_TITLE = (30, 31)
    STATISTICS_COUNTS_TOTAL_CARDS = (30, 32)
    STATISTICS_COUNTS_YOUNG_CARDS = (30, 33)
    STATISTICS_DAYS_AGO_RANGE = (30, 34)
    STATISTICS_DAYS_AGO_SINGLE = (30, 35)
    STATISTICS_DAYS_STUDIED = (30, 36)
    STATISTICS_DUE_COUNT = (30, 37)
    STATISTICS_DUE_DATE = (30, 38)
    STATISTICS_DUE_FOR_NEW_CARD = (30, 39)
    STATISTICS_DUE_TOMORROW = (30, 40)
    STATISTICS_ELAPSED_TIME_DAYS = (30, 41)
    STATISTICS_ELAPSED_TIME_HOURS = (30, 42)
    STATISTICS_ELAPSED_TIME_MINUTES = (30, 43)
    STATISTICS_ELAPSED_TIME_MONTHS = (30, 44)
    STATISTICS_ELAPSED_TIME_SECONDS = (30, 45)
    STATISTICS_ELAPSED_TIME_YEARS = (30, 46)
    STATISTICS_FUTURE_DUE_SUBTITLE = (30, 47)
    STATISTICS_FUTURE_DUE_TITLE = (30, 48)
    STATISTICS_HOURS_CORRECT = (30, 49)
    STATISTICS_HOURS_RANGE = (30, 50)
    STATISTICS_HOURS_SUBTITLE = (30, 51)
    STATISTICS_HOURS_TITLE = (30, 52)
    STATISTICS_IN_DAYS_RANGE = (30, 53)
    STATISTICS_IN_DAYS_SINGLE = (30, 54)
    STATISTICS_IN_TIME_SPAN_DAYS = (30, 55)
    STATISTICS_IN_TIME_SPAN_HOURS = (30, 56)
    STATISTICS_IN_TIME_SPAN_MINUTES = (30, 57)
    STATISTICS_IN_TIME_SPAN_MONTHS = (30, 58)
    STATISTICS_IN_TIME_SPAN_SECONDS = (30, 59)
    STATISTICS_IN_TIME_SPAN_YEARS = (30, 60)
    STATISTICS_INTERVALS_DAY_RANGE = (30, 61)
    STATISTICS_INTERVALS_DAY_SINGLE = (30, 62)
    STATISTICS_INTERVALS_SUBTITLE = (30, 63)
    STATISTICS_INTERVALS_TITLE = (30, 64)
    STATISTICS_LONGEST_INTERVAL = (30, 65)
    STATISTICS_MINUTES_PER_DAY = (30, 66)
    STATISTICS_NO_DATA = (30, 67)
    STATISTICS_RANGE_1_YEAR_HISTORY = (30, 68)
    STATISTICS_RANGE_ALL_HISTORY = (30, 69)
    STATISTICS_RANGE_ALL_TIME = (30, 70)
    STATISTICS_RANGE_COLLECTION = (30, 71)
    STATISTICS_RANGE_DECK = (30, 72)
    STATISTICS_RANGE_SEARCH = (30, 73)
    STATISTICS_REVIEWS = (30, 74)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (30, 75)
    STATISTICS_REVIEWS_PER_DAY = (30, 76)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (30, 77)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (30, 78)
    STATISTICS_REVIEWS_TITLE = (30, 79)
    STATISTICS_RUNNING_TOTAL = (30, 80)
    STATISTICS_SAVE_PDF = (30, 81)
    STATISTICS_SAVED = (30, 82)
    STATISTICS_SECONDS_TAKEN = (30, 83)
    STATISTICS_STATS = (30, 84)
    STATISTICS_STUDIED_TODAY = (30, 85)
    STATISTICS_TODAY_AGAIN_COUNT = (30, 86)
    STATISTICS_TODAY_CORRECT_MATURE = (30, 87)
    STATISTICS_TODAY_NO_CARDS = (30, 88)
    STATISTICS_TODAY_NO_MATURE_CARDS = (30, 89)
    STATISTICS_TODAY_TITLE = (30, 90)
    STATISTICS_TODAY_TYPE_COUNTS = (30, 91)
    STATISTICS_TOTAL = (30, 92)
    STUDYING_AGAIN = (31, 0)
    STUDYING_ALL_BURIED_CARDS = (31, 1)
    STUDYING_AUDIO_5S = (31, 2)
    STUDYING_AUDIO_AND5S = (31, 3)
    STUDYING_BURIED_SIBLINGS = (31, 4)
    STUDYING_BURY = (31, 5)
    STUDYING_BURY_CARD = (31, 6)
    STUDYING_BURY_NOTE = (31, 7)
    STUDYING_CARD_BURIED = (31, 8)
    STUDYING_CARD_STUDIED_IN = (31, 9)
    STUDYING_CARD_SUSPENDED = (31, 10)
    STUDYING_CARD_WAS_A_LEECH = (31, 11)
    STUDYING_CARDS_WILL_BE_AUTOMATICALLY_RETURNED_TO = (31, 12)
    STUDYING_CONTINUE = (31, 13)
    STUDYING_DELETE_NOTE = (31, 14)
    STUDYING_DELETING_THIS_DECK_FROM_THE_DECK = (31, 15)
    STUDYING_EASY = (31, 16)
    STUDYING_EDIT = (31, 17)
    STUDYING_EMPTY = (31, 18)
    STUDYING_FINISH = (31, 19)
    STUDYING_FLAG_CARD = (31, 20)
    STUDYING_GOOD = (31, 21)
    STUDYING_HARD = (31, 22)
    STUDYING_IT_HAS_BEEN_SUSPENDED = (31, 23)
    STUDYING_MANUALLY_BURIED_CARDS = (31, 24)
    STUDYING_MARK_NOTE = (31, 25)
    STUDYING_MINUTE = (31, 26)
    STUDYING_MORE = (31, 27)
    STUDYING_NO_CARDS_ARE_DUE_YET = (31, 28)
    STUDYING_NOTE_AND_ITS_CARD_DELETED = (31, 29)
    STUDYING_NOTE_BURIED = (31, 30)
    STUDYING_NOTE_SUSPENDED = (31, 31)
    STUDYING_PAUSE_AUDIO = (31, 32)
    STUDYING_PLEASE_RUN_TOOLSEMPTY_CARDS = (31, 33)
    STUDYING_RECORD_OWN_VOICE = (31, 34)
    STUDYING_REPLAY_OWN_VOICE = (31, 35)
    STUDYING_SHOW_ANSWER = (31, 36)
    STUDYING_SPACE = (31, 37)
    STUDYING_STUDY_NOW = (31, 38)
    STUDYING_SUSPEND = (31, 39)
    STUDYING_SUSPEND_NOTE = (31, 40)
    STUDYING_THIS_IS_A_SPECIAL_DECK_FOR = (31, 41)
    STUDYING_TO_REVIEW = (31, 42)
    STUDYING_TYPE_ANSWER_UNKNOWN_FIELD = (31, 43)
    STUDYING_UNBURY = (31, 44)
    STUDYING_WHAT_WOULD_YOU_LIKE_TO_UNBURY = (31, 45)
    STUDYING_YOU_HAVENT_RECORDED_YOUR_VOICE_YET = (31, 46)
    SYNC_ABORT_BUTTON = (32, 0)
    SYNC_ACCOUNT_REQUIRED = (32, 1)
    SYNC_ADDED_UPDATED_COUNT = (32, 2)
    SYNC_ANKIWEB_ID_LABEL = (32, 3)
    SYNC_CANCEL_BUTTON = (32, 4)
    SYNC_CHECKING = (32, 5)
    SYNC_CLIENT_TOO_OLD = (32, 6)
    SYNC_CLOCK_OFF = (32, 7)
    SYNC_CONFIRM_EMPTY_DOWNLOAD = (32, 8)
    SYNC_CONFLICT = (32, 9)
    SYNC_CONFLICT_EXPLANATION = (32, 10)
    SYNC_CONNECTING = (32, 11)
    SYNC_DOWNLOAD_FROM_ANKIWEB = (32, 12)
    SYNC_DOWNLOADING_FROM_ANKIWEB = (32, 13)
    SYNC_LOG_OUT_BUTTON = (32, 14)
    SYNC_MEDIA_ABORTED = (32, 15)
    SYNC_MEDIA_ABORTING = (32, 16)
    SYNC_MEDIA_ADDED_COUNT = (32, 17)
    SYNC_MEDIA_CHECKED_COUNT = (32, 18)
    SYNC_MEDIA_COMPLETE = (32, 19)
    SYNC_MEDIA_DISABLED = (32, 20)
    SYNC_MEDIA_FAILED = (32, 21)
    SYNC_MEDIA_LOG_BUTTON = (32, 22)
    SYNC_MEDIA_LOG_TITLE = (32, 23)
    SYNC_MEDIA_REMOVED_COUNT = (32, 24)
    SYNC_MEDIA_STARTING = (32, 25)
    SYNC_MUST_WAIT_FOR_END = (32, 26)
    SYNC_PASSWORD_LABEL = (32, 27)
    SYNC_RESYNC_REQUIRED = (32, 28)
    SYNC_SANITY_CHECK_FAILED = (32, 29)
    SYNC_SERVER_ERROR = (32, 30)
    SYNC_SYNCING = (32, 31)
    SYNC_UPLOAD_TO_ANKIWEB = (32, 32)
    SYNC_UPLOADING_TO_ANKIWEB = (32, 33)
    SYNC_WRONG_PASS = (32, 34)
    UNDO_ACTION_REDONE = (33, 0)
    UNDO_ACTION_UNDONE = (33, 1)
    UNDO_REDO = (33, 2)
    UNDO_REDO_ACTION = (33, 3)
    UNDO_UNDO = (33, 4)
    UNDO_UNDO_ACTION = (33, 5)
class GeneratedTranslations:
    ...
    def actions_blue_flag(self, ) -> str:
        r''' Blue Flag '''
    ...
    def actions_green_flag(self, ) -> str:
        r''' Green Flag '''
    ...
    def actions_options_for(self, val: FluentVariable) -> str:
        r''' Options for {$val} '''
        return self._translate(1, 29, {"val": val})


    def actions_orange_flag(self, ) -> str:
        r''' Orange Flag '''
        return self._translate(1, 30, {})


    def actions_pink_flag(self, ) -> str:
        r''' Pink Flag '''
    ...
    def actions_purple_flag(self, ) -> str:
        r''' Purple Flag '''
    ...
    def actions_shortcut_key(self, val: FluentVariable) -> str:
        r''' Shortcut key: {$val} '''
        return self._translate(1, 48, {"val": val})
    ...
    def actions_turquoise_flag(self, ) -> str:
        r''' Turquoise Flag '''
    ...
    def adding_edit(self, val: FluentVariable) -> str:
        r''' Edit "{$val}" '''
        return self._translate(2, 3, {"val": val})
    ...
    def adding_note_deleted(self, ) -> str:
        r''' (Note deleted) '''
        return self._translate(2, 5, {})


    def adding_shortcut(self, val: FluentVariable) -> str:
        r''' Shortcut: {$val} '''
        return self._translate(2, 6, {"val": val})
    ...
    def adding_you_have_a_cloze_deletion_note(self, ) -> str:
        r''' You have a cloze deletion note type but have not made any cloze deletions. Proceed? '''
...
{$traceback} '''
    ...
    def browsing_confirm_saved_search_overwrite(self, name: str) -> str:
        ...
        return self._translate(4, 31, {"name": name})
    ...
    def browsing_found_as_across_bs(self, part: FluentVariable, whole: str) -> str:
        ...
        return self._translate(4, 52, {"part": part, "whole": whole})


    def browsing_group(self, count: int) -> str:
        r''' {$count} groups '''
        return self._translate(4, 53, {"count": count})
    ...
    def browsing_nd_names(self, num: FluentVariable, name: str) -> str:
        r''' {$num}: {$name} '''
        return self._translate(4, 64, {"num": num, "name": name})
    ...
    def browsing_note_count(self, count: int) -> str:
        r''' {$count} notes '''
        return self._translate(4, 70, {"count": count})
    ...
    def browsing_notes_updated(self, count: int) -> str:
        ...
        return self._translate(4, 74, {"count": count})
    ...
    def browsing_preview_selected_card(self, val: FluentVariable) -> str:
        ...
        return self._translate(4, 83, {"val": val})
    ...
    def browsing_queue_bottom(self, val: FluentVariable) -> str:
        r''' Queue bottom: {$val} '''
        return self._translate(4, 85, {"val": val})
    ...
    def browsing_removed_unused_tags_count(self, count: int) -> str:
        ...
        return self._translate(4, 89, {"count": count})
...
Please either add a cloze deletion, or use the Empty Cards tool. '''
    ...
    def database_check_revlog_properties(self, count: int) -> str:
        ...
        return self._translate(9, 16, {"count": count})
    ...
    def deck_config_add_group(self, ) -> str:
        r''' Add Preset '''
        return self._translate(10, 0, {})


    def deck_config_advanced_title(self, ) -> str:
        r''' Advanced '''
        return self._translate(10, 1, {})
...
cloze deletions) will be delayed until the next day. '''
    ...
    def deck_config_clone_group(self, ) -> str:
        r''' Clone Preset '''
        return self._translate(10, 8, {})


    def deck_config_confirm_normal(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(10, 9, {"name": name})


    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(10, 10, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(10, 11, {"cards": cards})


    def deck_config_daily_limits(self, ) -> str:
        r''' Daily Limits '''
        return self._translate(10, 12, {})
...
the manual before changing this option. '''
    ...
    def deck_config_learning_step_above_graduating_interval(self, ) -> str:
        ...
        return self._translate(10, 25, {})


    def deck_config_learning_steps(self, ) -> str:
        r''' Learning steps '''
        return self._translate(10, 26, {})
...
shown in succession. '''
        return self._translate(10, 38, {})


    def deck_config_new_gather_priority(self, ) -> str:
        r''' New card gather priority '''
        return self._translate(10, 39, {})


    def deck_config_new_gather_priority_deck(self, ) -> str:
        r''' Deck '''
        return self._translate(10, 40, {})


    def deck_config_new_gather_priority_position(self, ) -> str:
        r''' Position '''
        return self._translate(10, 41, {})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(10, 64, {"cards": cards, "expected": expected})


    def deck_config_save_button(self, ) -> str:
        r''' Save '''
        return self._translate(10, 65, {})


    def deck_config_save_to_all_subdecks(self, ) -> str:
        r''' Save to All Subdecks '''
        return self._translate(10, 66, {})
...
you proceed. '''
    ...
    def editing_an_error_occurred_while_opening(self, val: FluentVariable) -> str:
        ...
        return self._translate(12, 3, {"val": val})
    ...
    def empty_cards_count_line(self, empty_count: int, existing_count: int, template_names: str) -> str:
        ...
        return self._translate(13, 0, {"empty_count": empty_count, "existing_count": existing_count, "template_names": template_names})
    ...
    def empty_cards_deleted_count(self, cards: int) -> str:
        ...
        return self._translate(13, 4, {"cards": cards})
    ...
    def empty_cards_for_note_type(self, notetype: str) -> str:
        ...
        return self._translate(13, 6, {"notetype": notetype})
...
Debug info: '''
    ...
    def exporting_card_exported(self, count: int) -> str:
        ...
        return self._translate(15, 4, {"count": count})
    ...
    def exporting_couldnt_save_file(self, val: FluentVariable) -> str:
        ...
        return self._translate(15, 8, {"val": val})
    ...
    def exporting_exported_media_file(self, count: int) -> str:
        ...
        return self._translate(15, 11, {"count": count})
    ...
    def exporting_note_exported(self, count: int) -> str:
        ...
        return self._translate(15, 17, {"count": count})
    ...
    def fields_delete_field_from(self, val: FluentVariable) -> str:
        ...
        return self._translate(16, 1, {"val": val})
    ...
    def fields_field_name(self, ) -> str:
        r''' Field name: '''
        return self._translate(16, 4, {})


    def fields_fields_for(self, val: FluentVariable) -> str:
        r''' Fields for {$val} '''
        return self._translate(16, 5, {"val": val})
    ...
    def importing_notes_skipped_as_theyre_already_in(self, val: FluentVariable) -> str:
        ...
        return self._translate(18, 37, {"val": val})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(18, 43, {"row": row, "found": found, "expected": expected})
    ...
    def media_recordingtime(self, secs: str) -> str:
        ...
        return self._translate(20, 5, {"secs": secs})
    ...
    def media_check_files_remaining(self, count: int) -> str:
        ...
        return self._translate(21, 7, {"count": count})


    def media_check_missing_count(self, count: int) -> str:
        r''' Missing files: {$count} '''
        return self._translate(21, 8, {"count": count})


    def media_check_missing_file(self, filename: str) -> str:
        r''' Missing: {$filename} '''
        return self._translate(21, 9, {"filename": filename})
    ...
    def notetypes_add(self, val: FluentVariable) -> str:
        r''' Add: {$val} '''
        return self._translate(23, 0, {"val": val})
    ...
    def notetypes_basic_type_answer_name(self, ) -> str:
        ...
        return self._translate(23, 8, {})


    def notetypes_card_1_name(self, ) -> str:
        r''' Card 1 '''
        return self._translate(23, 9, {})
    ...
    def notetypes_clone(self, val: FluentVariable) -> str:
        r''' Clone: {$val} '''
        return self._translate(23, 12, {"val": val})
    ...
    def profiles_confirm_lang_choice(self, lang: str) -> str:
        ...
        return self._translate(25, 2, {"lang": lang})
...
{$link} '''
        return self._translate(25, 6, {"link": link})
    ...
    def profiles_please_remove_the_folder_and(self, val: FluentVariable) -> str:
        ...
        return self._translate(25, 9, {"val": val})
    ...
    def qt_misc_anki_updatedanki_has_been_released(self, val: FluentVariable) -> str:
        ...
        return self._translate(27, 4, {"val": val})
    ...
    def qt_misc_error_during_startup(self, val: FluentVariable) -> str:
        ...
        return self._translate(27, 22, {"val": val})
    ...
    def qt_misc_error_loading_graphics_driver(self, mode: str, context: str) -> str:
        ...
        return self._translate(27, 23, {"mode": mode, "context": context})


    def qt_misc_filtered_deck(self, val: FluentVariable) -> str:
        r''' Filtered Deck {$val} '''
        return self._translate(27, 24, {"val": val})
    ...
    def qt_misc_in_order_to_ensure_your_collection(self, val: FluentVariable) -> str:
        ...
        return self._translate(27, 27, {"val": val})
...
Original error: {$error} '''
    ...
    def scheduling_buried_cards_found(self, unbury_them: str) -> str:
        ...
        return self._translate(28, 9, {"unburyThem": unbury_them})
    ...
    def scheduling_deck_updated(self, count: int) -> str:
        ...
        return self._translate(28, 15, {"count": count})
    ...
    def scheduling_forgot_cards(self, cards: int) -> str:
        ...
        return self._translate(28, 21, {"cards": cards})
    ...
    def scheduling_how_to_custom_study(self, custom_study: str) -> str:
        ...
        return self._translate(28, 25, {"customStudy": custom_study})
    ...
    def scheduling_learn_remaining(self, remaining: int) -> str:
        ...
        return self._translate(28, 30, {"remaining": remaining})
    ...
    def scheduling_next_learn_due(self, unit: str, amount: int) -> str:
        ...
        return self._translate(28, 42, {"unit": unit, "amount": amount})
...
the daily limit in the options. '''
    ...
    def search_invalid_answer_button(self, context: str, provided: str) -> str:
        ...
        return self._translate(29, 3, {"context": context, "provided": provided})


    def search_invalid_argument(self, term: str, argument: str) -> str:
        r''' `{$term}` was given an invalid argument '`{$argument}`'. '''
        return self._translate(29, 4, {"term": term, "argument": argument})


    def search_invalid_flag(self, ) -> str:
    ...
    def search_invalid_negative_whole_number(self, context: str, provided: str) -> str:
        ...
        return self._translate(29, 6, {"context": context, "provided": provided})


    def search_invalid_number(self, context: str, provided: str) -> str:
        r''' expected a number in "`{$context}`", but found "`{$provided}`". '''
        return self._translate(29, 7, {"context": context, "provided": provided})
    ...
    def search_invalid_positive_whole_number(self, context: str, provided: str) -> str:
        ...
        return self._translate(29, 9, {"context": context, "provided": provided})
    ...
    def search_unknown_escape(self, val: FluentVariable) -> str:
        ...
        return self._translate(29, 19, {"val": val})
    ...
    def statistics_amount_of_total_with_percentage(self, amount: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(30, 2, {"amount": amount, "total": total, "percent": percent})


    def statistics_answer_buttons_button_number(self, ) -> str:
        r''' Button '''
        return self._translate(30, 3, {})


    def statistics_answer_buttons_button_pressed(self, ) -> str:
        r''' Times pressed '''
        return self._translate(30, 4, {})
    ...
    def statistics_average_answer_time(self, average_seconds: float, cards_per_minute: float) -> str:
        r''' {$average-seconds}s () '''
        return self._translate(30, 8, {"average-seconds": average_seconds, "cards-per-minute": cards_per_minute})


    def statistics_average_answer_time_label(self, ) -> str:
        r''' Average answer time '''
        return self._translate(30, 9, {})
    ...
    def statistics_card_ease_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(30, 18, {"cards": cards, "percent": percent})


    def statistics_cards(self, cards: int) -> str:
        r''' {$cards} cards '''
        return self._translate(30, 19, {"cards": cards})
    ...
    def statistics_cards_per_day(self, count: int) -> str:
        r''' {$count} cards/day '''
        return self._translate(30, 21, {"count": count})


    def statistics_cards_per_min(self, cards_per_minute: float) -> str:
        r''' {$cards-per-minute} cards/minute '''
        return self._translate(30, 22, {"cards-per-minute": cards_per_minute})
    ...
    def statistics_days_ago_range(self, days_start: int, days_end: int) -> str:
        ...
        return self._translate(30, 34, {"daysStart": days_start, "daysEnd": days_end})


    def statistics_days_ago_single(self, days: int) -> str:
        r''' {$days} days ago '''
        return self._translate(30, 35, {"days": days})
    ...
    def statistics_due_for_new_card(self, number: FluentVariable) -> str:
        r''' New #{$number} '''
        return self._translate(30, 39, {"number": number})
    ...
    def statistics_intervals_day_range(self, cards: int, days_start: int, days_end: int) -> str:
        ...
        return self._translate(30, 61, {"cards": cards, "daysStart": days_start, "daysEnd": days_end})


    def statistics_intervals_day_single(self, cards: int, day: FluentVariable) -> str:
        r''' {$cards} cards with a {$day} day interval '''
        return self._translate(30, 62, {"cards": cards, "day": day})
    ...
    def statistics_reviews(self, reviews: int) -> str:
        r''' {$reviews} reviews '''
        return self._translate(30, 74, {"reviews": reviews})
    ...
    def statistics_reviews_per_day(self, count: int) -> str:
        r''' {$count} reviews/day '''
        return self._translate(30, 76, {"count": count})
    ...
    def statistics_saved(self, ) -> str:
        r''' Saved. '''
        return self._translate(30, 82, {})


    def statistics_seconds_taken(self, seconds: FluentVariable) -> str:
        r''' {$seconds}s '''
        return self._translate(30, 83, {"seconds": seconds})


    def statistics_stats(self, ) -> str:
        r''' stats '''
        return self._translate(30, 84, {})
...
({$secs-per-card}s/card) '''
        return self._translate(30, 85, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})


    def statistics_today_again_count(self, ) -> str:
        r''' Again count: '''
        return self._translate(30, 86, {})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(30, 91, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})


    def statistics_total(self, ) -> str:
        r''' Total '''
        return self._translate(30, 92, {})
    ...
    def studying_card_studied_in(self, count: int) -> str:
        ...
        return self._translate(31, 9, {"count": count})
    ...
    def studying_minute(self, count: int) -> str:
        r''' {$count} minutes. '''
        return self._translate(31, 26, {"count": count})
    ...
    def studying_note_and_its_card_deleted(self, count: int) -> str:
        ...
        return self._translate(31, 29, {"count": count})
    ...
    def studying_record_own_voice(self, ) -> str:
        r''' Record Own Voice '''
        return self._translate(31, 34, {})


    def studying_replay_own_voice(self, ) -> str:
        r''' Replay Own Voice '''
        return self._translate(31, 35, {})
...
A free account is required to keep your collection synchronized. Please <a href="{$link}">sign up</a> for an account, then enter your details below. '''
        return self._translate(32, 1, {"link": link})


    def sync_added_updated_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Added/modified: {$up}â†‘ {$down}â†“ '''
        return self._translate(32, 2, {"up": up, "down": down})
...
After all devices are in sync, future reviews and added cards can be merged automatically. '''
    ...
    def sync_media_added_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Added: {$up}â†‘ {$down}â†“ '''
        return self._translate(32, 17, {"up": up, "down": down})


    def sync_media_checked_count(self, count: int) -> str:
        r''' Checked: {$count} '''
        return self._translate(32, 18, {"count": count})
    ...
    def sync_media_removed_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Removed: {$up}â†‘ {$down}â†“ '''
        return self._translate(32, 24, {"up": up, "down": down})
    ...
    def undo_action_redone(self, action: str) -> str:
        r''' {$action} redone '''
        return self._translate(33, 0, {"action": action})


    def undo_action_undone(self, action: str) -> str:
        r''' {$action} undone '''
        return self._translate(33, 1, {"action": action})
    ...
    def undo_redo_action(self, action: str) -> str:
        r''' Redo {$action} '''
        return self._translate(33, 3, {"action": action})
    ...
    def undo_undo_action(self, val: FluentVariable) -> str:
        r''' Undo {$val} '''
        return self._translate(33, 5, {"val": val})
