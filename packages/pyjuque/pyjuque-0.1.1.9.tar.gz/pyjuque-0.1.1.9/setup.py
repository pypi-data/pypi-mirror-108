...
setup(
	...
	install_requires=['yaspin==1.2.0', 'ccxt==1.44.7', 'pyyaml==5.4', 'numpy==1.19.4', 'pandas==1.1.4', 'plotly==4.12.0', 'python-dotenv==0.15.0' ,'requests==2.25.0', 'SQLAlchemy==1.3.18', 'websocket==0.2.1', 'websocket-client==0.57.0'],
...
# twine upload dist/pyjuque-0.1.1.8.tar.gz