...
def line_chart(title: str, x: list, line: list, height=300, width=400, sizing_mode=None) -> Figure:
    p = figure(
        title=title,
...
def line_circle_chart(title: str, x: list, line: list, circle: list, height=300, width=400, sizing_mode=None) -> Figure:
    p = figure(
        title=title,
        toolbar_location="above",
        plot_height=height,
