...
def compile_model(model, config):
    ...
    # opt = MyAdamW(weight_decay=0.0001, learning_rate=0.001)
    ...
    metrics = {
        ...
        'multi_label': ['binary_accuracy', tf.keras.metrics.AUC(), tf.keras.metrics.Precision(), tf.keras.metrics.Recall()],
        'regression': ['mae']
    }[output_type]
