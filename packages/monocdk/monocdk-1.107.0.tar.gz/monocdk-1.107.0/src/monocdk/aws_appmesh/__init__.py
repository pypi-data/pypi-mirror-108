    ...
    listeners=[appmesh.VirtualGatewayListener.grpc(
        ...
        tls={
            ...
            "certificate": appmesh.TlsCertificate.file(
                certificate_chain_path="path/to/certChain",
...
class AcmCertificateOptions:
    def __init__(self, *, certificate: _ICertificate_c7bbdc16) -> None:
...
class Backend(
    ...
    def virtual_service(
        ...
        *,
        ...
        :param tls_client_policy: (experimental) Client policy for the backend. Default: - none
...
class BackendDefaults:
    def __init__(
        ...
        *,
        ...
        :param tls_client_policy: (experimental) Client policy for backend defaults. Default: - none
...
class GrpcGatewayListenerOptions:
    def __init__(
        ...
        *,
        ...
        port: typing.Optional[jsii.Number] = None,
        tls: typing.Optional["TlsListener"] = None,
    ) -> None:
    ...
    @builtins.property
    def tls(self) -> typing.Optional["TlsListener"]:
        ...
        '''
        result = self._values.get("tls")
        return typing.cast(typing.Optional["TlsListener"], result)
...
class HealthCheck(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_HealthCheckProxy"]:
        return _HealthCheckProxy
...
class TlsCertificate(
    ...
    def acm(cls, *, certificate: _ICertificate_c7bbdc16) -> "TlsCertificate":
        ...
        :stability: experimental
        '''
        props = AcmCertificateOptions(certificate=certificate)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"validation": "validation", "enforce": "enforce", "ports": "ports"},
)
...
@jsii.data_type(
    jsii_type="monocdk.aws_appmesh.TlsListener",
    jsii_struct_bases=[],
    name_mapping={"certificate": "certificate", "mode": "mode"},
)
class TlsListener:
    def __init__(self, *, certificate: TlsCertificate, mode: "TlsMode") -> None:
...
class TlsValidation:
    def __init__(self, *, trust: "TlsValidationTrust") -> None:
...
@jsii.data_type(
    jsii_type="monocdk.aws_appmesh.TlsValidationAcmTrustOptions",
    jsii_struct_bases=[],
    name_mapping={"certificate_authorities": "certificateAuthorities"},
)
class TlsValidationAcmTrustOptions:
    def __init__(
        self,
        *,
    ...
    def __repr__(self) -> str:
        return "TlsValidationAcmTrustOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="monocdk.aws_appmesh.TlsValidationFileTrustOptions",
    jsii_struct_bases=[],
    name_mapping={"certificate_chain": "certificateChain"},
)
class TlsValidationFileTrustOptions:
    def __init__(self, *, certificate_chain: builtins.str) -> None:
    ...
    def __repr__(self) -> str:
        return "TlsValidationFileTrustOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class TlsValidationTrust(
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_TlsValidationTrustProxy"]:
        return _TlsValidationTrustProxy
    ...
    def acm(
        ...
        *,
        ...
        :stability: experimental
        '''
        props = TlsValidationAcmTrustOptions(
            certificate_authorities=certificate_authorities
        )

        return typing.cast("TlsValidationTrust", jsii.sinvoke(cls, "acm", [props]))

    @jsii.member(jsii_name="file") # type: ignore[misc]
    @builtins.classmethod
    def file(cls, *, certificate_chain: builtins.str) -> "TlsValidationTrust":
        ...
        :stability: experimental
        '''
        props = TlsValidationFileTrustOptions(certificate_chain=certificate_chain)

        return typing.cast("TlsValidationTrust", jsii.sinvoke(cls, "file", [props]))
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={
        "virtual_gateway_client_tls_validation_trust": "virtualGatewayClientTlsValidationTrust",
        "virtual_node_client_tls_validation_trust": "virtualNodeClientTlsValidationTrust",
    },
)
class TlsValidationTrustConfig:
    def __init__(
        self,
        *,
        virtual_gateway_client_tls_validation_trust: CfnVirtualGateway.VirtualGatewayTlsValidationContextTrustProperty,
        virtual_node_client_tls_validation_trust: CfnVirtualNode.TlsValidationContextTrustProperty,
    ) -> None:
        '''(experimental) All Properties for TLS Validations for both Client Policy and Listener.

        :param virtual_gateway_client_tls_validation_trust: (experimental) VirtualGateway CFN configuration for client policy's TLS Validation.
        :param virtual_node_client_tls_validation_trust: (experimental) VirtualNode CFN configuration for client policy's TLS Validation.

        :stability: experimental
        '''
        if isinstance(virtual_gateway_client_tls_validation_trust, dict):
            virtual_gateway_client_tls_validation_trust = CfnVirtualGateway.VirtualGatewayTlsValidationContextTrustProperty(**virtual_gateway_client_tls_validation_trust)
        if isinstance(virtual_node_client_tls_validation_trust, dict):
            virtual_node_client_tls_validation_trust = CfnVirtualNode.TlsValidationContextTrustProperty(**virtual_node_client_tls_validation_trust)
        self._values: typing.Dict[str, typing.Any] = {
            "virtual_gateway_client_tls_validation_trust": virtual_gateway_client_tls_validation_trust,
            "virtual_node_client_tls_validation_trust": virtual_node_client_tls_validation_trust,
        }

    @builtins.property
    def virtual_gateway_client_tls_validation_trust(
        self,
        ...
        :stability: experimental
        '''
        result = self._values.get("virtual_gateway_client_tls_validation_trust")
        assert result is not None, "Required property 'virtual_gateway_client_tls_validation_trust' is missing"
        return typing.cast(CfnVirtualGateway.VirtualGatewayTlsValidationContextTrustProperty, result)

    @builtins.property
    def virtual_node_client_tls_validation_trust(
        self,
        ...
        :stability: experimental
        '''
        result = self._values.get("virtual_node_client_tls_validation_trust")
        assert result is not None, "Required property 'virtual_node_client_tls_validation_trust' is missing"
...
__all__ = [
    ...
    "TlsMode",
    "TlsValidation",
    "TlsValidationAcmTrustOptions",
    "TlsValidationFileTrustOptions",
    "TlsValidationTrust",
