...
readme = Path('C:/Users/McCub/Desktop/discord.py-message-components/README.rst').read_text(encoding='utf-16')
...
setup(
    ...
    packages=['src.discord', 'src.discord.ext.commands', 'src.discord.ext.tasks'],
