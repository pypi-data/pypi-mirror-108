...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'kubernetes', '3.0.0-alpha.1623192203+722469b1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource kubernetes 3.0.0-alpha.1623192203+722469b1`
                """)
            else:
                raise
