# mypy-boto3-batch<a id="mypy-boto3-batch"></a>
...
[boto3.Batch 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/batch.html#Batch)
