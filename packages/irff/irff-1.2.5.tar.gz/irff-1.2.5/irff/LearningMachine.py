...
class LearningMachine(object):
  ...
  def __init__(self,initConfig='poscar.gen',
               ...
               accCriteria=0.95,lossCriteria=1000.0,lossTole=1.0,accTole=0.005,
               accMax=0.96,accInc=1.0001,mdInc=1.2,resetAcc=1,
               ...
               nn=True,vdwnn=False,
               bo_layer=[2,1],mf_layer=[6,1],be_layer=[6,1],
               EnergyFunction=1,MessageFunction=3,
               bom={'others':1.0},
               bore={'others':0.45},
               weight={'others':2.0},
               spv_bm=False,spv_be=False,
               lambda_bd=10000.0,lambda_reg=0.000001,regularize=True,
               mefac=0.1,
               writelib=5000,
      ...
      while running:
          ...
          if learnWay==6:
             ...
             if Deformed>=1.0:
                ...
                # if self.CheckZmat and mdsteps<=2:
                #    mdsteps= 7
