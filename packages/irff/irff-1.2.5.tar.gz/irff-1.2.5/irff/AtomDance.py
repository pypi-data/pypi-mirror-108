...
class AtomDance(object):
  ...
  def set_bond_momenta(self,i,j,atoms,sign=1.0,add=False):
      ...
      if ring:
         group_i,group_j = get_group(i,j,self.ir.r,atoms)
  ...
  def swing_group(self,ang=None,group=None,rang=20,nbin=30,scale=1.2,traj=None):
      i,j,k = ang
      atoms = self.ir.atoms
      self.ir.calculate_Delta(atoms)
  ...
  def continous(self,atoms,dr=0.001,da=1.0):
