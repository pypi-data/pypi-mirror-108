# mypy-boto3-customer-profiles<a id="mypy-boto3-customer-profiles"></a>
...
[boto3.CustomerProfiles 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/customer-profiles.html#CustomerProfiles)
