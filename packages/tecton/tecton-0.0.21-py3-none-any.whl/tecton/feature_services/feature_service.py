...
class FeatureService:
    ...
    In Tecton, a Feature Service exposes an API for accessing a set of FeaturePackages.
    ...
    Packages associated with a model. It also includes user-provided metadata such as
    ...
    def __init__(
        ...
        *,
        ...
        features: List[Union[FeaturesConfig, FeaturePackage, FeatureDefinition]] = None,
        ...
        :param features: The list of FeaturePackage or FeaturesConfig that this FeatureService will serve.
        :param online_serving_enabled: (Optional, default True) If True, users can send realtime requests
            to this FeatureService, and only FeaturePackages with online materialization enabled can be added
