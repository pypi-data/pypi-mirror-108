...
"""
Transfomations in this mode should return a Spark SQL string
"""
...
class Transformation:
    ...
    _ARGUMENT_TYPE = Union[PipelineNode, Constant]
...
def transformation(
    ...
    """
    Declares a Transformation that wraps a user function. The transformation be assembled in a pipeline function.

    :param mode: The mode for this transformation; should be one of SPARK_SQL_MODE, PYSPARK_MODE or PANDAS_MODE
