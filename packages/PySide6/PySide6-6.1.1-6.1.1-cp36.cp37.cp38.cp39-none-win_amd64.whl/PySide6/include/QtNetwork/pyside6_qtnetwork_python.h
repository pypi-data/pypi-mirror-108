...
enum : int {
    ...
    SBK_QNETWORKCOOKIE_SAMESITE_IDX                          = 52,
    SBK_QNETWORKCOOKIE_IDX                                   = 50,
    SBK_QNETWORKCOOKIEJAR_IDX                                = 53,
    SBK_QNETWORKDATAGRAM_IDX                                 = 54,
    SBK_QNETWORKDISKCACHE_IDX                                = 55,
    SBK_QNETWORKINTERFACE_INTERFACEFLAG_IDX                  = 57,
    SBK_QFLAGS_QNETWORKINTERFACE_INTERFACEFLAG_IDX           = 26,
    SBK_QNETWORKINTERFACE_INTERFACETYPE_IDX                  = 58,
    SBK_QNETWORKINTERFACE_IDX                                = 56,
    SBK_QNETWORKPROXY_PROXYTYPE_IDX                          = 61,
    SBK_QNETWORKPROXY_CAPABILITY_IDX                         = 60,
    SBK_QFLAGS_QNETWORKPROXY_CAPABILITY_IDX                  = 27,
    SBK_QNETWORKPROXY_IDX                                    = 59,
    SBK_QNETWORKPROXYFACTORY_IDX                             = 62,
    SBK_QNETWORKPROXYQUERY_QUERYTYPE_IDX                     = 64,
    SBK_QNETWORKPROXYQUERY_IDX                               = 63,
    SBK_QNETWORKREPLY_NETWORKERROR_IDX                       = 66,
    SBK_QNETWORKREPLY_IDX                                    = 65,
    SBK_QNETWORKREQUEST_KNOWNHEADERS_IDX                     = 70,
    SBK_QNETWORKREQUEST_ATTRIBUTE_IDX                        = 68,
    SBK_QNETWORKREQUEST_CACHELOADCONTROL_IDX                 = 69,
    SBK_QNETWORKREQUEST_LOADCONTROL_IDX                      = 71,
    SBK_QNETWORKREQUEST_PRIORITY_IDX                         = 72,
    SBK_QNETWORKREQUEST_REDIRECTPOLICY_IDX                   = 73,
    SBK_QNETWORKREQUEST_TRANSFERTIMEOUTCONSTANT_IDX          = 74,
    SBK_QNETWORKREQUEST_IDX                                  = 67,
    SBK_QOCSPRESPONSE_IDX                                    = 76,
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 78,
    SBK_QSSL_KEYTYPE_IDX                                     = 86,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 83,
    SBK_QSSL_KEYALGORITHM_IDX                                = 85,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 82,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 88,
    SBK_QSSL_SSLOPTION_IDX                                   = 87,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 28,
    SBK_QSSL_ALERTLEVEL_IDX                                  = 80,
    SBK_QSSL_ALERTTYPE_IDX                                   = 81,
    SBK_QSSL_IMPLEMENTEDCLASS_IDX                            = 84,
    SBK_QSSL_SUPPORTEDFEATURE_IDX                            = 89,
    SBK_QtNetworkQSSL_IDX                                    = 79,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 92,
    SBK_QSSLCERTIFICATE_PATTERNSYNTAX_IDX                    = 91,
    SBK_QSSLCERTIFICATE_IDX                                  = 90,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 93,
    SBK_QSSLCIPHER_IDX                                       = 94,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 96,
    SBK_QSSLCONFIGURATION_IDX                                = 95,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 98,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 97,
    SBK_QSSLERROR_SSLERROR_IDX                               = 100,
    SBK_QSSLERROR_IDX                                        = 99,
    SBK_QSSLKEY_IDX                                          = 101,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 102,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 105,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 104,
    SBK_QSSLSOCKET_IDX                                       = 103,
    SBK_QTCPSERVER_IDX                                       = 106,
    SBK_QTCPSOCKET_IDX                                       = 107,
    SBK_QUDPSOCKET_IDX                                       = 108,
    SBK_QDTLSERROR_IDX                                       = 20,
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 75,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 77,
    SBK_QtNetwork_IDX_COUNT                                  = 109
};
...
enum : int {
    ...
    SBK_QTNETWORK_QPAIR_QHOSTADDRESS_INT_IDX                 = 11, // QPair<QHostAddress,int >
    ...
    SBK_QTNETWORK_QLIST_QSTRING_IDX                          = 22, // QList<QString >
    SBK_QTNETWORK_QLIST_QSSL_IMPLEMENTEDCLASS_IDX            = 23, // QList<QSsl::ImplementedClass >
    SBK_QTNETWORK_QLIST_QOCSPRESPONSE_IDX                    = 24, // QList<QOcspResponse >
    SBK_QTNETWORK_QLIST_QSSL_SUPPORTEDFEATURE_IDX            = 25, // QList<QSsl::SupportedFeature >
    SBK_QTNETWORK_QLIST_QSSL_SSLPROTOCOL_IDX                 = 26, // QList<QSsl::SslProtocol >
    SBK_QTNETWORK_QLIST_QSSLCERTIFICATEEXTENSION_IDX         = 27, // QList<QSslCertificateExtension >
    SBK_QTNETWORK_QMULTIMAP_QSSL_ALTERNATIVENAMEENTRYTYPE_QSTRING_IDX = 28, // QMultiMap<QSsl::AlternativeNameEntryType,QString >
    SBK_QTNETWORK_QLIST_QVARIANT_IDX                         = 29, // QList<QVariant >
    SBK_QTNETWORK_QMAP_QSTRING_QVARIANT_IDX                  = 30, // QMap<QString,QVariant >
    SBK_QtNetwork_CONVERTERS_IDX_COUNT                       = 31
};
