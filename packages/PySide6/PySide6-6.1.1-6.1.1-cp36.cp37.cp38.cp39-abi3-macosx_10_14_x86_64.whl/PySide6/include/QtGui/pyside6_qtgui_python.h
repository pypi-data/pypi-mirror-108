...
enum : int {
    ...
    SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                     = 7, // QList<QStandardItem* >
    SBK_QTGUI_QLIST_QPOINTF_IDX                              = 8, // QList<QPointF >
    SBK_QTGUI_QLIST_QUINT32_IDX                              = 9, // QList<quint32 >
    ...
    SBK_QTGUI_QLIST_STD_PAIR_QREAL_QCOLOR_IDX                = 16, // QList<std::pair< qreal,QColor > >
    ...
    SBK_QTGUI_QLIST_QLINE_IDX                                = 22, // QList<QLine >
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 23, // QList<QLineF >
    SBK_QTGUI_QLIST_QRECT_IDX                                = 24, // QList<QRect >
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 25, // QList<QRectF >
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 26, // QList<QKeySequence >
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 27, // QList<QObject* >
    ...
    SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX          = 38, // QList<QInputMethodEvent::Attribute >
    SBK_QTGUI_QLIST_QEVENTPOINT_IDX                          = 39, // QList<QEventPoint >
    SBK_QTGUI_QLIST_QWINDOWPTR_IDX                           = 40, // QList<QWindow* >
    SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                = 41, // QList<QPersistentModelIndex >
