...
enum : int {
    ...
    SBK_QPYDESIGNERCONTAINEREXTENSION_IDX                    = 34,
    SBK_QPYDESIGNERCUSTOMWIDGETCOLLECTION_IDX                = 35,
    SBK_QPYDESIGNERMEMBERSHEETEXTENSION_IDX                  = 36,
    SBK_QPYDESIGNERPROPERTYSHEETEXTENSION_IDX                = 37,
    SBK_QPYDESIGNERTASKMENUEXTENSION_IDX                     = 38,
    SBK_QtDesigner_IDX_COUNT                                 = 39
};
