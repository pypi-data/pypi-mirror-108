...
from altuscli.model import DenormalizedStructureBuilder
from altuscli.model import ServiceModel
from altuscli.utils import ArgumentGenerator
from altuscli.utils import CachedProperty
from altuscli.utils import datetime2timestamp
from altuscli.utils import get_service_module_name
from altuscli.utils import instance_cache
from altuscli.utils import parse_timestamp
...
class TestGetServiceModuleName(unittest.TestCase):
    def setUp(self):
        self.service_description = {
            'metadata': {
                'serviceFullName': 'Altus MyService',
