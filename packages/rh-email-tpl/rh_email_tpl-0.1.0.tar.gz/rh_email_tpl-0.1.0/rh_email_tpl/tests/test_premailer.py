...
TESTS_TEMPLATE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "premailer_templates")

TEMPLATES = settings.TEMPLATES
TEMPLATES[0]["DIRS"].append(TESTS_TEMPLATE_DIR)

PREMAILER_OPTIONS = settings.PREMAILER_OPTIONS
PREMAILER_OPTIONS["base_url"] = "http://example.com"


@override_settings(TEMPLATES=TEMPLATES, PREMAILER_OPTIONS=PREMAILER_OPTIONS)
