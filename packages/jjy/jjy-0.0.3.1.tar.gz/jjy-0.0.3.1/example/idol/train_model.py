...
def make_net5():
    net = MultiLayerNet(is_use_dropout=False)
    net.load_model("./idol_result/train_weight_2021-04-24 123923.npz")
    return net
...
def train_model():
    ...
    with Timer(name="jjy 3-Dense Layer"):
        result = net.train(
            x_train, t_train, x_test, t_test, batch_size=32, iters_num=937, print_epoch=1, evaluate_limit=500,
