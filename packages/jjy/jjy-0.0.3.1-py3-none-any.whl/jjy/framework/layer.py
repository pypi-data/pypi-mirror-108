...
class BatchNormalization(LayerType):
    ...
    def __init__(self, gamma=None, beta=None, momentum=0.9, running_mean=None, running_var=None, **kwargs):
...
class Convolution(LayerType):
    def __init__(self, W, b, stride=1, pad=0, **kwargs):
        # print(kwargs)
        super().__init__(**kwargs)
