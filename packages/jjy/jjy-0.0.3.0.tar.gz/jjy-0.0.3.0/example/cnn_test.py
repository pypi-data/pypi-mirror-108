...
def main():
    ...
    net.add_layer(Layer.Conv2D(128, (3, 3), pad=1, input_size=(1, 28, 28), trainable=True, ),
    ...
    net.add_layer(Layer.FreezePrev())
    net.add_layer(Layer.Dense(10, trainable=True))
    ...
    result = net.train(
        x_train, t_train, x_test, t_test, batch_size=200, iters_num=25, print_epoch=1, evaluate_limit=100,
