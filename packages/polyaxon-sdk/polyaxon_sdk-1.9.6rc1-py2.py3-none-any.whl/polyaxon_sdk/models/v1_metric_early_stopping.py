...
"""
    ...
    The version of the OpenAPI document: 1.9.6-rc1
...
class V1MetricEarlyStopping(object):
    ...
    def __init__(self, kind='metric_early_stopping', metric=None, value=None, optimization=None, status=None, policy=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this V1MetricEarlyStopping.  # noqa: E501


        :return: The status of this V1MetricEarlyStopping.  # noqa: E501
        :rtype: V1Statuses
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this V1MetricEarlyStopping.


        :param status: The status of this V1MetricEarlyStopping.  # noqa: E501
        :type: V1Statuses
        """
