/*! For license information please see chunk.a390fb343087083bff8a.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[3186,9577,690,5335],{18601:(t,e,i)=>{"use strict";i.d(e,{qN:()=>n.q,Wg:()=>a});var n=i(78220);class a extends n.H{click(){this.formElement&&(this.formElement.focus(),this.formElement.click())}setAriaLabel(t){this.formElement&&this.formElement.setAttribute("aria-label",t)}firstUpdated(){super.firstUpdated(),this.shadowRoot&&this.mdcRoot.addEventListener("change",(t=>{this.dispatchEvent(new Event("change",t))}))}}a.shadowRootOptions={mode:"open",delegatesFocus:!0}},63207:(t,e,i)=>{"use strict";i(65660),i(15112);var n=i(9672),a=i(87156),o=i(50856),s=i(65233);(0,n.k)({_template:o.d`
    <style>
      :host {
        @apply --layout-inline;
