...
class DataSyncClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.can_paginate)
        [Show boto3-stubs documentation](./client.md#can_paginate)
        """

    def cancel_task_execution(self, TaskExecutionArn: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.cancel_task_execution)
    ...
    def create_agent(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_agent)
    ...
    def create_location_efs(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_location_efs)
    ...
    def create_location_fsx_windows(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_location_fsx_windows)
    ...
    def create_location_nfs(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_location_nfs)
    ...
    def create_location_object_storage(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_location_object_storage)
    ...
    def create_location_s3(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_location_s3)
    ...
    def create_location_smb(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_location_smb)
    ...
    def create_task(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.create_task)
        [Show boto3-stubs documentation](./client.md#create_task)
        """

    def delete_agent(self, AgentArn: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.delete_agent)
        [Show boto3-stubs documentation](./client.md#delete_agent)
        """

    def delete_location(self, LocationArn: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.delete_location)
        [Show boto3-stubs documentation](./client.md#delete_location)
        """

    def delete_task(self, TaskArn: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.delete_task)
        [Show boto3-stubs documentation](./client.md#delete_task)
        """

    def describe_agent(self, AgentArn: str) -> DescribeAgentResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_agent)
    ...
    def describe_location_efs(self, LocationArn: str) -> DescribeLocationEfsResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_location_efs)
    ...
    def describe_location_fsx_windows(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_location_fsx_windows)
    ...
    def describe_location_nfs(self, LocationArn: str) -> DescribeLocationNfsResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_location_nfs)
    ...
    def describe_location_object_storage(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_location_object_storage)
    ...
    def describe_location_s3(self, LocationArn: str) -> DescribeLocationS3ResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_location_s3)
    ...
    def describe_location_smb(self, LocationArn: str) -> DescribeLocationSmbResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_location_smb)
    ...
    def describe_task(self, TaskArn: str) -> DescribeTaskResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_task)
    ...
    def describe_task_execution(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.describe_task_execution)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.generate_presigned_url)
    ...
    def list_agents(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.list_agents)
    ...
    def list_locations(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.list_locations)
    ...
    def list_tags_for_resource(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.list_tags_for_resource)
    ...
    def list_task_executions(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.list_task_executions)
    ...
    def list_tasks(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.list_tasks)
    ...
    def start_task_execution(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.start_task_execution)
    ...
    def tag_resource(self, ResourceArn: str, Tags: List["TagListEntryTypeDef"]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.tag_resource)
        [Show boto3-stubs documentation](./client.md#tag_resource)
        """

    def untag_resource(self, ResourceArn: str, Keys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.untag_resource)
        [Show boto3-stubs documentation](./client.md#untag_resource)
        """

    def update_agent(self, AgentArn: str, Name: str = None) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.update_agent)
    ...
    def update_location_nfs(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.update_location_nfs)
    ...
    def update_location_object_storage(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.update_location_object_storage)
    ...
    def update_location_smb(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.update_location_smb)
    ...
    def update_task(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.update_task)
    ...
    def update_task_execution(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/datasync.html#DataSync.Client.update_task_execution)
