...
BL = module("'''+Var.nameA[0:-3]+r'''")
if not BL:
    print("pip install cmds.py [not install cmds.py]")
else:
    import builtins,sys
    builtins.__dict__["cmds"]= module("'''+Var.nameA[0:-3]+r'''")


if "cmds.py" in [i if len(i.split("=="))==1 else i.split("==")[0] for i in sys.argv]:
    if "uninstall" in sys.argv:
        import re
        ## print("@",__file__,re.__file__)
        ## texe
