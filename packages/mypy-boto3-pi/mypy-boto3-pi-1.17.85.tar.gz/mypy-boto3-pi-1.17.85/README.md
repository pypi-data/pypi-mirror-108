# mypy-boto3-pi<a id="mypy-boto3-pi"></a>
...
[boto3.PI 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/pi.html#PI)
...
def check_value(value: ServiceTypeType) -> bool:
    ...
```
