...
def create_template(variable, config, kernels = None, use_calib_cache = True, control_plots = False, interactive_plots = False, prefix = "") : 
  """
...
def resample_data(data, config, variable, template, chunk_size = 50000) : 
  """
