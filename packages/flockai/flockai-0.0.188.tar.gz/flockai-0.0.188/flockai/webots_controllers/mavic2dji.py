...
class KeyboardMavic2DJI(KeyboardControlledDrone):
    ...
    def get_communication_energy(self, comm_emmition_time, comm_receival_time):
        return self.energy_model.communication_energy.calculate(transmit_time=comm_emmition_time, receive_time=comm_receival_time, idle_time=0)
    ...
    def run(self):
        ...
        comm_emmition_time = 0
        comm_receival_time = 0
        ...
        while self.step(self.basic_time_step) != -1:
            ...
            # TODO:
            comm_emmition_time += self.send_msg(msg="test", emitter_devices=emitter_devices)
            received_messages, receival_time = self.receive_msgs(receiver_devices=receiver_devices)
            comm_receival_time += receival_time
            ...
            print(self.get_processing_energy())
            print(self.get_communication_energy(comm_emmition_time=comm_emmition_time, comm_receival_time=comm_receival_time))
