...
try:
    # HACK: BASEmesh is no longer compatible with more recent versions of
    # Py2DM, so this must be hard-coded to use the 0.1.0 release until we can
    # port the mesh saving and loading system over.
