...
#cmake -DCMAKE_BUILD_TYPE=Debug -DBUILD_DOC=OFF -DBUILD_TEST=ON -DBUILD_DEMO=OFF ../.. -DCMAKE_INSTALL_PREFIX=$$PREFIX -DCMAKE_PREFIX_PATH=$$PREFIX
#make VERBOSE=1
#make install

cd "$$ROOT_DIR/Carna-$VERSION_CARNA/build/make_release"
cmake -DCMAKE_BUILD_TYPE=Release -DBUILD_DOC=OFF -DBUILD_TEST=ON -DBUILD_DEMO=OFF ../.. -DCMAKE_INSTALL_PREFIX=$$PREFIX -DCMAKE_PREFIX_PATH=$$PREFIX -DGLEW_LIBRARIES=../../../../_build_env/lib/libGLEW.so
make VERBOSE=1
make install
