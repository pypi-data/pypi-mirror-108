...
from .stream_service_discovery.stream_service_discovery_handler import DesktopStreamServiceDiscoveryHandler
from .stream_service_discovery.stream_connection_configuration import DesktopStreamConnectionConfiguration
...
class DesktopSession(Session):
    ...
    def _get_handshake_url(self, port=None):
        ...
        handshake = configure.get_str(configure.keys.desktop_handshake_url(self._session_name))
    ...
    def _set_stream_status(self, stream_connection_name: str, stream_status):
        ...
        -------
        """
        self._streaming_connection_name_to_status[stream_connection_name] = stream_status
    ...
    async def _get_stream_connection_configuration(self, stream_connection_name:str):
        ...
        service_discovery_handler = DesktopStreamServiceDiscoveryHandler(self, streaming_connection_discovery_endpoint_url)
        ...
        stream_connection_configuration = DesktopStreamConnectionConfiguration(self, 
    ...
    async def _create_and_start_stream_connection(self, stream_connection_name:str, 
        ...
        return await Session._create_and_start_stream_connection(self,
                                                                    stream_connection_name,
                                                                    connection_protocol_name)
    ...
    async def check_port(self, port, timeout=None):
        ...
        try:
            response = await self._http_request_async(url=url,
                                                     method="GET",
                                                     # headers=_headers,
                                                     # json=body,
                                                     timeout=timeout)
    ...
    async def http_request_async(self, url: str, method=None, headers=None,
        ...
        return await self._http_request_async(url, method=method, headers=headers,
