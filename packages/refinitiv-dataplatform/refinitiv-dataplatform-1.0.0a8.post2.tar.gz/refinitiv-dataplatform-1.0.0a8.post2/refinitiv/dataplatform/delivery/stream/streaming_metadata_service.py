...
class FieldDescription:
    def __init__(self, field_description):
        ...
        if element:
            ...
            self.ripple_to = element.get('RIPPLETO').get('Data') if element.get('RIPPLETO') else None
...
class StreamingMetadataService(Openable, LogReporter):
    ...
    def __init__(self, session, connection=None, service=None):
        ...
        self._dictionary_stream = DictionaryStream(self,
        ...
        self._enumtype_stream = DictionaryStream(self,
                                                 session=self._session,
                                                 connection=self._connection,
    ...
    def _decode_field_dictionary(self, message):
        entries = message.get('Series').get('Entries') if message.get('Series') else None
        if entries:
...
class DictionaryStream(OMMStream):
    ...
    def __init__(self, svc_manager:StreamingMetadataService,
                 session, name,
                 connection=None,
                 service=None,
                 fields=None,
