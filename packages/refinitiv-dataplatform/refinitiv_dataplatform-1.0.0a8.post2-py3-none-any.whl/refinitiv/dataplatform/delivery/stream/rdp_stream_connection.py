...
class RDPStreamConnection(StreamConnection):
    ...
    def _set_stream_authentication_token(self, authentication_token):
        ...
        self.debug(f'RDPStreamConnection.authentication_token() - authentication message = {auth_message}')
...
#warning ignore the heartbeat message
            ...
            self._session.debug('#WARNING do nothing after received heartbeat from server.')
        else:
