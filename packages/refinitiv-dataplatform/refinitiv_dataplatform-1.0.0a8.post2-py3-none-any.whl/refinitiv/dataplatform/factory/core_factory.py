...
def create_session(session_name):
    ...
    platform_session_config = configure.get(configure.keys.platform_session(session_name), None)
    desktop_session_config = configure.get(configure.keys.desktop_session(session_name), None)
    ...
    if desktop_session_config and platform_session_config:
        ...
        raise RDPError(1, f'Cannot find session configuration with name "{session_name}"')
