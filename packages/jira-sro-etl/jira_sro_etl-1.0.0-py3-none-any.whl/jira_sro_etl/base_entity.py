...
class BaseEntity():
    ...
    def choose_conversor(self, type: str) -> Conversor:
        """Return the right conversor based on the given string

        Args:
            type (str): String used to select conversor

        Returns:
            Conversor: Class to convert a jira entity to ontology
        """
        print('------------- choose conversor ---------------')
        if type == 'user':
            print('------------- user ---------------')
            return ConversorUser(self.organization, self.data)
        elif type == 'project':
            print('------------- project ---------------')
            return ConversorProject(self.organization, self.data)
        elif type == 'sprint':
            print('------------- sprint ---------------')
            return ConversorSprint(self.organization, self.data)
        elif type =='Story':
            print('------------- Story ---------------')
            return ConversorUserStory(self.organization, self.data)
        elif type == 'Epic':
            print('------------- epic ---------------')
            return ConversorEpic(self.configuration, self.data)
        elif type == 'Sub-task':
            print('------------- Sub-task ---------------')
            return ConversorTask(self.configuration, self.data)
        elif type == 'Team-member':
            print('------------- Team-member ---------------')
            return ConversorTeamMember(self.configuration, self.data)
        elif type == 'Team':
            print('------------- Team ---------------')
            return ConversorTeam(self.configuration, self.data)
        elif type == 'Development-team':
            print('------------- Development-team ---------------')
            return ConversorDevelopmentTeam(self.configuration, self.data)
    ...
    def insert_many_on_mongo_db(self, list_entities: list, collection_name: str) -> InsertManyResult:
