 ...
 *   Axis [ label="Axis" URL="\ref cqasm::types::Axis"];
 *   Bool [ label="Bool" URL="\ref cqasm::types::Bool"];
 *   Complex [ label="Complex" URL="\ref cqasm::types::Complex"];
 *   ComplexMatrix [ label="ComplexMatrix" URL="\ref cqasm::types::ComplexMatrix"];
 *   Int [ label="Int" URL="\ref cqasm::types::Int"];
 *   Json [ label="Json" URL="\ref cqasm::types::Json"];
 *   Qubit [ label="Qubit" URL="\ref cqasm::types::Qubit"];
 *   Real [ label="Real" URL="\ref cqasm::types::Real"];
 *   RealMatrix [ label="RealMatrix" URL="\ref cqasm::types::RealMatrix"];
 *   String [ label="String" URL="\ref cqasm::types::String"];
 *   TypeBase [ label="TypeBase" URL="\ref cqasm::types::TypeBase", style=dotted];
 ...
 *   prim0 [ label="primitives::Int" URL="\ref cqasm::primitives::Int"];
 *   ComplexMatrix -> prim0 [ label="num_rows", arrowhead=normal, style=solid, fontname=Helvetica, fontsize=10];
 *   prim1 [ label="primitives::Int" URL="\ref cqasm::primitives::Int"];
 ...
 *   prim3 [ label="primitives::Int" URL="\ref cqasm::primitives::Int"];
 *   RealMatrix -> prim3 [ label="num_cols", arrowhead=normal, style=solid, fontname=Helvetica, fontsize=10];
 *   prim4 [ label="primitives::Bool" URL="\ref cqasm::primitives::Bool"];
...
public:
     ...
     * (more or less).
     */
    cqasm::primitives::Bool assignable;

    /**
     * Constructor.
     */
    TypeBase(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Axis(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Bool(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Complex(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     */
    cqasm::primitives::Int num_rows;

    /**
     * Number of columns. Negative indicates that the value is unconstrained.
     * Can be zero, unlike num_rows.
     */
    cqasm::primitives::Int num_cols;

    /**
     * Constructor.
     */
    ComplexMatrix(const cqasm::primitives::Int &num_rows = cqasm::primitives::initialize<cqasm::primitives::Int>(), const cqasm::primitives::Int &num_cols = cqasm::primitives::initialize<cqasm::primitives::Int>(), const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Int(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Json(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Qubit(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Real(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    RealMatrix(const cqasm::primitives::Int &num_rows = cqasm::primitives::initialize<cqasm::primitives::Int>(), const cqasm::primitives::Int &num_cols = cqasm::primitives::initialize<cqasm::primitives::Int>(), const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    String(const cqasm::primitives::Bool &assignable = cqasm::primitives::initialize<cqasm::primitives::Bool>());
