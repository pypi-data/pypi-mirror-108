 ...
 *   BitRefs [ label="BitRefs" URL="\ref cqasm::values::BitRefs"];
 *   ConstAxis [ label="ConstAxis" URL="\ref cqasm::values::ConstAxis"];
 *   ConstBool [ label="ConstBool" URL="\ref cqasm::values::ConstBool"];
 *   ConstComplex [ label="ConstComplex" URL="\ref cqasm::values::ConstComplex"];
 *   ConstComplexMatrix [ label="ConstComplexMatrix" URL="\ref cqasm::values::ConstComplexMatrix"];
 *   ConstInt [ label="ConstInt" URL="\ref cqasm::values::ConstInt"];
 *   ConstJson [ label="ConstJson" URL="\ref cqasm::values::ConstJson"];
 *   ConstReal [ label="ConstReal" URL="\ref cqasm::values::ConstReal"];
 *   ConstRealMatrix [ label="ConstRealMatrix" URL="\ref cqasm::values::ConstRealMatrix"];
 *   ConstString [ label="ConstString" URL="\ref cqasm::values::ConstString"];
 *   Constant [ label="Constant" URL="\ref cqasm::values::Constant", style=dotted];
 *   Function [ label="Function" URL="\ref cqasm::values::Function"];
 *   QubitRefs [ label="QubitRefs" URL="\ref cqasm::values::QubitRefs"];
 *   Reference [ label="Reference" URL="\ref cqasm::values::Reference", style=dotted];
 *   VariableRef [ label="VariableRef" URL="\ref cqasm::values::VariableRef"];
 ...
 *   prim12 [ label="semantic::Variable" URL="\ref cqasm::semantic::Variable"];
...
public:
     ...
     * The contained value.
     */
    cqasm::primitives::Axis value;

    /**
     * Constructor.
     */
    ConstAxis(const cqasm::primitives::Axis &value = cqasm::primitives::initialize<cqasm::primitives::Axis>());
...
public:
     ...
     * The contained value.
     */
    cqasm::primitives::Bool value;

    /**
     * Constructor.
     */
    ConstBool(const cqasm::primitives::Bool &value = cqasm::primitives::initialize<cqasm::primitives::Bool>());
...
public:
     ...
     * The contained value.
     */
    cqasm::primitives::Complex value;

    /**
     * Constructor.
     */
    ConstComplex(const cqasm::primitives::Complex &value = cqasm::primitives::initialize<cqasm::primitives::Complex>());
...
public:
     ...
     * The contained value.
     */
    cqasm::primitives::CMatrix value;

    /**
     * Constructor.
     */
    ConstComplexMatrix(const cqasm::primitives::CMatrix &value = cqasm::primitives::initialize<cqasm::primitives::CMatrix>());
...
public:
     ...
     * Constructor.
     */
    ConstInt(const cqasm::primitives::Int &value = cqasm::primitives::initialize<cqasm::primitives::Int>());
...
public:
     ...
     * Constructor.
     */
    ConstJson(const cqasm::primitives::Str &value = cqasm::primitives::initialize<cqasm::primitives::Str>());
...
public:
     ...
     * Constructor.
     */
    ConstReal(const cqasm::primitives::Real &value = cqasm::primitives::initialize<cqasm::primitives::Real>());
...
public:
     ...
     * The contained value.
     */
    cqasm::primitives::RMatrix value;

    /**
     * Constructor.
     */
    ConstRealMatrix(const cqasm::primitives::RMatrix &value = cqasm::primitives::initialize<cqasm::primitives::RMatrix>());
...
public:
     ...
     * Constructor.
     */
    ConstString(const cqasm::primitives::Str &value = cqasm::primitives::initialize<cqasm::primitives::Str>());
...
public:
     ...
     * Operands for the function.
     */
    One<cqasm::types::Node> return_type;

    /**
     * Constructor.
     */
    Function(const cqasm::primitives::Str &name = cqasm::primitives::initialize<cqasm::primitives::Str>(), const Any<cqasm::values::Node> &operands = cqasm::primitives::initialize<Any<cqasm::values::Node>>(), const One<cqasm::types::Node> &return_type = cqasm::primitives::initialize<One<cqasm::types::Node>>());
...
public:
     ...
     */
    Link<cqasm::semantic::Variable> variable;

    /**
     * Constructor.
     */
    VariableRef(const Link<cqasm::semantic::Variable> &variable = cqasm::primitives::initialize<Link<cqasm::semantic::Variable>>());
