...
from .constants import TRAIN_STATUS_COMPLETED, MODE_CLUSTER
...
class AlgorithmManager:
    ...
    def status(self, algorithm, model_id):
        ...
        if status == TRAIN_STATUS_COMPLETED and client_config.mode == MODE_CLUSTER:
    ...
    def loop(self):
        while True:
            ...
            p = threading.Thread(target=self._train_async,
