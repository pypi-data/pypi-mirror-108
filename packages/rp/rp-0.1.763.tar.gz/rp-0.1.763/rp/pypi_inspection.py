...
def get_pypi_info_from_module_name(module_name):
    #assert is_a_module(module)
    name=module_name
    name=name.split('.')[0]#rp.prompt_toolkit --> rp
    info=get_dist_infos()
