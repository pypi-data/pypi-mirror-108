# mypy-boto3-application-insights<a id="mypy-boto3-application-insights"></a>
...
[boto3.ApplicationInsights 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/application-insights.html#ApplicationInsights)
