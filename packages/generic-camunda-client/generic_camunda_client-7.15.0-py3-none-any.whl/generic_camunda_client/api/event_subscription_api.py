...
class EventSubscriptionApi(object):
    ...
    def get_event_subscriptions(self, **kwargs):  # noqa: E501
        ...
        Queries for event subscriptions that fulfill given parameters. The size of the result set can be retrieved by using the [Get Event Subscriptions count](https://docs.camunda.org/manual/7.15/reference/rest/event-subscription/get-query-count/) method.  # noqa: E501
    ...
    def get_event_subscriptions_count(self, **kwargs):  # noqa: E501
        ...
        Queries for the number of event subscriptions that fulfill given parameters. Takes the same parameters as the [Get Event Subscriptions](https://docs.camunda.org/manual/7.15/reference/rest/event-subscription/get-query/) method.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
