...
class AttachmentDtoAllOf(object):
    ...
    def create_time(self):
        ...
        The time the variable was inserted. [Default format](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.  # noqa: E501
    ...
    def removal_time(self):
        ...
        The time after which the attachment should be removed by the History Cleanup job. [Default format](https://docs.camunda.org/manual/7.15/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.  # noqa: E501
