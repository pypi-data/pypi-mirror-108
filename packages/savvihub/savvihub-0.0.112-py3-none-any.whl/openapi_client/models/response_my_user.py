...
class ResponseMyUser(object):
    ...
    def __init__(self, created_dt=None, display_name=None, edges=None, email=None, github_authorized=None, github_username=None, has_password=None, id=None, immutable_slug=None, is_email_verified=None, last_login=None, updated_dt=None, username=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
