...
class ResponseKernelImage(object):
    ...
    openapi_types = {
        ...
        'kernel_image_workspace': 'int',
        'kernel_image_workspace_credentials': 'int',
        'language': 'str',
        'name': 'str',
        'packages': 'str',
        'processor_type': 'str',
    ...
    attribute_map = {
        ...
        'kernel_image_workspace': 'kernel_image_workspace',
        'kernel_image_workspace_credentials': 'kernel_image_workspace_credentials',
        'language': 'language',
        'name': 'name',
        'packages': 'packages',
        ...
        'workspace_credentials_id': 'workspace_credentials_id',
        'workspace_id': 'workspace_id'
    }

    def __init__(self, command=None, created_dt=None, description=None, execute_type=None, id=None, image_pull_policy=None, image_url=None, immutable_slug=None, is_public=None, is_savvihub_managed=None, kernel_image_workspace=None, kernel_image_workspace_credentials=None, language=None, name=None, packages=None, processor_type=None, updated_dt=None, working_dir=None, workspace_credentials_id=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._kernel_image_workspace = None
        self._kernel_image_workspace_credentials = None
        self._language = None
        self._name = None
        self._packages = None
        ...
        self._workspace_credentials_id = None
        ...
        self.kernel_image_workspace = kernel_image_workspace
        self.kernel_image_workspace_credentials = kernel_image_workspace_credentials
        ...
        self.workspace_credentials_id = workspace_credentials_id
    ...
    @property
    def kernel_image_workspace(self):
        """Gets the kernel_image_workspace of this ResponseKernelImage.  # noqa: E501


        :return: The kernel_image_workspace of this ResponseKernelImage.  # noqa: E501
        :rtype: int
        """
        return self._kernel_image_workspace

    @kernel_image_workspace.setter
    def kernel_image_workspace(self, kernel_image_workspace):
        """Sets the kernel_image_workspace of this ResponseKernelImage.


        :param kernel_image_workspace: The kernel_image_workspace of this ResponseKernelImage.  # noqa: E501
        :type kernel_image_workspace: int
        """
        if self.local_vars_configuration.client_side_validation and kernel_image_workspace is None:  # noqa: E501
            raise ValueError("Invalid value for `kernel_image_workspace`, must not be `None`")  # noqa: E501

        self._kernel_image_workspace = kernel_image_workspace

    @property
    def kernel_image_workspace_credentials(self):
        """Gets the kernel_image_workspace_credentials of this ResponseKernelImage.  # noqa: E501


        :return: The kernel_image_workspace_credentials of this ResponseKernelImage.  # noqa: E501
        :rtype: int
        """
        return self._kernel_image_workspace_credentials

    @kernel_image_workspace_credentials.setter
    def kernel_image_workspace_credentials(self, kernel_image_workspace_credentials):
        """Sets the kernel_image_workspace_credentials of this ResponseKernelImage.


        :param kernel_image_workspace_credentials: The kernel_image_workspace_credentials of this ResponseKernelImage.  # noqa: E501
        :type kernel_image_workspace_credentials: int
        """

        self._kernel_image_workspace_credentials = kernel_image_workspace_credentials
    ...
    @property
    def workspace_credentials_id(self):
        """Gets the workspace_credentials_id of this ResponseKernelImage.  # noqa: E501


        :return: The workspace_credentials_id of this ResponseKernelImage.  # noqa: E501
        :rtype: int
        """
        return self._workspace_credentials_id

    @workspace_credentials_id.setter
    def workspace_credentials_id(self, workspace_credentials_id):
        """Sets the workspace_credentials_id of this ResponseKernelImage.


        :param workspace_credentials_id: The workspace_credentials_id of this ResponseKernelImage.  # noqa: E501
        :type workspace_credentials_id: int
        """

        self._workspace_credentials_id = workspace_credentials_id
