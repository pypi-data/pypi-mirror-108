...
class ResponseProjectInfo(object):
    ...
    def __init__(self, cached_git_default_branch=None, cached_git_http_url_to_repo=None, cached_git_owner_slug=None, cached_git_repo_slug=None, cached_git_ssh_url_to_repo=None, created_dt=None, description=None, experiment_summary=None, git_provider=None, id=None, immutable_slug=None, is_public=None, name=None, primary_owner=None, primary_owner_id=None, project_primary_owner=None, project_volume=None, project_workspace=None, type=None, updated_dt=None, volume_id=None, workspace=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def project_workspace(self):
        """Gets the project_workspace of this ResponseProjectInfo.  # noqa: E501


        :return: The project_workspace of this ResponseProjectInfo.  # noqa: E501
        :rtype: int
        """
    ...
    def project_workspace(self, project_workspace):
        """Sets the project_workspace of this ResponseProjectInfo.


        :param project_workspace: The project_workspace of this ResponseProjectInfo.  # noqa: E501
        :type project_workspace: int
        """
        if self.local_vars_configuration.client_side_validation and project_workspace is None:  # noqa: E501
            raise ValueError("Invalid value for `project_workspace`, must not be `None`")  # noqa: E501
