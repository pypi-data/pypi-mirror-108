...
class ResponseDatasetInfo(object):
    ...
    def __init__(self, created_dt=None, dataset_volume=None, dataset_workspace=None, description=None, file_count=None, id=None, immutable_slug=None, is_public=None, is_read_only=None, is_support_snapshot=None, name=None, size=None, source=None, status=None, updated_dt=None, volume_id=None, workspace=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def dataset_workspace(self):
        """Gets the dataset_workspace of this ResponseDatasetInfo.  # noqa: E501


        :return: The dataset_workspace of this ResponseDatasetInfo.  # noqa: E501
        :rtype: int
        """
    ...
    def dataset_workspace(self, dataset_workspace):
        """Sets the dataset_workspace of this ResponseDatasetInfo.


        :param dataset_workspace: The dataset_workspace of this ResponseDatasetInfo.  # noqa: E501
        :type dataset_workspace: int
        """
        if self.local_vars_configuration.client_side_validation and dataset_workspace is None:  # noqa: E501
            raise ValueError("Invalid value for `dataset_workspace`, must not be `None`")  # noqa: E501
