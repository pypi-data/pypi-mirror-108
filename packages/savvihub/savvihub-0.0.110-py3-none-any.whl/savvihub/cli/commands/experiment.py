...
from openapi_client import (
    ...
    ProtoVolumeMountRequests, ModelKernelResourceSpecField, ProtoVolumeMountRequestSourceVersionControlProject,
...
def describe(
    ...
    full_plots_info_desc.add_child(f'{WEB_HOST}/{workspace_name}/{project_name}/experiments/{experiment.number}/plots')
