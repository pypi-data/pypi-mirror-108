...
class SavviHubClient:
    ...
    def experiment_logs(self, workspace, project, experiment_number_or_name, **kwargs) -> ExperimentExperimentLogsResponse:
    ...
    def experiment_create(
        self, workspace, project, message, cluster_name, image_url, resource_spec_id, resource_spec,
