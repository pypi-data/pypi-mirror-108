...
class ModelProjectEdges(object):
    ...
    def __init__(self, experiments=None, organization=None, primary_owner=None, services=None, volume=None, workspace=None, local_vars_configuration=None):  # noqa: E501
