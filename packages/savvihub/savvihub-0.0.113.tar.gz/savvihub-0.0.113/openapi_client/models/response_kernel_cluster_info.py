...
class ResponseKernelClusterInfo(object):
    ...
    def __init__(self, created_dt=None, current_system_metrics=None, docs_link=None, id=None, immutable_slug=None, is_savvihub_managed=None, kernel_cluster_organization=None, kernel_cluster_workspace=None, kubernetes_namespace=None, kubernetes_service_type=None, message=None, name=None, organization_id=None, provider=None, region=None, status=None, updated_dt=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
