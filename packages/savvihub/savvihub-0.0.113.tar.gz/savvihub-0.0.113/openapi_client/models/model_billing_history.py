...
class ModelBillingHistory(object):
    ...
    def __init__(self, amount=None, billing_history_experiment=None, billing_history_organization=None, billing_history_service=None, billing_history_workspace=None, created_dt=None, edges=None, id=None, month=None, total=None, updated_dt=None, workload_created_dt=None, local_vars_configuration=None):  # noqa: E501
