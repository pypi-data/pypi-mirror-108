...
#### Install From Repo
  ...
  Clone the repo  
  ```shell  
  git clone https://github.com/OmerCP/OmerBinance
  ```  
...
Project Link: [https://pypi.org/project/OmerBinance/](https://pypi.org/project/OmerBinance/)
