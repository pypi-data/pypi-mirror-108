...
- style (dict; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, picker=Component.UNDEFINED, showTime=Component.UNDEFINED, placeholderStart=Component.UNDEFINED, placeholderEnd=Component.UNDEFINED, disabledStart=Component.UNDEFINED, disabledEnd=Component.UNDEFINED, selectedStartDate=Component.UNDEFINED, selectedEndDate=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'disabledEnd', 'disabledStart', 'loading_state', 'picker', 'placeholderEnd', 'placeholderStart', 'selectedEndDate', 'selectedStartDate', 'showTime', 'style']
        self._type = 'AntdDateRangePicker'
        self._namespace = 'feffery_antd_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'disabledEnd', 'disabledStart', 'loading_state', 'picker', 'placeholderEnd', 'placeholderStart', 'selectedEndDate', 'selectedStartDate', 'showTime', 'style']
