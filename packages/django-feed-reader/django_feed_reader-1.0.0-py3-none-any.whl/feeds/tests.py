...
class UnMocked(BaseTest):

    def xxtest_chinese(self):
    
        src = Source(name="Test", feed_url="https://hlbk.lol/episodes/feed.xml", interval=0)

        src.save()
        read_feed(src)    
        print(src.posts.first().enclosures.all())
