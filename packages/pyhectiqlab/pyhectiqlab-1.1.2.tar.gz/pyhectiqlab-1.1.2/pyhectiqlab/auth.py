...
class AuthProvider(object):
    ...
    def fetch_secret_api_token(self, username:str, password:str):
        ...
        if res.get('status_code')!=200:
            return False
        self._update_local_api_keys(username, username, res.get('secret_api_key'))
        self._load_local_api_keys()
        return True
    ...
    def _update_local_api_keys(self, profile, username, secret_api_key):
        self._load_local_api_keys()
        self.profiles[profile] = {'secret_api_key': secret_api_key, 'username': username}
