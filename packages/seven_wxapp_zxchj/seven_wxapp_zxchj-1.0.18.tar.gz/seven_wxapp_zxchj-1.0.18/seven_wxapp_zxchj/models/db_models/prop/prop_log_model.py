...
@LastEditTime: 2021-04-23 14:49:42
...
class PropLog:
    ...
    def get_field_list(self):
        return ['id', 'act_id', 'user_id', 'user_nick', 'change_type', 'operate_type', 'prop_type', 'machine_name', 'specs_type', 'operate_value', 'history_value', 'title', 'remark', 'create_date_int', 'create_date']
