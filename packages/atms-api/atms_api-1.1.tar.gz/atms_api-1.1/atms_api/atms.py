...
class _Location:
    ...
    def geom_from_two_locations(loc1: '_Location', loc2: '_Location'):
        ...
        loc2_valid = loc2.latitude is not None and loc2.latitude != 0 and \
                     loc2.longitude is not None and loc2.longitude != 0
...
class EventUnplanned(_EventBase):
    ...
    def xml_el(self):
        ...
        header.append(_get_org_info('organization-sending'))
        ...
        phrase1.append(_el_tag_text('accidentsAndIncidents', accidents_and_incidents))
        ...
        descrip1.append(_el_tag_text('description', self._description))
...
•	Not in Service
        ...
        if self._status == 'Ok':
            stat_int = 3
        elif self._status in ('Not Communicating', 'Unknown'):
            stat_int = 6
...
class RouteInventory(Atms):
    ...
    def __init__(self, data: dict):
        ...
        self._waypoints: typing.List[_Location] = [_Location(l) for l in data['waypoints']]
        super().__init__(data)
...
class RouteStatus(Atms):
    ...
    def xml_el(self):
        ...
        if self._rte_len > -1:
            el.append(_el_tag_text('total-distance', int(self._rte_len * 1600)))
