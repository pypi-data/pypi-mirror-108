# boto3-stubs<a id="boto3-stubs"></a>
...
[boto3 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/index.html)
...
## How to uninstall<a id="how-to-uninstall"></a>
...
### Pylint compatibility<a id="pylint-compatibility"></a>
...
### Latest changes<a id="latest-changes"></a>
...
- `boto3-stubs[all]` - Type annotations for all 269 services.
