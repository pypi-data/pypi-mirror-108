...
class ActionsResults:
    ...
    def add(self, edge_id: str, result: ActionResult):
    ...
    def get(self, edge_id, port) -> List[ActionResult]:
        if self.has_edge_value(edge_id):
            raise DagError(
    ...
    def has_edge_value(self, edge_id) -> bool:
        return edge_id not in self._results
