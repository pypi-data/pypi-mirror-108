...
class NextJsProject(
    ...
    def __init__(
        ...
        *,
        ...
        :param deps_upgrade: (experimental) How to handle dependency upgrades. Default: - DependenciesUpgrade.GITHUB_ACTIONS
        ...
        :param projen_upgrade_auto_merge: (experimental) Automatically merge projen upgrade PRs when build passes. Auto-approves the pull request which mergify will then merge. Default: - "true" if mergify auto-merge is enabled (default)
