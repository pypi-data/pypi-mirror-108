...
def to_tensor(inputs, scale=None, mean=None, std=None, **kwargs):
  ...
  """
  if T.IsNumpy(inputs):
    return _to_tensor_np(inputs=inputs, scale=scale, mean=mean, std=std)
  elif T.IsMeta(inputs):
    return _to_tensor_meta(metas=inputs, scale=scale, mean=mean, std=std, **kwargs)
  elif T.IsTensor(inputs):
    raise NotImplementedError
  elif T.IsPilImage(inputs):
    return _to_tensor_pil(inputs=inputs, scale=scale, mean=mean, std=std)
...
def truncated_standardize(inputs, **kwargs):
  ...
  """
  if T.IsNumpy(inputs):
    return _truncated_standardize_np(inputs=inputs)
  elif T.IsMeta(inputs):
    return _truncated_standardize_meta(metas=inputs, **kwargs)
  elif T.IsTensor(inputs):
    raise NotImplementedError
  elif T.IsPilImage(inputs):
    raise NotImplementedError
