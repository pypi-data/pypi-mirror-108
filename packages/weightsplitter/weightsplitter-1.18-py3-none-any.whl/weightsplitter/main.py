...
class WeightSplitter(PortDataSplitter):
    def __init__(self, ip, port, port_name='/dev/ttyUSB0', terminal_name='CAS', debug=False, test_mode=False,
                 *args, **kwargs):
        super().__init__(ip, port, port_name, device_name=terminal_name, debug=debug, test_mode=test_mode,
                         *args, **kwargs)
