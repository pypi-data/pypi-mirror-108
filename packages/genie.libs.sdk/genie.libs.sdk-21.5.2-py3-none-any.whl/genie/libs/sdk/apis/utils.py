...
def get_devices(testbed, os=None, regex=None, regex_key='os', pick_type='all', only_connected=False, with_os=False):
    ...
    def _create_dict_with_os(testbed, picked_devices):
        ...
        for dev in picked_devices:
            os = Dq(testbed.raw_config).contains_key_value('devices', dev).get_values('os', 0)
