...
class Weather:
    ...
    def next_12h_simplified(self):
        ...
        for i in self.data['list'][:4]:
            weatherdata.append((i['dt_txt'], i['main']['temp'], i['weather'][0]['description']))
        return weatherdata
...
# print(cityweather.next_12h())
# print("---------------------------\n")
pprint.pprint(cityweather.next_12h_simplified())
...
# pprint.pprint(cityweather.todayweatherdetails())
# print("-----------------------\n")
# pprint.pprint(cityweather.todayweatherdetailsSimplified())
