# mypy-boto3-serverlessrepo<a id="mypy-boto3-serverlessrepo"></a>
...
[boto3.ServerlessApplicationRepository 1.17.85](https://boto3.amazonaws.com/v1/documentation/api/1.17.85/reference/services/serverlessrepo.html#ServerlessApplicationRepository)
