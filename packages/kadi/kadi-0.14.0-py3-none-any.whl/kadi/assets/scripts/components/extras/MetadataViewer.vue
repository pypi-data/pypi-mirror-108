      ...
      <li v-for="(extra, index) in extras_"
        ...
        <div v-if="kadi.utils.isNestedType(extra.type)">
          <div class="row align-items-center" :class="{'mb-1': extra.value.length > 0 && !extra.isCollapsed}">
            ...
            <div :class="{'col-md-4': showValidation, 'col-md-5': !showValidation}">
              <collapse-item :id="extra.id"
                             :is-collapsed="extra.isCollapsed"
                             show-icon-class=""
                             hide-icon-class=""
            ...
            <div class="col-md-2 text-muted" :class="{'d-md-flex justify-content-end': !showValidation}">
              <small :class="{'mr-3': !showValidation}">{{ extra.type | prettyTypeName | capitalize }}</small>
            </div>
          </div>
        ...
        <div v-if="!kadi.utils.isNestedType(extra.type)">
          <div class="row align-items-center">
            ...
            <div class="col-md-1 d-md-flex justify-content-end" v-if="showValidation && extra.validation">
              <button type="button"
                      class="btn btn-sm btn-link text-muted py-0 px-0 px-md-2 mr-1"
          ...
          <div class="mt-3" v-if="extra.showValidation">
            <div class="row text-muted mb-2 mb-md-0" v-for="(value, key) in extra.validation" :key="key">
              <div class="col-md-5">{{ key | capitalize }}</div>
