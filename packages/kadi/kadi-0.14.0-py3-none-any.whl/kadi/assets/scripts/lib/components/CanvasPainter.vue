...
export default {
  data() {
    return {
      // Visible canvas.
      canvas: null,
      // 2D drawing context of the visible canvas.
      ctx: null,
      // Actual canvas.
      memCanvas: null,
      // 2D drawing context of the actual canvas.
      memCtx: null,
      // Current X coordinate of the mouse while the left mouse button is down.
      currX: 0,
      // Current Y coordinate of the mouse while the left mouse button is down.
      currY: 0,
      // Previous X coordinate of the mouse while the left mouse button was down.
      prevX: 0,
      // Previous Y coordinate of the mouse while the left mouse button was down.
      prevY: 0,
      // Current X coordinate of the origin of the visible canvas in relation to the origin of the actual canvas.
      originX: 0,
      // Current Y coordinate of the origin of the visible canvas in relation to the origin of the actual canvas.
      originY: 0,
      // Current width of the actual canvas.
      width: 0,
      // Current height of the actual canvas.
      height: 0,
      maxSize: 9999,
      tool: 'pen',
      color: '#000000',
