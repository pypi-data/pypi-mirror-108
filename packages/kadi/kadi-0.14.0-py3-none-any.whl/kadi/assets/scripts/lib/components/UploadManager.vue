...
export default {
  ...
  methods: {
    addFile(file, force = false, origin = null) {
      const upload = {
        // For use in v-for before the upload has an actual ID.
        ...
        chunks: [],
        file,
        // To skip the confirmation when replacing existing files.
        force,
        // To distinguish where an upload originated from.
        origin,
        progress: 0,
        source: null,
        chunkSize: null,
