    ...
    def __init__(self, size=None, key=None, number_layers=None, path=None):
        ...
        if path != None:
            ...
            for n in range(len(data)):
                ...
                print(index_layer)
                self.Layer[index_layer].X[n // 2], self.Layer[index_layer].Y[n // 2], self.Layer[index_layer].Z[
                    n // 2] = data[n][0], data[n][1], data[n][2]
                self.Layer[index_layer].mx[n // 2], self.Layer[index_layer].my[n // 2], self.Layer[index_layer].mz[
                    n // 2] = data[n][3], data[n][4], data[n][5]
