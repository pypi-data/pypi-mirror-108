...
def main() -> None:
    ...
    - Test precision frequency for two spins from different layers coupled via different types of interlayer exchange:
        [ab, bc, ac, AA, AB, AC]
    """
    interlayerinteraction=['AA']#['ab', 'bc', 'ac', 'AA', 'AB', 'AC', 'BA', 'BB', 'BC', 'CA', 'CB', 'CC']
    ...
    for inter in interlayerinteraction:
        writelog(logfile, '=' * 100)
        l_test = CTestPrecisionWithoutDamping(logfile=logfile, cleanup=False, interlayerinteraction=inter)
